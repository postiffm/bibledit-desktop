...
private:
  ...
  ustring searchfor;
  ustring replacewith;
  static void replacedialog_on_cancelbutton_clicked(GtkButton *button,
                                                    gpointer user_data);
  void on_cancelbutton_clicked();
  static void replacedialog_on_yesbutton_clicked(GtkButton *button,
                                                 gpointer user_data);
  void on_yesbutton_clicked();
  static void replacedialog_on_nobutton_clicked(GtkButton *button,
                                                gpointer user_data);
  void on_nobutton_clicked();
  static void replacedialog_on_allbutton_clicked(GtkButton *button,
                                                 gpointer user_data);
