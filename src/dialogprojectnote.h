...
public:
  ProjectNoteDialog(GtkWidget *parent, const vector<ustring> &projects_in,
                    const ustring &project_in, const ustring &created_on,
                    const ustring &created_by, const ustring &edited_on,
