...
// Restore assistant.
{
  ...
  gtk_assistant_set_page_title(GTK_ASSISTANT(assistant), vbox_select_type,
                               _("What would you like to restore?"));
  ...
  gtk_assistant_set_page_title(GTK_ASSISTANT(assistant), vbox_bible_name,
                               _("What will be the name of the Bible?"));
  ...
  gtk_box_pack_start(GTK_BOX(vbox_bible_name), entry_bible_name, FALSE, FALSE,
                     0);
  ...
  g_signal_connect_after((gpointer)entry_bible_name, "changed",
                         G_CALLBACK(on_entry_bible_name_changed),
                         gpointer(this));
...
void RestoreAssistant::on_assistant_prepare_signal(GtkAssistant *assistant,
                                                   GtkWidget *page,
                                                   gpointer user_data) {
...
void RestoreAssistant::on_assistant_apply_signal(GtkAssistant *assistant,
                                                 gpointer user_data) {
...
void RestoreAssistant::on_assistant_apply() {
  ...
  ustring unpack_directory =
      gw_build_filename(Directories->get_temp(), "restore");
...
gint RestoreAssistant::assistant_forward_function(gint current_page,
                                                  gpointer user_data) {
...
void RestoreAssistant::on_entry_bible_name_changed(GtkEditable *editable,
                                                   gpointer user_data) {
...
void RestoreAssistant::on_button_file_clicked(GtkButton *button,
                                              gpointer user_data) {
