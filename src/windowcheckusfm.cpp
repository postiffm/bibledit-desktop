...
WindowCheckUSFM::WindowCheckUSFM(GtkWidget *parent_layout, GtkAccelGroup *accelerator_group, bool startup) : FloatingWindow(parent_layout, widCheckUSFM, "Check USFM", startup)
