...
WindowNotes::WindowNotes(GtkWidget *parent_layout, GtkAccelGroup *accelerator_group, bool startup) : FloatingWindow(parent_layout, widNotes, "Project notes", startup)
