...
WindowNotes::WindowNotes(GtkWidget *parent_layout,
...
// Project notes window.
{
  ...
  gtk_scrolled_window_set_policy(GTK_SCROLLED_WINDOW(scrolledwindow_notes),
  ...
  gtk_box_pack_start(GTK_BOX(vbox_note_editor), toolbar_note_editor, FALSE,
                     FALSE, 0);
  ...
  gtk_container_add(GTK_CONTAINER(toolbar_note_editor),
                    toolitem_note_edit_bold);

  togglebutton_note_edit_bold = gtk_toggle_button_new();
  gtk_widget_show(togglebutton_note_edit_bold);
  gtk_container_add(GTK_CONTAINER(toolitem_note_edit_bold),
  ...
  gtk_container_add(GTK_CONTAINER(toolbar_note_editor),
                    toolitem_note_edit_italics);

  togglebutton_note_edit_italics = gtk_toggle_button_new();
  gtk_widget_show(togglebutton_note_edit_italics);
  gtk_container_add(GTK_CONTAINER(toolitem_note_edit_italics),
                    togglebutton_note_edit_italics);
  gtk_button_set_focus_on_click(GTK_BUTTON(togglebutton_note_edit_italics),
                                FALSE);
  ...
  gtk_container_add(GTK_CONTAINER(toolbar_note_editor),
                    toolitem_note_edit_underline);

  togglebutton_note_edit_underline = gtk_toggle_button_new();
  gtk_widget_show(togglebutton_note_edit_underline);
  gtk_container_add(GTK_CONTAINER(toolitem_note_edit_underline),
                    togglebutton_note_edit_underline);
  gtk_button_set_focus_on_click(GTK_BUTTON(togglebutton_note_edit_underline),
                                FALSE);

  image29114 = gtk_image_new_from_stock("gtk-underline", GTK_ICON_SIZE_BUTTON);
  gtk_widget_show(image29114);
  gtk_container_add(GTK_CONTAINER(togglebutton_note_edit_underline),
                    image29114);

  toolitem_note_edit_strike_through = (GtkWidget *)gtk_tool_item_new();
  gtk_widget_show(toolitem_note_edit_strike_through);
  gtk_container_add(GTK_CONTAINER(toolbar_note_editor),
                    toolitem_note_edit_strike_through);

  togglebutton_note_edit_strike_through = gtk_toggle_button_new();
  gtk_widget_show(togglebutton_note_edit_strike_through);
  gtk_container_add(GTK_CONTAINER(toolitem_note_edit_strike_through),
                    togglebutton_note_edit_strike_through);
  gtk_button_set_focus_on_click(
      GTK_BUTTON(togglebutton_note_edit_strike_through), FALSE);

  image29123 =
      gtk_image_new_from_stock("gtk-strikethrough", GTK_ICON_SIZE_BUTTON);
  gtk_widget_show(image29123);
  gtk_container_add(GTK_CONTAINER(togglebutton_note_edit_strike_through),
                    image29123);
  ...
  gtk_box_pack_start(GTK_BOX(vbox_note_editor), scrolledwindow_note_editor,
                     TRUE, TRUE, 0);
  gtk_scrolled_window_set_policy(
      GTK_SCROLLED_WINDOW(scrolledwindow_note_editor), GTK_POLICY_AUTOMATIC,
      GTK_POLICY_AUTOMATIC);

  webview_note_editor = webkit_web_view_new();
  gtk_widget_show(webview_note_editor);
  gtk_container_add(GTK_CONTAINER(scrolledwindow_note_editor),
                    webview_note_editor);
  ...
  gtk_box_pack_start(GTK_BOX(hbox_ok_cancel), button_note_cancel, FALSE, FALSE,
                     0);
  ...
  gtk_box_pack_start(GTK_BOX(vbox_controls), label_note_category, FALSE, FALSE,
                     0);
  ...
  gtk_box_pack_start(GTK_BOX(vbox_controls), combobox_note_category, FALSE,
                     FALSE, 0);

  label_note_references = gtk_label_new_with_mnemonic(_("_References"));
  gtk_widget_show(label_note_references);
  gtk_box_pack_start(GTK_BOX(vbox_controls), label_note_references, FALSE,
                     FALSE, 0);
  ...
  gtk_box_pack_start(GTK_BOX(vbox_controls), textview_note_references, TRUE,
                     TRUE, 0);
  ...
  g_signal_connect(
      (gpointer)webview_notes, "navigation-policy-decision-requested",
      G_CALLBACK(on_navigation_policy_decision_requested), gpointer(this));
  g_signal_connect((gpointer)webview_notes, "document-load-finished",
                   G_CALLBACK(on_document_load_finished), gpointer(this));
  g_signal_connect((gpointer)button_note_ok, "clicked",
                   G_CALLBACK(on_button_ok_clicked), gpointer(this));
  g_signal_connect((gpointer)button_note_cancel, "clicked",
                   G_CALLBACK(on_button_cancel_clicked), gpointer(this));
  g_signal_connect((gpointer)button_more, "clicked",
                   G_CALLBACK(on_button_more_clicked), gpointer(this));

  // Project notes editor signals.
  g_signal_connect((gpointer)togglebutton_note_edit_bold, "toggled",
                   G_CALLBACK(on_togglebutton_note_edit_bold_toggled),
                   gpointer(this));
  g_signal_connect((gpointer)togglebutton_note_edit_italics, "toggled",
                   G_CALLBACK(on_togglebutton_note_edit_italics_toggled),
                   gpointer(this));
  g_signal_connect((gpointer)togglebutton_note_edit_underline, "toggled",
                   G_CALLBACK(on_togglebutton_note_edit_underline_toggled),
                   gpointer(this));
  g_signal_connect((gpointer)togglebutton_note_edit_strike_through, "toggled",
                   G_CALLBACK(on_togglebutton_note_edit_strike_through_toggled),
                   gpointer(this));
  g_signal_connect((gpointer)webview_note_editor, "move-cursor",
                   G_CALLBACK(on_move_cursor), gpointer(this));

  gtk_label_set_mnemonic_widget(GTK_LABEL(label_note_references),
                                textview_note_references);
  gtk_label_set_mnemonic_widget(GTK_LABEL(label_note_category),
                                combobox_note_category);

  // GUI timer.
  gui_source_id =
      g_timeout_add_full(G_PRIORITY_DEFAULT, 100, GSourceFunc(on_gui_timeout),
                         gpointer(this), NULL);
...
*/
{
  ...
  if (newnote) {
    ...
    references = books_id_to_english(settings->genconfig.book_get()) + " " +
                 settings->genconfig.chapter_get() + ":" +
  ...
  // Display the note.
  webkit_web_view_load_string(WEBKIT_WEB_VIEW(webview_note_editor),
                              note.c_str(), NULL, NULL, NULL);
  webkit_web_view_set_editable(WEBKIT_WEB_VIEW(webview_note_editor), true);
  ...
  // Fetch and store the creation date for display and later use.
  {
    ...
    created_on = _("Created on ") + date_time_julian_human_readable(
                                        note_editor->date_created, true);
  }
  ...
  // The modification date.
  {
    ...
    edited_on = _("Edited on ") + date_time_julian_human_readable(
                                      note_editor->date_modified, true);
  }
...
void WindowNotes::on_togglebutton_note_edit_bold_toggled(
...
void WindowNotes::togglebutton_note_edit_bold_toggled() {
  /*
  The available commands for the execCommand function can be found in the WebKit
  source.
  The implementation uses a table in the createCommandMap function in the
  EditorCommand.cpp source file.
  Look for the ones that say "supported" (as opposed  to
  supportedFromMenuOrKeyBinding).
  */
  WebKitDOMDocument *dom_document =
      webkit_web_view_get_dom_document(WEBKIT_WEB_VIEW(webview_note_editor));
  webkit_dom_document_exec_command(dom_document, "Bold", FALSE, "");
}

void WindowNotes::on_togglebutton_note_edit_italics_toggled(
    GtkToggleButton *togglebutton, gpointer user_data) {
...
void WindowNotes::on_togglebutton_note_edit_underline_toggled(
    GtkToggleButton *togglebutton, gpointer user_data) {
...
void WindowNotes::on_togglebutton_note_edit_strike_through_toggled(
    GtkToggleButton *togglebutton, gpointer user_data) {
...
void WindowNotes::redisplay(bool immediately) {
  ...
  if (immediately)
    ...
    redisplay_source_id = g_timeout_add_full(G_PRIORITY_DEFAULT, 500,
                                             GSourceFunc(on_redisplay_timeout),
                                             gpointer(this), NULL);
}
...
void WindowNotes::redisplay_timeout() {
  ...
  extern Settings *settings;
  ustring reference = books_id_to_english(settings->genconfig.book_get()) +
                      " " + settings->genconfig.chapter_get() + ":" +
                      settings->genconfig.verse_get();
  // Create displaying object.
  displayprojectnotes =
      new DisplayProjectNotes(reference, webview_notes, NULL, edited_note_id);
}
...
// Stop the process of displaying notes.
{
  ...
  while (displayprojectnotes) {
    ...
    while (gtk_events_pending())
      gtk_main_iteration();
    g_usleep(100000);
    // While waiting run the on_gui routine, because this deletes the object if
    // it is ready.
    on_gui();
  }
}
...
void WindowNotes::display(vector<unsigned int> &ids) {
  stop_displaying_more_notes();
  displayprojectnotes =
      new DisplayProjectNotes("", webview_notes, &ids, edited_note_id);
}

void WindowNotes::on_button_cancel_clicked(GtkButton *button,
                                           gpointer user_data) {
...
void WindowNotes::on_notes_button_ok() {
  ...
  // If no valid references remain, stop the whole transaction and give a
  // message.
  ...
  // Get and validate all references from the textview.
  {
    ...
    for (unsigned int i = 0; i < references.size(); i++) {
      ...
      ustring osis_reference = osis_book + "." +
                               convert_to_string(references[i].chapter_get()) +
                               "." + references[i].verse_get();
  ...
  if (osis_references.empty()) {
    gtkw_dialog_error(vbox_client,
                      _("No valid references. Note was not stored"));
    return;
  }
  ...
  WebKitDOMDocument *dom_document =
      webkit_web_view_get_dom_document(WEBKIT_WEB_VIEW(webview_note_editor));
  WebKitDOMHTMLElement *body_element =
      webkit_dom_document_get_body(dom_document);
  gchar *html = webkit_dom_html_element_get_inner_html(
      WEBKIT_DOM_HTML_ELEMENT(body_element));
  ...
  // Logbook (text)
  {
    ...
    ustring date_user_text =
        date_time_julian_human_readable(date_modified, true);
  ...
  notes_store_one_in_file(note_editor->id, note, project, osis_references,
                          category, note_editor->date_created,
                          note_editor->created_by, date_modified, logbook);

  // Store the note's id, so that this note can be displayed even if it normally
  // would not have displayed.
  // The reason is that if a user edits a note, then clicks OK to store it, then
  // it would disappear,
  // then the user would wonder where that note went, whether he cancelled it by
  // mistake.
  // For that reason the id of this note is stored, so that when displaying
  // notes, this id should display as well.
...
// Functions common to both the ok and cancel buttons.
{
  ...
  webkit_web_view_load_string(WEBKIT_WEB_VIEW(webview_note_editor), "", NULL,
                              NULL, NULL);
...
void WindowNotes::get_references_from_note(vector<Reference> &references,
                                           vector<ustring> &messages) {
  if (note_editor)
    notes_get_references_from_editor(note_editor->textbuffer_references,
                                     references, messages);
...
gboolean WindowNotes::on_navigation_policy_decision_requested(
  ...
  ((WindowNotes *)user_data)
      ->navigation_policy_decision_requested(request, navigation_action,
                                             policy_decision);
  return true;
}

void WindowNotes::navigation_policy_decision_requested(
    WebKitNetworkRequest *request, WebKitWebNavigationAction *navigation_action,
...
void WindowNotes::on_button_more_clicked(GtkButton *button,
                                         gpointer user_data) {
  ((WindowNotes *)user_data)->on_button_more();
}

void WindowNotes::on_button_more() {
  ProjectNoteDialog dialog(vbox_client, projects, project, created_on,
                           created_by, edited_on, logbook);
...
void WindowNotes::set_fonts() {
  ...
  if (!settings->genconfig.text_editor_font_default_get()) {
    PangoFontDescription *desired_font_description =
        pango_font_description_from_string(
            settings->genconfig.text_editor_font_name_get().c_str());
    const char *desired_font_family =
        pango_font_description_get_family(desired_font_description);
    WebKitWebSettings *webkit_settings =
        webkit_web_view_get_settings(WEBKIT_WEB_VIEW(webview_notes));
    g_object_set(G_OBJECT(webkit_settings), "default-font-family",
                 desired_font_family, NULL);
    webkit_settings =
        webkit_web_view_get_settings(WEBKIT_WEB_VIEW(webview_note_editor));
    g_object_set(G_OBJECT(webkit_settings), "default-font-family",
                 desired_font_family, NULL);
...
void WindowNotes::on_document_load_finished(WebKitWebView *web_view,
...
void WindowNotes::document_load_finished() {
  ...
  WebKitDOMDocument *dom_document =
      webkit_web_view_get_dom_document(WEBKIT_WEB_VIEW(webview_notes));
  if (dom_document) {
    WebKitDOMElement *dom_element = webkit_dom_document_get_element_by_id(
        dom_document, notes_cursor_anchor());
    if (dom_element) {
...
gboolean WindowNotes::on_move_cursor(WebKitWebView *web_view,
...
void WindowNotes::move_cursor(WebKitWebView *web_view, GtkMovementStep step,
                              gint count) {}
