...
enum T2PBlockType {
  t2pbtTextGeneral,
  t2pbtTextParagraphFirstLine,
  t2pbtTextParagraphLastLine,
  t2pbtTextParagraphOnlyLine,
  t2pbtTextIntrusion,
  t2pbtSpaceBeforeParagraph,
  t2pbtSpaceAfterParagraph,
  t2pbtNewPage,
  t2pbtNewOddPage
};
...
public:
  ...
  void set_widow_orphan_data(int paragraph_line_number,
                             bool last_line_of_paragraph);
