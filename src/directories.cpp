    ...
    if (spawn.exitstatus == 0) {
      ...
      if (spawn.exitstatus == 0) {
        ...
        if (spawn.exitstatus == 0) {
          ...
          gw_message("Cannot find a suitable move utility");
        }
      }
    }
  }
  ...
  //---------------------------------------------
  {
    ...
    if (spawn.exitstatus == 0) {
      ...
      if (spawn.exitstatus == 0) {
        ...
        gw_message("Cannot find a suitable zip utility");
      }
    }
  }
  ...
  //---------------------------------------------
  {
    ...
    if (spawn.exitstatus == 0) {
      ...
      if (spawn.exitstatus == 0) {
        ...
        gw_message("Cannot find a suitable tar utility");
      }
    }
  }
    ...
    if (spawn.exitstatus == 0) {
      ...
      if (spawn.exitstatus == 0) {
        ...
        if (spawn.exitstatus == 0) {
          ...
          gw_message("Cannot find a suitable rm/del utility");
        }
      }
    }
  }
