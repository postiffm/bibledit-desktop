...
template <class T>
inline T *unconst(const T *t) { return const_cast<T *>(t); }

// Convert const gchar* to ustring, while treating NULL as empty string.
inline ustring convert_const_gchar_ptr_to_ustring(const char *str) {
...
inline ustring convert_return_gchar_ptr_to_ustring(char *str) {
