...
private:
  ...
  void on_books();
  static void on_checkbutton_current_book_toggled(GtkToggleButton *togglebutton,
                                                  gpointer user_data);
  static void on_button_area_clicked(GtkButton *button, gpointer user_data);
  void on_button_area();
  static void on_searchspecialdialog_activate_focus(GtkWindow *window,
                                                    gpointer user_data);
  void on_control_f();
  static void on_notebook_mode_switch_page(GtkNotebook *notebook,
