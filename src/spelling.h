...
public:
  ...
  bool move_cursor_to_spelling_error(GtkTextBuffer *textbuffer, bool next,
                                     bool extremity);
...
private:
  ...
  void check_word(GtkTextBuffer *textbuffer, GtkTextIter *start,
                  GtkTextIter *end);
  ...
  static void on_populate_popup(GtkTextView *textview, GtkMenu *menu,
                                gpointer user_data);
  ...
  void build_suggestion_menu(GtkWidget *menu, GtkTextBuffer *buffer,
                             const char *word);
