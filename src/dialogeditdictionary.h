...
private:
  ...
  static void on_button_import_dict_clicked(GtkButton *button,
                                            gpointer user_data);
  void on_button_import_dict();
  static void on_button_import_file_clicked(GtkButton *button,
                                            gpointer user_data);
  void on_button_import_file();
  static void on_button_export_dict_clicked(GtkButton *button,
                                            gpointer user_data);
  void on_button_export_dict();
  static void on_button_export_file_clicked(GtkButton *button,
                                            gpointer user_data);
