...
compression_record_data compression_table[] = {
    {".tar.gz", 0, 2},  {".tgz", 0, 2},  {".tar.bz", 0, 0}, {".tbz", 0, 0},
    {".tar.bz2", 0, 0}, {".tbz2", 0, 0}, {".zip", 0, 1},
};
...
// Returns whether this was successful.
{
  ...
  case 0: {
    gw_message("I'm not yet smart enough to handle the " + archive +
               " file type");
    break;
  }
  case 1: { // If you have a zip utility installed in Windows, etc.
