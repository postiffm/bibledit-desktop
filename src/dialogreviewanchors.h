...
public:
  ReviewAnchorsDialog(vector<unsigned int> *books,
...
protected:
  ...
  GtkWidget *okbutton;
  static gboolean on_treeview_key_press_event(GtkWidget *widget,
                                              GdkEventKey *event,
                                              gpointer user_data);
  bool treeview_key_press_handler(GdkEventKey *event);
  static void on_collect_iters(GtkTreeModel *model, GtkTreePath *path,
                               GtkTreeIter *iter, gpointer data);
  static void on_button_spurious_anchors_clicked(GtkButton *button,
                                                 gpointer user_data);
