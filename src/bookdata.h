...
typedef struct {
  ...
  const char
      *bibleworks; // BibleWorks name, also Biblegateway and Blue Letter Bible
  const char *blueletter;  // for blue letter bible (similar to bibleworks but
                           // Philippians has a weird abbrev)
