...
NotesUpdateDialog::NotesUpdateDialog(int dummy) {
  ...
  gtk_window_set_position(GTK_WINDOW(notesupdatedialog),
                          GTK_WIN_POS_CENTER_ON_PARENT);
  gtk_window_set_type_hint(GTK_WINDOW(notesupdatedialog),
  ...
  label6 = gtk_label_new(
      _("This tool provides a way to update many project notes at once. It is "
        "a powerful tool, and changes made here cannot be made undone "
  ...
  gtk_notebook_set_tab_label(
      ...
      gtk_notebook_get_nth_page(GTK_NOTEBOOK(notebook1), 0), label4);
  ...
  gtk_notebook_set_tab_label(
      GTK_NOTEBOOK(notebook1),
      gtk_notebook_get_nth_page(GTK_NOTEBOOK(notebook1), 1), label5);
  ...
  gtk_notebook_set_tab_label(
      GTK_NOTEBOOK(notebook1),
      gtk_notebook_get_nth_page(GTK_NOTEBOOK(notebook1), 2), label9);

  shortcuts1.label(label9);
  shortcuts2.label(label9);

  dialog_action_area1 =
      gtk_dialog_get_action_area(GTK_DIALOG(notesupdatedialog));
  ...
  gtk_dialog_add_action_widget(GTK_DIALOG(notesupdatedialog), cancelbutton1,
                               GTK_RESPONSE_CANCEL);
  ...
  gtk_dialog_add_action_widget(GTK_DIALOG(notesupdatedialog), okbutton1,
                               GTK_RESPONSE_OK);
...
void NotesUpdateDialog::on_okbutton1_clicked(GtkButton *button,
                                             gpointer user_data) {
