...
enum InterprocessCommunicationMessageType { icmtClearMessages,
                                            icmtStoreMessage,
                                            icmtListen,
                                            icmtSetMessage };
enum InterprocessCommunicationChannelType { icctNone,
                                            icctXiphos,
                                            icctBibleTime,
                                            icctBibledit,
                                            icctVcsWorker,
                                            icctVcsControl };
enum InterprocessCommunicationSubjectType { icstNone,
                                            icstGoto,
                                            icstQuit,
                                            icstReload,
                                            icstGetref,
