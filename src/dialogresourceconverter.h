...
private:
  ...
  // Entry.
  void build_entry(GtkWidget *&image_ok, GtkWidget *&label_ok,
                   GtkWidget *&label, const gchar *label_text,
                   GtkWidget *&entry, const ustring &entry_text,
                   GCallback handler);
  // static void on_entry_changed (GtkEditable *editable, gpointer user_data);
  // void on_entry ();

  // Button.
  void build_button(GtkWidget *&image_ok, GtkWidget *&label_ok,
                    GtkWidget *&label_short, GtkWidget *&button,
                    const gchar *button_text, Shortcuts &shortcuts,
  ...
  void build_checkbutton_button(GtkWidget *&image_ok, GtkWidget *&label_ok,
                                ...
                                const gchar *checkbutton_text,
                                GCallback checkbutton_handler,
                                GtkWidget *&button, const gchar *button_text,
                                GCallback button_handler, Shortcuts &shortcuts,
                                GtkWidget *&label);

  // Textview.
  void build_textview(GtkWidget *&image_ok, GtkWidget *&label_ok,
                      GtkWidget *&label, GtkWidget *&textview, gchar *text,
                      GCallback handler);

  // Entry, combo, entry.
  void build_entry_combo_entry(GtkWidget *&image_ok, GtkWidget *&label_ok,
                               GtkWidget *&label, GtkWidget *&label_entry_1,
                               GtkWidget *&entry_1, GtkWidget *&label_combo,
                               GtkWidget *&combo, GtkWidget *&label_entry_2,
                               GtkWidget *&entry_2, GCallback entry_handler,
                               Shortcuts &shortcuts);
  ...
  static void on_open_file_button_clicked(GtkButton *button,
                                          gpointer user_data);
  ...
  static void on_view_file_button_clicked(GtkButton *button,
                                          gpointer user_data);
  ...
  static void on_chapter_pattern_entry_changed(GtkEditable *editable,
                                               gpointer user_data);
  ...
  static void on_verse_pattern_entry_changed(GtkEditable *editable,
                                             gpointer user_data);
  ...
  static void on_write_anchors_button_clicked(GtkButton *button,
                                              gpointer user_data);
