...
public:
  WindowNotes(GtkWidget *parent_layout, GtkAccelGroup *accelerator_group,
              bool startup);
  virtual ~WindowNotes();
  ...
  void get_references_from_note(vector<Reference> &references,
...
private:
  ...
  // Formatting
  static void
  on_togglebutton_note_edit_bold_toggled(GtkToggleButton *togglebutton,
                                         gpointer user_data);
  void togglebutton_note_edit_bold_toggled();
  static void
  on_togglebutton_note_edit_italics_toggled(GtkToggleButton *togglebutton,
                                            gpointer user_data);
  void togglebutton_note_edit_italics_toggled();
  static void
  on_togglebutton_note_edit_underline_toggled(GtkToggleButton *togglebutton,
                                              gpointer user_data);
  ...
  static void
  on_togglebutton_note_edit_left_justify_toggled(GtkToggleButton *togglebutton,
                                                 gpointer user_data);
  static gboolean on_move_cursor(WebKitWebView *web_view, GtkMovementStep step,
  ...
  static void on_document_load_finished(WebKitWebView *web_view,
