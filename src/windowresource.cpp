...
WindowResource::WindowResource(const ustring &resource_name, GtkWidget *parent_layout, GtkAccelGroup *accelerator_group, bool startup) : FloatingWindow(parent_layout, widResource, resource_name, startup)
