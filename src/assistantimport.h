...
public:
  ImportAssistant(WindowReferences *references_window,
...
private:
  ...
  GtkWidget *image1;
  GtkWidget *label12;
  static void on_button_bible_name_clicked(GtkButton *button,
                                           gpointer user_data);
  ...
  static void on_combobox_online_bible_bible_changed(GtkComboBox *combobox,
                                                     gpointer user_data);
