...
OdtTextParagraph::OdtTextParagraph(vector<ustring> *lines,
                                   const ustring &stylename)
...
void OdtTextParagraph::newline() { mynewline = true; }
...
void OdtTextParagraph::spannedtext(const ustring &line,
                                   const ustring &stylename) {
  if (mynewline)
    myline.append(" ");
  mynewline = false;
