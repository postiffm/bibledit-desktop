...
WindowMerge::WindowMerge(GtkWidget *parent_layout, GtkAccelGroup *accelerator_group, bool startup) : FloatingWindow(parent_layout, widMerge, "Merge", startup)
...
void WindowMerge::on_button_merge() {
  ...
  labels.push_back("Merge " + book_chapter + " of project " + current_edited_project + " and " + current_master_project + ",\n"
                                                                                                                          "and approve of each change as compared to project " +
