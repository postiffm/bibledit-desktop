...
public:
  XmlFoBlock(vector<ustring> *lines, double fontsize, int lineheight,
             ...
             ustring justification, double spacebefore, double spaceafter,
             double leftmargin, double rightmargin, double firstlineindent,
             bool spancolumns, bool keepwithnext);
  ~XmlFoBlock();
  bool italic;
  bool bold;
  bool underline;
