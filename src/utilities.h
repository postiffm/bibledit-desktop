...
int beg, unsigned int end);
void quick_sort (vector<unsigned int>& one, vector<unsigned int>& two, unsigned
int beg, unsigned int end);
void quick_sort (vector<size_t>& one,       vector<size_t>& two,       unsigned
int beg, unsigned int end);
void quick_sort (vector<unsigned int>& one, vector<bool>& two,         unsigned
int beg, unsigned int end);
void quick_sort (vector<int>& one,          vector<unsigned int>& two, unsigned
int beg, unsigned int end);
void quick_sort (vector<ustring>& one,      vector<ustring>& two,      unsigned
int beg, unsigned int end);
void quick_sort (vector<ustring>& one,      vector<bool>& two,         unsigned
int beg, unsigned int end);
void quick_sort (vector<ustring>& one,                                 unsigned
int beg, unsigned int end);
void quick_sort (vector<long unsigned int>& one, vector<long unsigned int>& two,
...
public:
  ReadDirectories(const ustring &path, const ustring &prefix,
