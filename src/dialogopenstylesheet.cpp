...
OpenStylesheetDialog::OpenStylesheetDialog(OpenStylesheetDialogType dialogtype,
                                           const ustring &currentstylesheet) {
  ...
  gtk_window_set_position(GTK_WINDOW(openstyledialog),
  ...
  label1 =
      gtk_label_new(_("Type the first couple of characters of the stylesheet, "
  ...
  gtk_dialog_add_action_widget(GTK_DIALOG(openstyledialog), cancelbutton,
                               GTK_RESPONSE_CANCEL);
  gtk_widget_set_can_default(GTK_WIDGET(cancelbutton), true);

  okbutton = gtk_button_new_from_stock("gtk-ok");
  gtk_widget_show(okbutton);
  gtk_dialog_add_action_widget(GTK_DIALOG(openstyledialog), okbutton,
                               GTK_RESPONSE_OK);
...
void OpenStylesheetDialog::on_treeview1_row_activated(GtkTreeView *treeview,
                                                      GtkTreePath *path,
...
void OpenStylesheetDialog::static_on_okbutton_clicked(GtkButton *button,
                                                      gpointer user_data) {
