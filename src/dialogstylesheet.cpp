...
StylesheetDialog::StylesheetDialog(const ustring &stylesheet,
                                   const ustring &style) {
  // Save variables.
  ...
  gtk_window_set_position(GTK_WINDOW(stylesheetdialog),
  ...
  gtk_window_set_type_hint(GTK_WINDOW(stylesheetdialog),
  ...
  gtk_scrolled_window_set_policy(GTK_SCROLLED_WINDOW(scrolledwindow_main),
                                 GTK_POLICY_NEVER, GTK_POLICY_AUTOMATIC);
  gtk_scrolled_window_set_shadow_type(GTK_SCROLLED_WINDOW(scrolledwindow_main),
                                      GTK_SHADOW_IN);
  ...
  radiobutton_id =
      gtk_radio_button_new_with_mnemonic(NULL, _("is an identifier"));
  gtk_widget_show(radiobutton_id);
  gtk_box_pack_start(GTK_BOX(vbox3), radiobutton_id, FALSE, FALSE, 0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_id),
                             radiobutton_id_group);
  radiobutton_id_group =
      gtk_radio_button_get_group(GTK_RADIO_BUTTON(radiobutton_id));

  radiobutton_paragraph =
      gtk_radio_button_new_with_mnemonic(NULL, _("starts a new paragraph"));
  ...
  radiobutton_inline = gtk_radio_button_new_with_mnemonic(
      NULL, _("is inline text with endmarker"));
  gtk_widget_show(radiobutton_inline);
  gtk_box_pack_start(GTK_BOX(vbox3), radiobutton_inline, FALSE, FALSE, 0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_inline),
                             radiobutton_id_group);
  radiobutton_id_group =
      gtk_radio_button_get_group(GTK_RADIO_BUTTON(radiobutton_inline));

  radiobutton_chapter =
      gtk_radio_button_new_with_mnemonic(NULL, _("is a chapter number"));
  gtk_widget_show(radiobutton_chapter);
  gtk_box_pack_start(GTK_BOX(vbox3), radiobutton_chapter, FALSE, FALSE, 0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_chapter),
                             radiobutton_id_group);
  radiobutton_id_group =
      gtk_radio_button_get_group(GTK_RADIO_BUTTON(radiobutton_chapter));

  radiobutton_verse =
      gtk_radio_button_new_with_mnemonic(NULL, _("is a verse number"));
  gtk_widget_show(radiobutton_verse);
  gtk_box_pack_start(GTK_BOX(vbox3), radiobutton_verse, FALSE, FALSE, 0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_verse),
                             radiobutton_id_group);
  radiobutton_id_group =
      gtk_radio_button_get_group(GTK_RADIO_BUTTON(radiobutton_verse));

  radiobutton_footendnote =
      gtk_radio_button_new_with_mnemonic(NULL, _("is a footnote or endnote"));
  gtk_widget_show(radiobutton_footendnote);
  gtk_box_pack_start(GTK_BOX(vbox3), radiobutton_footendnote, FALSE, FALSE, 0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_footendnote),
                             radiobutton_id_group);
  radiobutton_id_group =
      gtk_radio_button_get_group(GTK_RADIO_BUTTON(radiobutton_footendnote));

  radiobutton_crossreference =
      gtk_radio_button_new_with_mnemonic(NULL, _("is a crossreference"));
  gtk_widget_show(radiobutton_crossreference);
  gtk_box_pack_start(GTK_BOX(vbox3), radiobutton_crossreference, FALSE, FALSE,
                     0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_crossreference),
                             radiobutton_id_group);
  radiobutton_id_group =
      gtk_radio_button_get_group(GTK_RADIO_BUTTON(radiobutton_crossreference));

  radiobutton_peripheral =
      gtk_radio_button_new_with_mnemonic(NULL, _("is a peripheral element"));
  gtk_widget_show(radiobutton_peripheral);
  gtk_box_pack_start(GTK_BOX(vbox3), radiobutton_peripheral, FALSE, FALSE, 0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_peripheral),
                             radiobutton_id_group);
  radiobutton_id_group =
      gtk_radio_button_get_group(GTK_RADIO_BUTTON(radiobutton_peripheral));

  radiobutton_picture =
      gtk_radio_button_new_with_mnemonic(NULL, _("is a picture"));
  gtk_widget_show(radiobutton_picture);
  gtk_box_pack_start(GTK_BOX(vbox3), radiobutton_picture, FALSE, FALSE, 0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_picture),
                             radiobutton_id_group);
  radiobutton_id_group =
      gtk_radio_button_get_group(GTK_RADIO_BUTTON(radiobutton_picture));

  radiobutton_pagebreak =
      gtk_radio_button_new_with_mnemonic(NULL, _("starts a new page"));
  gtk_widget_show(radiobutton_pagebreak);
  gtk_box_pack_start(GTK_BOX(vbox3), radiobutton_pagebreak, FALSE, FALSE, 0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_pagebreak),
                             radiobutton_id_group);
  radiobutton_id_group =
      gtk_radio_button_get_group(GTK_RADIO_BUTTON(radiobutton_pagebreak));

  radiobutton_table_element =
      gtk_radio_button_new_with_mnemonic(NULL, _("is a table element"));
  gtk_widget_show(radiobutton_table_element);
  gtk_box_pack_start(GTK_BOX(vbox3), radiobutton_table_element, FALSE, FALSE,
                     0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_table_element),
                             radiobutton_id_group);
  radiobutton_id_group =
      gtk_radio_button_get_group(GTK_RADIO_BUTTON(radiobutton_table_element));

  radiobutton_wordlist_element =
      gtk_radio_button_new_with_mnemonic(NULL, _("is a word list element"));
  gtk_widget_show(radiobutton_wordlist_element);
  gtk_box_pack_start(GTK_BOX(vbox3), radiobutton_wordlist_element, FALSE, FALSE,
                     0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_wordlist_element),
                             radiobutton_id_group);
  radiobutton_id_group = gtk_radio_button_get_group(
      GTK_RADIO_BUTTON(radiobutton_wordlist_element));
  ...
  gtk_notebook_set_tab_label(
      GTK_NOTEBOOK(notebook_subtype),
      gtk_notebook_get_nth_page(GTK_NOTEBOOK(notebook_subtype), 0), label47);
  ...
  radiobutton_footnote =
      gtk_radio_button_new_with_mnemonic(NULL, _("starts a footnote"));
  gtk_widget_show(radiobutton_footnote);
  gtk_box_pack_start(GTK_BOX(vbox8), radiobutton_footnote, FALSE, FALSE, 0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_footnote),
                             radiobutton_footnote_group);
  radiobutton_footnote_group =
      gtk_radio_button_get_group(GTK_RADIO_BUTTON(radiobutton_footnote));

  radiobutton_endnote =
      gtk_radio_button_new_with_mnemonic(NULL, _("starts an endnote"));
  gtk_widget_show(radiobutton_endnote);
  gtk_box_pack_start(GTK_BOX(vbox8), radiobutton_endnote, FALSE, FALSE, 0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_endnote),
                             radiobutton_footnote_group);
  radiobutton_footnote_group =
      gtk_radio_button_get_group(GTK_RADIO_BUTTON(radiobutton_endnote));

  radiobutton_note_content_standard =
      gtk_radio_button_new_with_mnemonic(NULL, _("is standard content"));
  gtk_widget_show(radiobutton_note_content_standard);
  gtk_box_pack_start(GTK_BOX(vbox8), radiobutton_note_content_standard, FALSE,
                     FALSE, 0);
  gtk_radio_button_set_group(
      GTK_RADIO_BUTTON(radiobutton_note_content_standard),
      radiobutton_footnote_group);
  radiobutton_footnote_group = gtk_radio_button_get_group(
      GTK_RADIO_BUTTON(radiobutton_note_content_standard));

  radiobutton_note_content =
      gtk_radio_button_new_with_mnemonic(NULL, _("is content"));
  gtk_widget_show(radiobutton_note_content);
  gtk_box_pack_start(GTK_BOX(vbox8), radiobutton_note_content, FALSE, FALSE, 0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_note_content),
                             radiobutton_footnote_group);
  radiobutton_footnote_group =
      gtk_radio_button_get_group(GTK_RADIO_BUTTON(radiobutton_note_content));

  radiobutton_note_content_endmarker =
      gtk_radio_button_new_with_mnemonic(NULL, _("is content with endmarker"));
  gtk_widget_show(radiobutton_note_content_endmarker);
  gtk_box_pack_start(GTK_BOX(vbox8), radiobutton_note_content_endmarker, FALSE,
                     FALSE, 0);
  gtk_radio_button_set_group(
      GTK_RADIO_BUTTON(radiobutton_note_content_endmarker),
      radiobutton_footnote_group);
  radiobutton_footnote_group = gtk_radio_button_get_group(
      GTK_RADIO_BUTTON(radiobutton_note_content_endmarker));

  radiobutton_note_paragraph =
      gtk_radio_button_new_with_mnemonic(NULL, _("starts another paragraph"));
  gtk_widget_show(radiobutton_note_paragraph);
  gtk_box_pack_start(GTK_BOX(vbox8), radiobutton_note_paragraph, FALSE, FALSE,
                     0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_note_paragraph),
                             radiobutton_footnote_group);
  radiobutton_footnote_group =
      gtk_radio_button_get_group(GTK_RADIO_BUTTON(radiobutton_note_paragraph));

  label48 = gtk_label_new("");
  gtk_widget_show(label48);
  gtk_notebook_set_tab_label(
      GTK_NOTEBOOK(notebook_subtype),
      gtk_notebook_get_nth_page(GTK_NOTEBOOK(notebook_subtype), 1), label48);
  ...
  radiobutton_xref =
      gtk_radio_button_new_with_mnemonic(NULL, _("starts a crossreference"));
  gtk_widget_show(radiobutton_xref);
  gtk_box_pack_start(GTK_BOX(vbox9), radiobutton_xref, FALSE, FALSE, 0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_xref),
                             radiobutton_xref_group);
  radiobutton_xref_group =
      gtk_radio_button_get_group(GTK_RADIO_BUTTON(radiobutton_xref));

  radiobutton_xref_content_standard =
      gtk_radio_button_new_with_mnemonic(NULL, _("is standard content"));
  gtk_widget_show(radiobutton_xref_content_standard);
  gtk_box_pack_start(GTK_BOX(vbox9), radiobutton_xref_content_standard, FALSE,
                     FALSE, 0);
  gtk_radio_button_set_group(
      GTK_RADIO_BUTTON(radiobutton_xref_content_standard),
      radiobutton_xref_group);
  radiobutton_xref_group = gtk_radio_button_get_group(
      GTK_RADIO_BUTTON(radiobutton_xref_content_standard));
  ...
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_xref_content),
                             radiobutton_xref_group);
  radiobutton_xref_group =
      gtk_radio_button_get_group(GTK_RADIO_BUTTON(radiobutton_xref_content));

  radiobutton_xref_content_endmarker =
      gtk_radio_button_new_with_mnemonic(NULL, _("is content with endmarker"));
  gtk_widget_show(radiobutton_xref_content_endmarker);
  gtk_box_pack_start(GTK_BOX(vbox9), radiobutton_xref_content_endmarker, FALSE,
                     FALSE, 0);
  gtk_radio_button_set_group(
      GTK_RADIO_BUTTON(radiobutton_xref_content_endmarker),
      radiobutton_xref_group);
  radiobutton_xref_group = gtk_radio_button_get_group(
      GTK_RADIO_BUTTON(radiobutton_xref_content_endmarker));
  ...
  gtk_notebook_set_tab_label(
      GTK_NOTEBOOK(notebook_subtype),
      gtk_notebook_get_nth_page(GTK_NOTEBOOK(notebook_subtype), 2), label49);
  ...
  radiobutton_paragraph_type_main_title =
      gtk_radio_button_new_with_mnemonic(NULL, _("is a main title"));
  gtk_widget_show(radiobutton_paragraph_type_main_title);
  gtk_box_pack_start(GTK_BOX(vbox13), radiobutton_paragraph_type_main_title,
                     FALSE, FALSE, 0);
  gtk_radio_button_set_group(
      GTK_RADIO_BUTTON(radiobutton_paragraph_type_main_title),
      radiobutton_paragraph_type_main_title_group);
  radiobutton_paragraph_type_main_title_group = gtk_radio_button_get_group(
      GTK_RADIO_BUTTON(radiobutton_paragraph_type_main_title));

  radiobutton_paragraph_type_subtitle =
      gtk_radio_button_new_with_mnemonic(NULL, _("is a subtitle"));
  gtk_widget_show(radiobutton_paragraph_type_subtitle);
  gtk_box_pack_start(GTK_BOX(vbox13), radiobutton_paragraph_type_subtitle,
                     FALSE, FALSE, 0);
  gtk_radio_button_set_group(
      GTK_RADIO_BUTTON(radiobutton_paragraph_type_subtitle),
      radiobutton_paragraph_type_main_title_group);
  radiobutton_paragraph_type_main_title_group = gtk_radio_button_get_group(
      GTK_RADIO_BUTTON(radiobutton_paragraph_type_subtitle));

  radiobutton_paragraph_type_section_heading =
      gtk_radio_button_new_with_mnemonic(NULL, _("is a section heading"));
  gtk_widget_show(radiobutton_paragraph_type_section_heading);
  gtk_box_pack_start(GTK_BOX(vbox13),
                     radiobutton_paragraph_type_section_heading, FALSE, FALSE,
                     0);
  gtk_radio_button_set_group(
      GTK_RADIO_BUTTON(radiobutton_paragraph_type_section_heading),
      radiobutton_paragraph_type_main_title_group);
  radiobutton_paragraph_type_main_title_group = gtk_radio_button_get_group(
      GTK_RADIO_BUTTON(radiobutton_paragraph_type_section_heading));

  radiobutton_paragraph_type_text =
      gtk_radio_button_new_with_mnemonic(NULL, _("is a normal paragraph"));
  gtk_widget_show(radiobutton_paragraph_type_text);
  gtk_box_pack_start(GTK_BOX(vbox13), radiobutton_paragraph_type_text, FALSE,
                     FALSE, 0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_paragraph_type_text),
                             radiobutton_paragraph_type_main_title_group);
  radiobutton_paragraph_type_main_title_group = gtk_radio_button_get_group(
      GTK_RADIO_BUTTON(radiobutton_paragraph_type_text));

  label54 = gtk_label_new("");
  gtk_widget_show(label54);
  gtk_notebook_set_tab_label(
      GTK_NOTEBOOK(notebook_subtype),
      gtk_notebook_get_nth_page(GTK_NOTEBOOK(notebook_subtype), 3), label54);
  ...
  radiobutton_peripheral_pub =
      gtk_radio_button_new_with_mnemonic(NULL, _("starts publication data"));
  gtk_widget_show(radiobutton_peripheral_pub);
  gtk_box_pack_start(GTK_BOX(vbox14), radiobutton_peripheral_pub, FALSE, FALSE,
                     0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_peripheral_pub),
                             radiobutton_peripheral_pub_group);
  radiobutton_peripheral_pub_group =
      gtk_radio_button_get_group(GTK_RADIO_BUTTON(radiobutton_peripheral_pub));

  radiobutton_peripheral_toc =
      gtk_radio_button_new_with_mnemonic(NULL, _("starts table of contents"));
  gtk_widget_show(radiobutton_peripheral_toc);
  gtk_box_pack_start(GTK_BOX(vbox14), radiobutton_peripheral_toc, FALSE, FALSE,
                     0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_peripheral_toc),
                             radiobutton_peripheral_pub_group);
  radiobutton_peripheral_pub_group =
      gtk_radio_button_get_group(GTK_RADIO_BUTTON(radiobutton_peripheral_toc));

  radiobutton_peripheral_pref =
      gtk_radio_button_new_with_mnemonic(NULL, _("starts preface"));
  gtk_widget_show(radiobutton_peripheral_pref);
  gtk_box_pack_start(GTK_BOX(vbox14), radiobutton_peripheral_pref, FALSE, FALSE,
                     0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_peripheral_pref),
                             radiobutton_peripheral_pub_group);
  radiobutton_peripheral_pub_group =
      gtk_radio_button_get_group(GTK_RADIO_BUTTON(radiobutton_peripheral_pref));

  radiobutton_peripheral_intro =
      gtk_radio_button_new_with_mnemonic(NULL, _("starts introduction"));
  gtk_widget_show(radiobutton_peripheral_intro);
  gtk_box_pack_start(GTK_BOX(vbox14), radiobutton_peripheral_intro, FALSE,
                     FALSE, 0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_peripheral_intro),
                             radiobutton_peripheral_pub_group);
  radiobutton_peripheral_pub_group = gtk_radio_button_get_group(
      GTK_RADIO_BUTTON(radiobutton_peripheral_intro));

  radiobutton_peripheral_conc =
      gtk_radio_button_new_with_mnemonic(NULL, _("starts concordance"));
  gtk_widget_show(radiobutton_peripheral_conc);
  gtk_box_pack_start(GTK_BOX(vbox14), radiobutton_peripheral_conc, FALSE, FALSE,
                     0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_peripheral_conc),
                             radiobutton_peripheral_pub_group);
  radiobutton_peripheral_pub_group =
      gtk_radio_button_get_group(GTK_RADIO_BUTTON(radiobutton_peripheral_conc));

  radiobutton_peripheral_glo =
      gtk_radio_button_new_with_mnemonic(NULL, _("starts glossary"));
  gtk_widget_show(radiobutton_peripheral_glo);
  gtk_box_pack_start(GTK_BOX(vbox14), radiobutton_peripheral_glo, FALSE, FALSE,
                     0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_peripheral_glo),
                             radiobutton_peripheral_pub_group);
  radiobutton_peripheral_pub_group =
      gtk_radio_button_get_group(GTK_RADIO_BUTTON(radiobutton_peripheral_glo));

  radiobutton_peripheral_idx =
      gtk_radio_button_new_with_mnemonic(NULL, _("starts index"));
  gtk_widget_show(radiobutton_peripheral_idx);
  gtk_box_pack_start(GTK_BOX(vbox14), radiobutton_peripheral_idx, FALSE, FALSE,
                     0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_peripheral_idx),
                             radiobutton_peripheral_pub_group);
  radiobutton_peripheral_pub_group =
      gtk_radio_button_get_group(GTK_RADIO_BUTTON(radiobutton_peripheral_idx));

  radiobutton_peripheral_maps =
      gtk_radio_button_new_with_mnemonic(NULL, _("starts map index"));
  gtk_widget_show(radiobutton_peripheral_maps);
  gtk_box_pack_start(GTK_BOX(vbox14), radiobutton_peripheral_maps, FALSE, FALSE,
                     0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_peripheral_maps),
                             radiobutton_peripheral_pub_group);
  radiobutton_peripheral_pub_group =
      gtk_radio_button_get_group(GTK_RADIO_BUTTON(radiobutton_peripheral_maps));

  radiobutton_peripheral_cov =
      gtk_radio_button_new_with_mnemonic(NULL, _("starts cover"));
  gtk_widget_show(radiobutton_peripheral_cov);
  gtk_box_pack_start(GTK_BOX(vbox14), radiobutton_peripheral_cov, FALSE, FALSE,
                     0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_peripheral_cov),
                             radiobutton_peripheral_pub_group);
  radiobutton_peripheral_pub_group =
      gtk_radio_button_get_group(GTK_RADIO_BUTTON(radiobutton_peripheral_cov));

  radiobutton_peripheral_spine =
      gtk_radio_button_new_with_mnemonic(NULL, _("starts spine"));
  gtk_widget_show(radiobutton_peripheral_spine);
  gtk_box_pack_start(GTK_BOX(vbox14), radiobutton_peripheral_spine, FALSE,
                     FALSE, 0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_peripheral_spine),
                             radiobutton_peripheral_pub_group);
  radiobutton_peripheral_pub_group = gtk_radio_button_get_group(
      GTK_RADIO_BUTTON(radiobutton_peripheral_spine));

  label56 = gtk_label_new("");
  gtk_widget_show(label56);
  gtk_notebook_set_tab_label(
      GTK_NOTEBOOK(notebook_subtype),
      gtk_notebook_get_nth_page(GTK_NOTEBOOK(notebook_subtype), 4), label56);
  ...
  radiobutton_id_book =
      gtk_radio_button_new_with_mnemonic(NULL, _("identifies the book"));
  gtk_widget_show(radiobutton_id_book);
  gtk_box_pack_start(GTK_BOX(vbox15), radiobutton_id_book, FALSE, FALSE, 0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_id_book),
                             radiobutton_id_book_group);
  radiobutton_id_book_group =
      gtk_radio_button_get_group(GTK_RADIO_BUTTON(radiobutton_id_book));

  radiobutton_id_encoding =
      gtk_radio_button_new_with_mnemonic(NULL, _("identifies the encoding"));
  gtk_widget_show(radiobutton_id_encoding);
  gtk_box_pack_start(GTK_BOX(vbox15), radiobutton_id_encoding, FALSE, FALSE, 0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_id_encoding),
                             radiobutton_id_book_group);
  radiobutton_id_book_group =
      gtk_radio_button_get_group(GTK_RADIO_BUTTON(radiobutton_id_encoding));

  radiobutton_id_comment =
      gtk_radio_button_new_with_mnemonic(NULL, _("is a comment"));
  gtk_widget_show(radiobutton_id_comment);
  gtk_box_pack_start(GTK_BOX(vbox15), radiobutton_id_comment, FALSE, FALSE, 0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_id_comment),
                             radiobutton_id_book_group);
  radiobutton_id_book_group =
      gtk_radio_button_get_group(GTK_RADIO_BUTTON(radiobutton_id_comment));

  radiobutton_id_comment_with_endmarker = gtk_radio_button_new_with_mnemonic(
      NULL, _("is a comment with an endmarker"));
  gtk_widget_show(radiobutton_id_comment_with_endmarker);
  gtk_box_pack_start(GTK_BOX(vbox15), radiobutton_id_comment_with_endmarker,
                     FALSE, FALSE, 0);
  gtk_radio_button_set_group(
      GTK_RADIO_BUTTON(radiobutton_id_comment_with_endmarker),
      radiobutton_id_book_group);
  radiobutton_id_book_group = gtk_radio_button_get_group(
      GTK_RADIO_BUTTON(radiobutton_id_comment_with_endmarker));

  radiobutton_id_running_header =
      gtk_radio_button_new_with_mnemonic(NULL, _("is a running header"));
  gtk_widget_show(radiobutton_id_running_header);
  gtk_box_pack_start(GTK_BOX(vbox15), radiobutton_id_running_header, FALSE,
                     FALSE, 0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_id_running_header),
                             radiobutton_id_book_group);
  radiobutton_id_book_group = gtk_radio_button_get_group(
      GTK_RADIO_BUTTON(radiobutton_id_running_header));

  radiobutton_is_long_toc_text = gtk_radio_button_new_with_mnemonic(
      NULL, _("is long table of contents text"));
  gtk_widget_show(radiobutton_is_long_toc_text);
  gtk_box_pack_start(GTK_BOX(vbox15), radiobutton_is_long_toc_text, FALSE,
                     FALSE, 0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_is_long_toc_text),
                             radiobutton_id_book_group);
  radiobutton_id_book_group = gtk_radio_button_get_group(
      GTK_RADIO_BUTTON(radiobutton_is_long_toc_text));

  radiobutton_is_short_toc_text = gtk_radio_button_new_with_mnemonic(
      NULL, _("is short table of contents text"));
  gtk_widget_show(radiobutton_is_short_toc_text);
  gtk_box_pack_start(GTK_BOX(vbox15), radiobutton_is_short_toc_text, FALSE,
                     FALSE, 0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_is_short_toc_text),
                             radiobutton_id_book_group);
  radiobutton_id_book_group = gtk_radio_button_get_group(
      GTK_RADIO_BUTTON(radiobutton_is_short_toc_text));

  radiobutton_is_book_abbrev =
      gtk_radio_button_new_with_mnemonic(NULL, _("is the book abbreviation"));
  gtk_widget_show(radiobutton_is_book_abbrev);
  gtk_box_pack_start(GTK_BOX(vbox15), radiobutton_is_book_abbrev, FALSE, FALSE,
                     0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_is_book_abbrev),
                             radiobutton_id_book_group);
  radiobutton_id_book_group =
      gtk_radio_button_get_group(GTK_RADIO_BUTTON(radiobutton_is_book_abbrev));

  radiobutton_is_chapter_label =
      gtk_radio_button_new_with_mnemonic(NULL, _("is the chapter label"));
  gtk_widget_show(radiobutton_is_chapter_label);
  gtk_box_pack_start(GTK_BOX(vbox15), radiobutton_is_chapter_label, FALSE,
                     FALSE, 0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_is_chapter_label),
                             radiobutton_id_book_group);
  radiobutton_id_book_group = gtk_radio_button_get_group(
      GTK_RADIO_BUTTON(radiobutton_is_chapter_label));

  radiobutton_is_published_chapter_marker = gtk_radio_button_new_with_mnemonic(
      NULL, _("is the published chapter marker"));
  gtk_widget_show(radiobutton_is_published_chapter_marker);
  gtk_box_pack_start(GTK_BOX(vbox15), radiobutton_is_published_chapter_marker,
                     FALSE, FALSE, 0);
  gtk_radio_button_set_group(
      GTK_RADIO_BUTTON(radiobutton_is_published_chapter_marker),
      radiobutton_id_book_group);
  radiobutton_id_book_group = gtk_radio_button_get_group(
      GTK_RADIO_BUTTON(radiobutton_is_published_chapter_marker));
  ...
  gtk_notebook_set_tab_label(
      GTK_NOTEBOOK(notebook_subtype),
      gtk_notebook_get_nth_page(GTK_NOTEBOOK(notebook_subtype), 5), label57);
  ...
  radiobutton_table_sub_new_row =
      gtk_radio_button_new_with_mnemonic(NULL, _("starts a new row"));
  gtk_widget_show(radiobutton_table_sub_new_row);
  gtk_box_pack_start(GTK_BOX(vbox17), radiobutton_table_sub_new_row, FALSE,
                     FALSE, 0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_table_sub_new_row),
                             radiobutton_table_sub_new_row_group);
  radiobutton_table_sub_new_row_group = gtk_radio_button_get_group(
      GTK_RADIO_BUTTON(radiobutton_table_sub_new_row));

  radiobutton_table_sub_heading =
      gtk_radio_button_new_with_mnemonic(NULL, _("is a column heading"));
  gtk_widget_show(radiobutton_table_sub_heading);
  gtk_box_pack_start(GTK_BOX(vbox17), radiobutton_table_sub_heading, FALSE,
                     FALSE, 0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_table_sub_heading),
                             radiobutton_table_sub_new_row_group);
  radiobutton_table_sub_new_row_group = gtk_radio_button_get_group(
      GTK_RADIO_BUTTON(radiobutton_table_sub_heading));

  radiobutton_table_sub_cell =
      gtk_radio_button_new_with_mnemonic(NULL, _("is cell data"));
  gtk_widget_show(radiobutton_table_sub_cell);
  gtk_box_pack_start(GTK_BOX(vbox17), radiobutton_table_sub_cell, FALSE, FALSE,
                     0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_table_sub_cell),
                             radiobutton_table_sub_new_row_group);
  radiobutton_table_sub_new_row_group =
      gtk_radio_button_get_group(GTK_RADIO_BUTTON(radiobutton_table_sub_cell));

  label61 = gtk_label_new("");
  gtk_widget_show(label61);
  gtk_notebook_set_tab_label(
      GTK_NOTEBOOK(notebook_subtype),
      gtk_notebook_get_nth_page(GTK_NOTEBOOK(notebook_subtype), 6), label61);
  ...
  gtk_box_pack_start(GTK_BOX(vbox_subtype_wordlist), label_subtype_wordlist,
                     FALSE, FALSE, 0);
  ...
  radiobutton_subtype_wordlist_glossary_dictionary_entry =
      gtk_radio_button_new_with_mnemonic(
          NULL, _("Wordlist / glossary / dictionary entry"));
  gtk_widget_show(radiobutton_subtype_wordlist_glossary_dictionary_entry);
  gtk_box_pack_start(GTK_BOX(vbox_subtype_wordlist),
                     radiobutton_subtype_wordlist_glossary_dictionary_entry,
                     FALSE, FALSE, 0);
  gtk_radio_button_set_group(
      GTK_RADIO_BUTTON(radiobutton_subtype_wordlist_glossary_dictionary_entry),
      radiobutton_subtype_wordlist_group);
  radiobutton_subtype_wordlist_group = gtk_radio_button_get_group(
      GTK_RADIO_BUTTON(radiobutton_subtype_wordlist_glossary_dictionary_entry));

  radiobutton_subtype_hebrew_wordlist_entry =
      gtk_radio_button_new_with_mnemonic(NULL, _("Hebrew wordlist entry"));
  gtk_widget_show(radiobutton_subtype_hebrew_wordlist_entry);
  gtk_box_pack_start(GTK_BOX(vbox_subtype_wordlist),
                     radiobutton_subtype_hebrew_wordlist_entry, FALSE, FALSE,
                     0);
  gtk_radio_button_set_group(
      GTK_RADIO_BUTTON(radiobutton_subtype_hebrew_wordlist_entry),
      radiobutton_subtype_wordlist_group);
  radiobutton_subtype_wordlist_group = gtk_radio_button_get_group(
      GTK_RADIO_BUTTON(radiobutton_subtype_hebrew_wordlist_entry));

  radiobutton_subtype_greek_wordlist_entry =
      gtk_radio_button_new_with_mnemonic(NULL, _("Greek wordlist entry"));
  gtk_widget_show(radiobutton_subtype_greek_wordlist_entry);
  gtk_box_pack_start(GTK_BOX(vbox_subtype_wordlist),
                     radiobutton_subtype_greek_wordlist_entry, FALSE, FALSE, 0);
  gtk_radio_button_set_group(
      GTK_RADIO_BUTTON(radiobutton_subtype_greek_wordlist_entry),
      radiobutton_subtype_wordlist_group);
  radiobutton_subtype_wordlist_group = gtk_radio_button_get_group(
      GTK_RADIO_BUTTON(radiobutton_subtype_greek_wordlist_entry));

  radiobutton_subtype_subject_index_entry =
      gtk_radio_button_new_with_mnemonic(NULL, _("Subject index entry"));
  gtk_widget_show(radiobutton_subtype_subject_index_entry);
  gtk_box_pack_start(GTK_BOX(vbox_subtype_wordlist),
                     radiobutton_subtype_subject_index_entry, FALSE, FALSE, 0);
  gtk_radio_button_set_group(
      GTK_RADIO_BUTTON(radiobutton_subtype_subject_index_entry),
      radiobutton_subtype_wordlist_group);
  radiobutton_subtype_wordlist_group = gtk_radio_button_get_group(
      GTK_RADIO_BUTTON(radiobutton_subtype_subject_index_entry));
  ...
  gtk_notebook_set_tab_label(
      GTK_NOTEBOOK(notebook_subtype),
      gtk_notebook_get_nth_page(GTK_NOTEBOOK(notebook_subtype), 7), label63);
  ...
  dialog_action_area1 =
      gtk_dialog_get_action_area(GTK_DIALOG(stylesheetdialog));
  ...
  gtk_dialog_add_action_widget(GTK_DIALOG(stylesheetdialog), cancelbutton1,
                               GTK_RESPONSE_CANCEL);
  gtk_widget_set_can_default(GTK_WIDGET(cancelbutton1), true);

  okbutton = gtk_button_new_from_stock("gtk-ok");
  gtk_widget_show(okbutton);
  gtk_dialog_add_action_widget(GTK_DIALOG(stylesheetdialog), okbutton,
                               GTK_RESPONSE_OK);
  gtk_widget_set_can_default(GTK_WIDGET(okbutton), true);

  g_signal_connect((gpointer)okbutton, "clicked",
                   G_CALLBACK(on_okbutton_clicked), gpointer(this));
  g_signal_connect((gpointer)radiobutton_id, "toggled",
                   G_CALLBACK(on_style_type_toggled), gpointer(this));
  g_signal_connect((gpointer)radiobutton_paragraph, "toggled",
                   G_CALLBACK(on_style_type_toggled), gpointer(this));
  g_signal_connect((gpointer)radiobutton_inline, "toggled",
                   G_CALLBACK(on_style_type_toggled), gpointer(this));
  g_signal_connect((gpointer)radiobutton_chapter, "toggled",
                   G_CALLBACK(on_style_type_toggled), gpointer(this));
  g_signal_connect((gpointer)radiobutton_verse, "toggled",
                   G_CALLBACK(on_style_type_toggled), gpointer(this));
  g_signal_connect((gpointer)radiobutton_footendnote, "toggled",
                   G_CALLBACK(on_style_type_toggled), gpointer(this));
  g_signal_connect((gpointer)radiobutton_crossreference, "toggled",
                   G_CALLBACK(on_style_type_toggled), gpointer(this));
  g_signal_connect((gpointer)radiobutton_peripheral, "toggled",
                   G_CALLBACK(on_style_type_toggled), gpointer(this));
  g_signal_connect((gpointer)radiobutton_picture, "toggled",
                   G_CALLBACK(on_style_type_toggled), gpointer(this));
  g_signal_connect((gpointer)radiobutton_pagebreak, "toggled",
                   G_CALLBACK(on_style_type_toggled), gpointer(this));
  g_signal_connect((gpointer)radiobutton_table_element, "toggled",
                   G_CALLBACK(on_style_type_toggled), gpointer(this));
  g_signal_connect((gpointer)radiobutton_wordlist_element, "toggled",
                   G_CALLBACK(on_style_type_toggled), gpointer(this));
  g_signal_connect((gpointer)radiobutton_footnote, "toggled",
                   G_CALLBACK(on_radiobutton_note_toggled), gpointer(this));
  g_signal_connect((gpointer)radiobutton_endnote, "toggled",
                   G_CALLBACK(on_radiobutton_note_toggled), gpointer(this));
  g_signal_connect((gpointer)radiobutton_note_content_standard, "toggled",
                   G_CALLBACK(on_radiobutton_note_toggled), gpointer(this));
  g_signal_connect((gpointer)radiobutton_note_content, "toggled",
                   G_CALLBACK(on_radiobutton_note_toggled), gpointer(this));
  g_signal_connect((gpointer)radiobutton_note_content_endmarker, "toggled",
                   G_CALLBACK(on_radiobutton_note_toggled), gpointer(this));
  g_signal_connect((gpointer)radiobutton_note_paragraph, "toggled",
                   G_CALLBACK(on_radiobutton_note_toggled), gpointer(this));
  g_signal_connect((gpointer)radiobutton_xref, "toggled",
                   G_CALLBACK(on_radiobutton_xref_toggled), gpointer(this));
  g_signal_connect((gpointer)radiobutton_xref_content_standard, "toggled",
                   G_CALLBACK(on_radiobutton_xref_toggled), gpointer(this));
  g_signal_connect((gpointer)radiobutton_xref_content, "toggled",
                   G_CALLBACK(on_radiobutton_xref_toggled), gpointer(this));
  g_signal_connect((gpointer)radiobutton_xref_content_endmarker, "toggled",
                   G_CALLBACK(on_radiobutton_xref_toggled), gpointer(this));

  g_signal_connect((gpointer)radiobutton_id_book, "toggled",
                   G_CALLBACK(on_radiobutton_identifier_toggled),
                   gpointer(this));
  g_signal_connect((gpointer)radiobutton_id_encoding, "toggled",
                   G_CALLBACK(on_radiobutton_identifier_toggled),
                   gpointer(this));
  g_signal_connect((gpointer)radiobutton_id_comment, "toggled",
                   G_CALLBACK(on_radiobutton_identifier_toggled),
                   gpointer(this));
  g_signal_connect((gpointer)radiobutton_id_running_header, "toggled",
                   G_CALLBACK(on_radiobutton_identifier_toggled),
                   gpointer(this));
  g_signal_connect((gpointer)radiobutton_is_long_toc_text, "toggled",
                   G_CALLBACK(on_radiobutton_identifier_toggled),
                   gpointer(this));
  g_signal_connect((gpointer)radiobutton_is_short_toc_text, "toggled",
                   G_CALLBACK(on_radiobutton_identifier_toggled),
                   gpointer(this));
  g_signal_connect((gpointer)radiobutton_is_book_abbrev, "toggled",
                   G_CALLBACK(on_radiobutton_identifier_toggled),
                   gpointer(this));

  g_signal_connect((gpointer)radiobutton_table_sub_new_row, "toggled",
                   G_CALLBACK(on_checkbutton_table_element_toggled),
                   gpointer(this));
  g_signal_connect((gpointer)radiobutton_table_sub_heading, "toggled",
                   G_CALLBACK(on_checkbutton_table_element_toggled),
                   gpointer(this));
  g_signal_connect((gpointer)radiobutton_table_sub_cell, "toggled",
                   G_CALLBACK(on_checkbutton_table_element_toggled),
                   gpointer(this));

  g_signal_connect(
      (gpointer)radiobutton_subtype_wordlist_glossary_dictionary_entry,
      "toggled", G_CALLBACK(on_radiobutton_subtype_wordlist_toggled),
      gpointer(this));
  g_signal_connect(
      (gpointer)radiobutton_subtype_hebrew_wordlist_entry, "toggled",
      G_CALLBACK(on_radiobutton_subtype_wordlist_toggled), gpointer(this));
  g_signal_connect(
      (gpointer)radiobutton_subtype_greek_wordlist_entry, "toggled",
      G_CALLBACK(on_radiobutton_subtype_wordlist_toggled), gpointer(this));
  g_signal_connect((gpointer)radiobutton_subtype_subject_index_entry, "toggled",
                   G_CALLBACK(on_radiobutton_subtype_wordlist_toggled),
                   gpointer(this));
...
StylesheetDialog::~StylesheetDialog() { gtk_widget_destroy(stylesheetdialog); }

int StylesheetDialog::run() {
  return gtk_dialog_run(GTK_DIALOG(stylesheetdialog));
}

void StylesheetDialog::on_okbutton_clicked(GtkButton *button,
                                           gpointer user_data) {
...
void StylesheetDialog::on_style_type_toggled(GtkToggleButton *togglebutton,
                                             gpointer user_data) {
...
void StylesheetDialog::on_alignment_toggled(GtkToggleButton *togglebutton,
                                            gpointer user_data) {
...
void StylesheetDialog::set_gui() {
  ...
  if (pointer >= 0) {
    ...
    case stStartsParagraph:
      ...
      gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(radiobutton_paragraph),
                                   true);
    ...
    case stChapterNumber:
      ...
      gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(radiobutton_chapter),
                                   true);
    ...
    case stFootEndNote:
      ...
      gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(radiobutton_footendnote),
                                   true);
      gtk_label_set_mnemonic_widget(GTK_LABEL(label21),
                                    radiobutton_footendnote);
      break;
    case stCrossreference:
      togglebutton = radiobutton_crossreference;
      gtk_toggle_button_set_active(
          GTK_TOGGLE_BUTTON(radiobutton_crossreference), true);
      gtk_label_set_mnemonic_widget(GTK_LABEL(label21),
                                    radiobutton_crossreference);
      break;
    case stPeripheral:
      togglebutton = radiobutton_peripheral;
      gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(radiobutton_peripheral),
                                   true);
      gtk_label_set_mnemonic_widget(GTK_LABEL(label21), radiobutton_peripheral);
      break;
    case stPicture:
      togglebutton = radiobutton_picture;
      gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(radiobutton_picture),
                                   true);
      gtk_label_set_mnemonic_widget(GTK_LABEL(label21), radiobutton_picture);
      break;
    case stPageBreak:
      togglebutton = radiobutton_pagebreak;
      gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(radiobutton_pagebreak),
                                   true);
      gtk_label_set_mnemonic_widget(GTK_LABEL(label21), radiobutton_pagebreak);
      break;
    case stTableElement:
      togglebutton = radiobutton_table_element;
      gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(radiobutton_table_element),
                                   true);
      gtk_label_set_mnemonic_widget(GTK_LABEL(label21),
                                    radiobutton_table_element);
      break;
    case stWordlistElement:
      ...
      gtk_toggle_button_set_active(
          GTK_TOGGLE_BUTTON(radiobutton_wordlist_element), true);
      gtk_label_set_mnemonic_widget(GTK_LABEL(label21),
                                    radiobutton_wordlist_element);
      break;
    }
...
void StylesheetDialog::save_style() {
  ...
  gchar *txt = gtk_text_buffer_get_text(GTK_TEXT_BUFFER(buffer), &startiter,
                                        &enditer, false);
  info = txt;  // this copies txt into the ustring
  g_free(txt); // Postiff: plug memory leak because gtk_text_buffer_get_text
               // allocates a new string
  info = trim(info);
  // Save this style.
  stylesheet_save_style(
      mystylesheet, mystyle, gtk_entry_get_text(GTK_ENTRY(entryname)), info,
      type, get_subtype(), fontsize_points, italic, bold, underline, smallcaps,
      superscript, justification, spacebefore, spaceafter, leftmargin,
      rightmargin, firstlineindent, spancolumns, color, print, userbool1,
      userbool2, userbool3, userint1, userint2, userint3, userstring1,
...
// Get the string that indicates the justification, from the GUI.
{
  ...
  if (gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(radiobutton_center))) {
    result = CENTER;
                 ...
                 GTK_TOGGLE_BUTTON(radiobutton_right))) {
    result = RIGHT;
  } else if (gtk_toggle_button_get_active(
                 GTK_TOGGLE_BUTTON(radiobutton_full))) {
    result = JUSTIFIED;
  } else {
    // Defaults to left.
    result = LEFT;
...
void StylesheetDialog::set_italic() {
  if (italic == ON) {
    gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(radiobutton_italics_on),
                                 true);
    on_radiobutton_italic(radiobutton_italics_on);
  } else if (italic == INHERIT) {
    gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(radiobutton_italics_inherit),
                                 true);
    on_radiobutton_italic(radiobutton_italics_inherit);
  } else if (italic == TOGGLE) {
    gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(radiobutton_italics_toggle),
                                 true);
    on_radiobutton_italic(radiobutton_italics_toggle);
  } else {
    gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(radiobutton_italics_off),
                                 true);
...
ustring StylesheetDialog::get_italic() {
  ...
  if (gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(radiobutton_italics_on))) {
    result = ON;
                 ...
                 GTK_TOGGLE_BUTTON(radiobutton_italics_inherit))) {
    result = INHERIT;
  } else if (gtk_toggle_button_get_active(
                 GTK_TOGGLE_BUTTON(radiobutton_italics_toggle))) {
    result = TOGGLE;
  }
  return result;
}
...
void StylesheetDialog::set_bold() {
  if (bold == ON) {
    ...
    gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(radiobutton_bold_toggle),
                                 true);
...
ustring StylesheetDialog::get_bold() {
  ...
  if (gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(radiobutton_bold_on))) {
    result = ON;
                 ...
                 GTK_TOGGLE_BUTTON(radiobutton_bold_inherit))) {
    result = INHERIT;
  } else if (gtk_toggle_button_get_active(
                 GTK_TOGGLE_BUTTON(radiobutton_bold_toggle))) {
    result = TOGGLE;
  }
  return result;
}
...
void StylesheetDialog::set_underline() {
  if (underline == ON) {
    gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(radiobutton_underline_on),
                                 true);
    on_radiobutton_underline(radiobutton_underline_on);
  } else if (underline == INHERIT) {
    gtk_toggle_button_set_active(
        GTK_TOGGLE_BUTTON(radiobutton_underline_inherit), true);
    on_radiobutton_underline(radiobutton_underline_inherit);
  } else if (underline == TOGGLE) {
    gtk_toggle_button_set_active(
        GTK_TOGGLE_BUTTON(radiobutton_underline_toggle), true);
    on_radiobutton_underline(radiobutton_underline_toggle);
  } else {
    gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(radiobutton_underline_off),
                                 true);
...
ustring StylesheetDialog::get_underline() {
  ...
  if (gtk_toggle_button_get_active(
          GTK_TOGGLE_BUTTON(radiobutton_underline_on))) {
    result = ON;
  } else if (gtk_toggle_button_get_active(
                 GTK_TOGGLE_BUTTON(radiobutton_underline_inherit))) {
    result = INHERIT;
  } else if (gtk_toggle_button_get_active(
                 GTK_TOGGLE_BUTTON(radiobutton_underline_toggle))) {
    result = TOGGLE;
  }
  return result;
}
...
void StylesheetDialog::set_small_caps() {
  if (smallcaps == ON) {
    gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(radiobutton_small_caps_on),
                                 true);
    on_radiobutton_small_caps(radiobutton_small_caps_on);
  } else if (smallcaps == INHERIT) {
    gtk_toggle_button_set_active(
        GTK_TOGGLE_BUTTON(radiobutton_small_caps_inherit), true);
    on_radiobutton_small_caps(radiobutton_small_caps_inherit);
  } else if (smallcaps == TOGGLE) {
    gtk_toggle_button_set_active(
        GTK_TOGGLE_BUTTON(radiobutton_small_caps_toggle), true);
    on_radiobutton_small_caps(radiobutton_small_caps_toggle);
  } else {
    gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(radiobutton_small_caps_off),
                                 true);
...
ustring StylesheetDialog::get_small_caps() {
  ...
  ustring result = OFF;
  if (gtk_toggle_button_get_active(
          GTK_TOGGLE_BUTTON(radiobutton_small_caps_on))) {
    result = ON;
  } else if (gtk_toggle_button_get_active(
                 GTK_TOGGLE_BUTTON(radiobutton_small_caps_inherit))) {
    result = INHERIT;
  } else if (gtk_toggle_button_get_active(
                 GTK_TOGGLE_BUTTON(radiobutton_small_caps_toggle))) {
    result = TOGGLE;
  }
  return result;
}
...
StyleType StylesheetDialog::get_styletype() {
  ...
  if (gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(radiobutton_id))) {
    type = stIdentifier;
                 ...
                 GTK_TOGGLE_BUTTON(radiobutton_paragraph))) {
    type = stStartsParagraph;
  } else if (gtk_toggle_button_get_active(
                 GTK_TOGGLE_BUTTON(radiobutton_inline))) {
    type = stInlineText;
  } else if (gtk_toggle_button_get_active(
                 GTK_TOGGLE_BUTTON(radiobutton_chapter))) {
    type = stChapterNumber;
  } else if (gtk_toggle_button_get_active(
                 GTK_TOGGLE_BUTTON(radiobutton_verse))) {
    type = stVerseNumber;
  } else if (gtk_toggle_button_get_active(
                 GTK_TOGGLE_BUTTON(radiobutton_footendnote))) {
    type = stFootEndNote;
  } else if (gtk_toggle_button_get_active(
                 GTK_TOGGLE_BUTTON(radiobutton_crossreference))) {
    type = stCrossreference;
  } else if (gtk_toggle_button_get_active(
                 GTK_TOGGLE_BUTTON(radiobutton_peripheral))) {
    type = stPeripheral;
  } else if (gtk_toggle_button_get_active(
                 GTK_TOGGLE_BUTTON(radiobutton_picture))) {
    type = stPicture;
  } else if (gtk_toggle_button_get_active(
                 GTK_TOGGLE_BUTTON(radiobutton_pagebreak))) {
    type = stPageBreak;
  } else if (gtk_toggle_button_get_active(
                 GTK_TOGGLE_BUTTON(radiobutton_table_element))) {
    type = stTableElement;
  } else if (gtk_toggle_button_get_active(
                 GTK_TOGGLE_BUTTON(radiobutton_wordlist_element))) {
    type = stWordlistElement;
  }
  return type;
}

void StylesheetDialog::on_radiobutton_italic_toggled(
    GtkToggleButton *togglebutton, gpointer user_data) {
  ((StylesheetDialog *)user_data)
      ->on_radiobutton_italic(GTK_WIDGET(togglebutton));
}
...
void StylesheetDialog::on_radiobutton_bold_toggled(
    GtkToggleButton *togglebutton, gpointer user_data) {
  ((StylesheetDialog *)user_data)
      ->on_radiobutton_bold(GTK_WIDGET(togglebutton));
}
...
void StylesheetDialog::on_radiobutton_underline_toggled(
    GtkToggleButton *togglebutton, gpointer user_data) {
  ((StylesheetDialog *)user_data)
      ->on_radiobutton_underline(GTK_WIDGET(togglebutton));
}
...
void StylesheetDialog::on_radiobutton_small_caps_toggled(
    GtkToggleButton *togglebutton, gpointer user_data) {
  ((StylesheetDialog *)user_data)
      ->on_radiobutton_small_caps(GTK_WIDGET(togglebutton));
}
...
void StylesheetDialog::set_subtype(StyleType maintype, int subtype) {
  ...
  case stNotUsedRunningHeader: {
    ...
    case itBook:
      gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(radiobutton_id_book),
                                   true);
      break;
    case itEncoding:
      gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(radiobutton_id_encoding),
                                   true);
      break;
    case itComment:
      gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(radiobutton_id_comment),
                                   true);
      break;
    case itRunningHeader:
      gtk_toggle_button_set_active(
          GTK_TOGGLE_BUTTON(radiobutton_id_running_header), true);
      break;
    case itLongTOC:
      gtk_toggle_button_set_active(
          GTK_TOGGLE_BUTTON(radiobutton_is_long_toc_text), true);
      break;
    case itShortTOC:
      gtk_toggle_button_set_active(
          GTK_TOGGLE_BUTTON(radiobutton_is_short_toc_text), true);
      break;
    case itBookAbbrev:
      gtk_toggle_button_set_active(
          GTK_TOGGLE_BUTTON(radiobutton_is_book_abbrev), true);
      break;
    case itChapterLabel:
      gtk_toggle_button_set_active(
          GTK_TOGGLE_BUTTON(radiobutton_is_chapter_label), true);
      break;
    case itPublishedChapterMarker:
      gtk_toggle_button_set_active(
          GTK_TOGGLE_BUTTON(radiobutton_is_published_chapter_marker), true);
      break;
    case itCommentWithEndmarker:
      gtk_toggle_button_set_active(
          GTK_TOGGLE_BUTTON(radiobutton_id_comment_with_endmarker), true);
      break;
    }
    break;
  }
  case stStartsParagraph: {
    ...
    case ptMainTitle:
      gtk_toggle_button_set_active(
          GTK_TOGGLE_BUTTON(radiobutton_paragraph_type_main_title), true);
      break;
    case ptSubTitle:
      gtk_toggle_button_set_active(
          GTK_TOGGLE_BUTTON(radiobutton_paragraph_type_subtitle), true);
      break;
    case ptSectionHeading:
      gtk_toggle_button_set_active(
          GTK_TOGGLE_BUTTON(radiobutton_paragraph_type_section_heading), true);
      break;
    case ptNormalParagraph:
      gtk_toggle_button_set_active(
          GTK_TOGGLE_BUTTON(radiobutton_paragraph_type_text), true);
      break;
    }
    break;
  }
  ...
  case stFootEndNote: {
    ...
    switch (footnotetype) {
    case fentFootnote:
      gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(radiobutton_footnote),
                                   true);
      break;
    case fentEndnote:
      gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(radiobutton_endnote),
                                   true);
      break;
    ...
    case fentContentWithEndmarker:
      gtk_toggle_button_set_active(
          GTK_TOGGLE_BUTTON(radiobutton_note_content_endmarker), true);
      break;
    case fentParagraph:
      gtk_toggle_button_set_active(
          GTK_TOGGLE_BUTTON(radiobutton_note_paragraph), true);
      break;
    }
    break;
  }
  case stCrossreference: {
    ...
    case ctStandardContent:
      ...
      break;
    case ctContent:
      gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(radiobutton_xref_content),
                                   true);
      break;
    case ctContentWithEndmarker:
      gtk_toggle_button_set_active(
          GTK_TOGGLE_BUTTON(radiobutton_xref_content_endmarker), true);
      break;
    }
    break;
  }
  case stPeripheral: {
    ...
    case ptPublication:
      gtk_toggle_button_set_active(
          GTK_TOGGLE_BUTTON(radiobutton_peripheral_pub), true);
      break;
    case ptTableOfContents:
      gtk_toggle_button_set_active(
          GTK_TOGGLE_BUTTON(radiobutton_peripheral_toc), true);
      break;
    case ptPreface:
      gtk_toggle_button_set_active(
          GTK_TOGGLE_BUTTON(radiobutton_peripheral_pref), true);
      break;
    case ptIntroduction:
      gtk_toggle_button_set_active(
          GTK_TOGGLE_BUTTON(radiobutton_peripheral_intro), true);
      break;
    case ptGlossary:
      gtk_toggle_button_set_active(
          GTK_TOGGLE_BUTTON(radiobutton_peripheral_conc), true);
      break;
    case ptConcordance:
      gtk_toggle_button_set_active(
          GTK_TOGGLE_BUTTON(radiobutton_peripheral_glo), true);
      break;
    case ptIndex:
      gtk_toggle_button_set_active(
          GTK_TOGGLE_BUTTON(radiobutton_peripheral_idx), true);
      break;
    case ptMapIndex:
      gtk_toggle_button_set_active(
          GTK_TOGGLE_BUTTON(radiobutton_peripheral_maps), true);
      break;
    case ptCover:
      gtk_toggle_button_set_active(
          GTK_TOGGLE_BUTTON(radiobutton_peripheral_cov), true);
      break;
    case ptSpine:
      gtk_toggle_button_set_active(
          GTK_TOGGLE_BUTTON(radiobutton_peripheral_spine), true);
      break;
    }
    break;
  }
  ...
  case stTableElement: {
    ...
    case tetRow:
      gtk_toggle_button_set_active(
          GTK_TOGGLE_BUTTON(radiobutton_table_sub_new_row), true);
      break;
    case tetHeading:
      gtk_toggle_button_set_active(
          GTK_TOGGLE_BUTTON(radiobutton_table_sub_heading), true);
      break;
    case tetCell:
      gtk_toggle_button_set_active(
          GTK_TOGGLE_BUTTON(radiobutton_table_sub_cell), true);
      break;
    }
    break;
  }
  case stWordlistElement: {
    ...
    case wltHebrewWordlistEntry:
      gtk_toggle_button_set_active(
          GTK_TOGGLE_BUTTON(radiobutton_subtype_hebrew_wordlist_entry), true);
      break;
    case wltGreekWordlistEntry:
      gtk_toggle_button_set_active(
          GTK_TOGGLE_BUTTON(radiobutton_subtype_greek_wordlist_entry), true);
      break;
    case wltSubjectIndexEntry:
      gtk_toggle_button_set_active(
          GTK_TOGGLE_BUTTON(radiobutton_subtype_subject_index_entry), true);
      break;
    }
    break;
  } break;
...
int StylesheetDialog::get_subtype() {
  ...
  case 1:
    ...
    if (gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(radiobutton_endnote)))
      subtype = fentEndnote;
    if (gtk_toggle_button_get_active(
            GTK_TOGGLE_BUTTON(radiobutton_note_content)))
      subtype = fentContent;
    if (gtk_toggle_button_get_active(
            GTK_TOGGLE_BUTTON(radiobutton_note_content_standard)))
      subtype = fentStandardContent;
    if (gtk_toggle_button_get_active(
            GTK_TOGGLE_BUTTON(radiobutton_note_content_endmarker)))
      subtype = fentContentWithEndmarker;
    if (gtk_toggle_button_get_active(
            GTK_TOGGLE_BUTTON(radiobutton_note_paragraph)))
  ...
  case 2:
    ...
    if (gtk_toggle_button_get_active(
            GTK_TOGGLE_BUTTON(radiobutton_xref_content_standard)))
      subtype = ctStandardContent;
    if (gtk_toggle_button_get_active(
            GTK_TOGGLE_BUTTON(radiobutton_xref_content)))
      subtype = ctContent;
    if (gtk_toggle_button_get_active(
            GTK_TOGGLE_BUTTON(radiobutton_xref_content_endmarker)))
      subtype = ctContentWithEndmarker;
    break;
  case 3:
    // Get subtype for paragraphs.
    if (gtk_toggle_button_get_active(
            GTK_TOGGLE_BUTTON(radiobutton_paragraph_type_main_title)))
      subtype = ptMainTitle;
    if (gtk_toggle_button_get_active(
            GTK_TOGGLE_BUTTON(radiobutton_paragraph_type_subtitle)))
      subtype = ptSubTitle;
    if (gtk_toggle_button_get_active(
            GTK_TOGGLE_BUTTON(radiobutton_paragraph_type_section_heading)))
      subtype = ptSectionHeading;
    if (gtk_toggle_button_get_active(
            GTK_TOGGLE_BUTTON(radiobutton_paragraph_type_text)))
      subtype = ptNormalParagraph;
    break;
  case 4:
    // Get subtype for peripherals.
    if (gtk_toggle_button_get_active(
            GTK_TOGGLE_BUTTON(radiobutton_peripheral_pub)))
      subtype = ptPublication;
    if (gtk_toggle_button_get_active(
            GTK_TOGGLE_BUTTON(radiobutton_peripheral_toc)))
      subtype = ptTableOfContents;
    if (gtk_toggle_button_get_active(
            GTK_TOGGLE_BUTTON(radiobutton_peripheral_pref)))
      subtype = ptPreface;
    if (gtk_toggle_button_get_active(
            GTK_TOGGLE_BUTTON(radiobutton_peripheral_intro)))
      subtype = ptIntroduction;
    if (gtk_toggle_button_get_active(
            GTK_TOGGLE_BUTTON(radiobutton_peripheral_glo)))
      subtype = ptGlossary;
    if (gtk_toggle_button_get_active(
            GTK_TOGGLE_BUTTON(radiobutton_peripheral_conc)))
      subtype = ptConcordance;
    if (gtk_toggle_button_get_active(
            GTK_TOGGLE_BUTTON(radiobutton_peripheral_idx)))
      subtype = ptIndex;
    if (gtk_toggle_button_get_active(
            GTK_TOGGLE_BUTTON(radiobutton_peripheral_maps)))
      subtype = ptMapIndex;
    if (gtk_toggle_button_get_active(
            GTK_TOGGLE_BUTTON(radiobutton_peripheral_cov)))
      subtype = ptCover;
    if (gtk_toggle_button_get_active(
            GTK_TOGGLE_BUTTON(radiobutton_peripheral_spine)))
      subtype = ptSpine;
    break;
  case 5:
    ...
    if (gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(radiobutton_id_book)))
      subtype = itBook;
    if (gtk_toggle_button_get_active(
            GTK_TOGGLE_BUTTON(radiobutton_id_encoding)))
      subtype = itEncoding;
    if (gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(radiobutton_id_comment)))
      subtype = itComment;
    if (gtk_toggle_button_get_active(
            GTK_TOGGLE_BUTTON(radiobutton_id_running_header)))
      subtype = itRunningHeader;
    if (gtk_toggle_button_get_active(
            GTK_TOGGLE_BUTTON(radiobutton_is_long_toc_text)))
      subtype = itLongTOC;
    if (gtk_toggle_button_get_active(
            GTK_TOGGLE_BUTTON(radiobutton_is_short_toc_text)))
      subtype = itShortTOC;
    if (gtk_toggle_button_get_active(
            GTK_TOGGLE_BUTTON(radiobutton_is_book_abbrev)))
      subtype = itBookAbbrev;
    if (gtk_toggle_button_get_active(
            GTK_TOGGLE_BUTTON(radiobutton_is_chapter_label)))
      subtype = itChapterLabel;
    if (gtk_toggle_button_get_active(
            GTK_TOGGLE_BUTTON(radiobutton_is_published_chapter_marker)))
      subtype = itPublishedChapterMarker;
    if (gtk_toggle_button_get_active(
            GTK_TOGGLE_BUTTON(radiobutton_id_comment_with_endmarker)))
      subtype = itCommentWithEndmarker;
    break;
  case 6:
    // Get subtype for table elements.
    if (gtk_toggle_button_get_active(
            GTK_TOGGLE_BUTTON(radiobutton_table_sub_new_row)))
      subtype = tetRow;
    if (gtk_toggle_button_get_active(
            GTK_TOGGLE_BUTTON(radiobutton_table_sub_heading)))
      subtype = tetHeading;
    if (gtk_toggle_button_get_active(
            GTK_TOGGLE_BUTTON(radiobutton_table_sub_cell)))
      subtype = tetCell;
    break;
  case 7:
    ...
    if (gtk_toggle_button_get_active(
            GTK_TOGGLE_BUTTON(radiobutton_subtype_hebrew_wordlist_entry)))
      subtype = wltHebrewWordlistEntry;
    if (gtk_toggle_button_get_active(
            GTK_TOGGLE_BUTTON(radiobutton_subtype_greek_wordlist_entry)))
      subtype = wltGreekWordlistEntry;
    if (gtk_toggle_button_get_active(
            GTK_TOGGLE_BUTTON(radiobutton_subtype_subject_index_entry)))
...
void StylesheetDialog::on_radiobutton_note_toggled(
    GtkToggleButton *togglebutton, gpointer user_data) {
...
void StylesheetDialog::on_radiobutton_xref_toggled(
    GtkToggleButton *togglebutton, gpointer user_data) {
 ...
 */
{
  ...
  if (hbox2) {
    ...
    fontsize_points =
        gtk_spin_button_get_value(GTK_SPIN_BUTTON(spinbuttonfontsize));
  ...
  if (checkbutton_superscript) {
    superscript = gtk_toggle_button_get_active(
        GTK_TOGGLE_BUTTON(checkbutton_superscript));
  ...
  if (vbox4) {
    ...
    firstlineindent =
        gtk_spin_button_get_value(GTK_SPIN_BUTTON(spinbutton_first));
  ...
  if (checkbutton_span) {
    spancolumns =
        gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(checkbutton_span)),
  ...
  if (checkbutton_apocrypha) {
    userbool1 =
        gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(checkbutton_apocrypha));
  ...
  if (vbox10) {
    if (gtk_toggle_button_get_active(
            GTK_TOGGLE_BUTTON(radiobutton_note_numbering_1)))
      userint1 = nntNumerical;
    if (gtk_toggle_button_get_active(
            GTK_TOGGLE_BUTTON(radiobutton_note_numbering_a)))
      userint1 = nntAlphabetical;
    if (gtk_toggle_button_get_active(
            GTK_TOGGLE_BUTTON(radiobutton_note_numbering_user)))
  ...
  if (hbox10) {
    if (gtk_toggle_button_get_active(
            GTK_TOGGLE_BUTTON(radiobutton_note_numbering_restart_never)))
      userint2 = nnrtNever;
    if (gtk_toggle_button_get_active(
            GTK_TOGGLE_BUTTON(radiobutton_note_numbering_restart_book)))
      userint2 = nnrtBook;
    if (gtk_toggle_button_get_active(
            GTK_TOGGLE_BUTTON(radiobutton_note_numbering_restart_chapter)))
  ...
  if (print_chapter_at_first_verse) {
    userbool1 = gtk_toggle_button_get_active(
        GTK_TOGGLE_BUTTON(print_chapter_at_first_verse));
  ...
  if (hbox_id) {
    userbool1 =
        gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(checkbutton_id_newpage));
    userbool2 =
        gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(checkbutton_id_oddpage));
  ...
  if (hbox13) {
    if (gtk_toggle_button_get_active(
            GTK_TOGGLE_BUTTON(radiobutton_print_endnotes_after_book)))
      userint2 = eptAfterBook;
    if (gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(
            radiobutton_print_endnotes_after_everything_else)))
      userint2 = eptAfterEverything;
    if (gtk_toggle_button_get_active(
            GTK_TOGGLE_BUTTON(radiobutton_print_endnotes_at_marker)))
  ...
  if (hbox15) {
    userint1 = gtk_spin_button_get_value_as_int(
        GTK_SPIN_BUTTON(spinbutton_column_number));
    gtk_widget_destroy(hbox15);
    hbox15 = NULL;
  }
  // Printing of chapter number in running headers.
  if (checkbutton_print_in_running_header_left) {
    userbool2 = gtk_toggle_button_get_active(
        GTK_TOGGLE_BUTTON(checkbutton_print_in_running_header_left));
    gtk_widget_destroy(checkbutton_print_in_running_header_left);
    checkbutton_print_in_running_header_left = NULL;
    userbool3 = gtk_toggle_button_get_active(
        GTK_TOGGLE_BUTTON(checkbutton_print_in_running_header_right));
  ...
  if (checkbutton_restarts_paragraph) {
    userbool1 = gtk_toggle_button_get_active(
        GTK_TOGGLE_BUTTON(checkbutton_restarts_paragraph));
...
void StylesheetDialog::fontsize_points_create() {
  ...
  spinbuttonfontsize =
      gtk_spin_button_new(GTK_ADJUSTMENT(spinbuttonfontsize_adj), 1, 1);
  ...
  gtk_spin_button_set_value(GTK_SPIN_BUTTON(spinbuttonfontsize),
                            fontsize_points);
}
...
void StylesheetDialog::italic_simple_create() {
  ...
  gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(checkbutton_italic),
                               italic == ON);
}
...
void StylesheetDialog::underline_simple_create() {
  ...
  gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(checkbutton_underline),
                               underline == ON);
}
...
void StylesheetDialog::smallcaps_simple_create() {
  ...
  gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(checkbutton_small_caps),
                               smallcaps == ON);
}
...
void StylesheetDialog::italic_bold_underline_smallcaps_extended_create() {
  ...
  gtk_table_attach(GTK_TABLE(table2), radiobutton_italics_off, 1, 2, 0, 1,
                   (GtkAttachOptions)(GTK_FILL), (GtkAttachOptions)(0), 0, 0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_italics_off),
                             radiobutton_italics_group);
  radiobutton_italics_group =
      gtk_radio_button_get_group(GTK_RADIO_BUTTON(radiobutton_italics_off));
  ...
  gtk_table_attach(GTK_TABLE(table2), radiobutton_italics_on, 2, 3, 0, 1,
                   (GtkAttachOptions)(GTK_FILL), (GtkAttachOptions)(0), 0, 0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_italics_on),
                             radiobutton_italics_group);
  radiobutton_italics_group =
      gtk_radio_button_get_group(GTK_RADIO_BUTTON(radiobutton_italics_on));

  radiobutton_italics_inherit =
      gtk_radio_button_new_with_mnemonic(NULL, _("Inherit"));
  gtk_widget_show(radiobutton_italics_inherit);
  gtk_table_attach(GTK_TABLE(table2), radiobutton_italics_inherit, 3, 4, 0, 1,
                   (GtkAttachOptions)(GTK_FILL), (GtkAttachOptions)(0), 0, 0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_italics_inherit),
                             radiobutton_italics_group);
  radiobutton_italics_group =
      gtk_radio_button_get_group(GTK_RADIO_BUTTON(radiobutton_italics_inherit));

  radiobutton_italics_toggle =
      gtk_radio_button_new_with_mnemonic(NULL, _("Toggle"));
  gtk_widget_show(radiobutton_italics_toggle);
  gtk_table_attach(GTK_TABLE(table2), radiobutton_italics_toggle, 4, 5, 0, 1,
                   (GtkAttachOptions)(GTK_FILL), (GtkAttachOptions)(0), 0, 0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_italics_toggle),
                             radiobutton_italics_group);
  radiobutton_italics_group =
      gtk_radio_button_get_group(GTK_RADIO_BUTTON(radiobutton_italics_toggle));
  ...
  gtk_table_attach(GTK_TABLE(table2), radiobutton_bold_off, 1, 2, 1, 2,
                   (GtkAttachOptions)(GTK_FILL), (GtkAttachOptions)(0), 0, 0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_bold_off),
                             radiobutton_bold_group);
  radiobutton_bold_group =
      gtk_radio_button_get_group(GTK_RADIO_BUTTON(radiobutton_bold_off));
  ...
  gtk_table_attach(GTK_TABLE(table2), radiobutton_bold_on, 2, 3, 1, 2,
                   (GtkAttachOptions)(GTK_FILL), (GtkAttachOptions)(0), 0, 0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_bold_on),
                             radiobutton_bold_group);
  radiobutton_bold_group =
      gtk_radio_button_get_group(GTK_RADIO_BUTTON(radiobutton_bold_on));

  radiobutton_bold_inherit =
      gtk_radio_button_new_with_mnemonic(NULL, _("Inherit"));
  gtk_widget_show(radiobutton_bold_inherit);
  gtk_table_attach(GTK_TABLE(table2), radiobutton_bold_inherit, 3, 4, 1, 2,
                   (GtkAttachOptions)(GTK_FILL), (GtkAttachOptions)(0), 0, 0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_bold_inherit),
                             radiobutton_bold_group);
  radiobutton_bold_group =
      gtk_radio_button_get_group(GTK_RADIO_BUTTON(radiobutton_bold_inherit));

  radiobutton_bold_toggle =
      gtk_radio_button_new_with_mnemonic(NULL, _("Toggle"));
  gtk_widget_show(radiobutton_bold_toggle);
  gtk_table_attach(GTK_TABLE(table2), radiobutton_bold_toggle, 4, 5, 1, 2,
                   (GtkAttachOptions)(GTK_FILL), (GtkAttachOptions)(0), 0, 0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_bold_toggle),
                             radiobutton_bold_group);
  radiobutton_bold_group =
      gtk_radio_button_get_group(GTK_RADIO_BUTTON(radiobutton_bold_toggle));

  radiobutton_underline_off =
      gtk_radio_button_new_with_mnemonic(NULL, _("Off"));
  gtk_widget_show(radiobutton_underline_off);
  gtk_table_attach(GTK_TABLE(table2), radiobutton_underline_off, 1, 2, 2, 3,
                   (GtkAttachOptions)(GTK_FILL), (GtkAttachOptions)(0), 0, 0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_underline_off),
                             radiobutton_underline_group);
  radiobutton_underline_group =
      gtk_radio_button_get_group(GTK_RADIO_BUTTON(radiobutton_underline_off));
  ...
  gtk_table_attach(GTK_TABLE(table2), radiobutton_underline_on, 2, 3, 2, 3,
                   (GtkAttachOptions)(GTK_FILL), (GtkAttachOptions)(0), 0, 0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_underline_on),
                             radiobutton_underline_group);
  radiobutton_underline_group =
      gtk_radio_button_get_group(GTK_RADIO_BUTTON(radiobutton_underline_on));

  radiobutton_underline_inherit =
      gtk_radio_button_new_with_mnemonic(NULL, _("Inherit"));
  gtk_widget_show(radiobutton_underline_inherit);
  gtk_table_attach(GTK_TABLE(table2), radiobutton_underline_inherit, 3, 4, 2, 3,
                   (GtkAttachOptions)(GTK_FILL), (GtkAttachOptions)(0), 0, 0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_underline_inherit),
                             radiobutton_underline_group);
  radiobutton_underline_group = gtk_radio_button_get_group(
      GTK_RADIO_BUTTON(radiobutton_underline_inherit));
  ...
  gtk_table_attach(GTK_TABLE(table2), radiobutton_underline_toggle, 4, 5, 2, 3,
                   (GtkAttachOptions)(GTK_FILL), (GtkAttachOptions)(0), 0, 0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_underline_toggle),
                             radiobutton_underline_group);
  radiobutton_underline_group = gtk_radio_button_get_group(
      GTK_RADIO_BUTTON(radiobutton_underline_toggle));

  radiobutton_small_caps_off =
      gtk_radio_button_new_with_mnemonic(NULL, _("Off"));
  gtk_widget_show(radiobutton_small_caps_off);
  gtk_table_attach(GTK_TABLE(table2), radiobutton_small_caps_off, 1, 2, 3, 4,
                   (GtkAttachOptions)(GTK_FILL), (GtkAttachOptions)(0), 0, 0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_small_caps_off),
                             radiobutton_small_caps_group);
  radiobutton_small_caps_group =
      gtk_radio_button_get_group(GTK_RADIO_BUTTON(radiobutton_small_caps_off));
  ...
  gtk_table_attach(GTK_TABLE(table2), radiobutton_small_caps_on, 2, 3, 3, 4,
                   (GtkAttachOptions)(GTK_FILL), (GtkAttachOptions)(0), 0, 0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_small_caps_on),
                             radiobutton_small_caps_group);
  radiobutton_small_caps_group =
      gtk_radio_button_get_group(GTK_RADIO_BUTTON(radiobutton_small_caps_on));

  radiobutton_small_caps_inherit =
      gtk_radio_button_new_with_mnemonic(NULL, _("Inherit"));
  gtk_widget_show(radiobutton_small_caps_inherit);
  gtk_table_attach(GTK_TABLE(table2), radiobutton_small_caps_inherit, 3, 4, 3,
                   4, (GtkAttachOptions)(GTK_FILL), (GtkAttachOptions)(0), 0,
                   0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_small_caps_inherit),
                             radiobutton_small_caps_group);
  radiobutton_small_caps_group = gtk_radio_button_get_group(
      GTK_RADIO_BUTTON(radiobutton_small_caps_inherit));

  radiobutton_small_caps_toggle =
      gtk_radio_button_new_with_mnemonic(NULL, _("Toggle"));
  gtk_widget_show(radiobutton_small_caps_toggle);
  gtk_table_attach(GTK_TABLE(table2), radiobutton_small_caps_toggle, 4, 5, 3, 4,
                   (GtkAttachOptions)(GTK_FILL), (GtkAttachOptions)(0), 0, 0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_small_caps_toggle),
                             radiobutton_small_caps_group);
  radiobutton_small_caps_group = gtk_radio_button_get_group(
      GTK_RADIO_BUTTON(radiobutton_small_caps_toggle));

  g_signal_connect((gpointer)radiobutton_italics_off, "toggled",
                   G_CALLBACK(on_radiobutton_italic_toggled), gpointer(this));
  g_signal_connect((gpointer)radiobutton_italics_on, "toggled",
                   G_CALLBACK(on_radiobutton_italic_toggled), gpointer(this));
  g_signal_connect((gpointer)radiobutton_italics_inherit, "toggled",
                   G_CALLBACK(on_radiobutton_italic_toggled), gpointer(this));
  g_signal_connect((gpointer)radiobutton_italics_toggle, "toggled",
                   G_CALLBACK(on_radiobutton_italic_toggled), gpointer(this));
  g_signal_connect((gpointer)radiobutton_bold_off, "toggled",
                   G_CALLBACK(on_radiobutton_bold_toggled), gpointer(this));
  g_signal_connect((gpointer)radiobutton_bold_on, "toggled",
                   G_CALLBACK(on_radiobutton_bold_toggled), gpointer(this));
  g_signal_connect((gpointer)radiobutton_bold_inherit, "toggled",
                   G_CALLBACK(on_radiobutton_bold_toggled), gpointer(this));
  g_signal_connect((gpointer)radiobutton_bold_toggle, "toggled",
                   G_CALLBACK(on_radiobutton_bold_toggled), gpointer(this));
  g_signal_connect((gpointer)radiobutton_underline_off, "toggled",
                   G_CALLBACK(on_radiobutton_underline_toggled),
                   gpointer(this));
  g_signal_connect((gpointer)radiobutton_underline_on, "toggled",
                   G_CALLBACK(on_radiobutton_underline_toggled),
                   gpointer(this));
  g_signal_connect((gpointer)radiobutton_underline_inherit, "toggled",
                   G_CALLBACK(on_radiobutton_underline_toggled),
                   gpointer(this));
  g_signal_connect((gpointer)radiobutton_underline_toggle, "toggled",
                   G_CALLBACK(on_radiobutton_underline_toggled),
                   gpointer(this));
  g_signal_connect((gpointer)radiobutton_small_caps_off, "toggled",
                   G_CALLBACK(on_radiobutton_small_caps_toggled),
                   gpointer(this));
  g_signal_connect((gpointer)radiobutton_small_caps_on, "toggled",
                   G_CALLBACK(on_radiobutton_small_caps_toggled),
                   gpointer(this));
  g_signal_connect((gpointer)radiobutton_small_caps_inherit, "toggled",
                   G_CALLBACK(on_radiobutton_small_caps_toggled),
                   gpointer(this));
  g_signal_connect((gpointer)radiobutton_small_caps_toggle, "toggled",
                   G_CALLBACK(on_radiobutton_small_caps_toggled),
                   gpointer(this));
...
void StylesheetDialog::superscript_create() {
  checkbutton_superscript =
      gtk_check_button_new_with_mnemonic(_("Su_perscript"));
  gtk_widget_show(checkbutton_superscript);
  gtk_box_pack_start(GTK_BOX(vbox6), checkbutton_superscript, FALSE, FALSE, 0);

  gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(checkbutton_superscript),
                               superscript);
}

void StylesheetDialog::paragraph_create(const gchar *label,
                                        bool grey_out_justify)
/*
 ...
 */
{
  ...
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_left),
                             radiobutton_left_group);
  radiobutton_left_group =
      gtk_radio_button_get_group(GTK_RADIO_BUTTON(radiobutton_left));
  ...
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_center),
                             radiobutton_left_group);
  radiobutton_left_group =
      gtk_radio_button_get_group(GTK_RADIO_BUTTON(radiobutton_center));
  ...
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_right),
                             radiobutton_left_group);
  radiobutton_left_group =
      gtk_radio_button_get_group(GTK_RADIO_BUTTON(radiobutton_right));
  ...
  spinbutton_first =
      gtk_spin_button_new(GTK_ADJUSTMENT(spinbutton_first_adj), 1, 1);
  ...
  spinbutton_before =
      gtk_spin_button_new(GTK_ADJUSTMENT(spinbutton_before_adj), 1, 1);
  ...
  spinbutton_after =
      gtk_spin_button_new(GTK_ADJUSTMENT(spinbutton_after_adj), 1, 1);
  ...
  spinbutton_left =
      gtk_spin_button_new(GTK_ADJUSTMENT(spinbutton_left_adj), 1, 1);
  ...
  spinbutton_right =
      gtk_spin_button_new(GTK_ADJUSTMENT(spinbutton_right_adj), 1, 1);
  ...
  g_signal_connect((gpointer)radiobutton_left, "toggled",
                   G_CALLBACK(on_alignment_toggled), gpointer(this));
  g_signal_connect((gpointer)radiobutton_center, "toggled",
                   G_CALLBACK(on_alignment_toggled), gpointer(this));
  g_signal_connect((gpointer)radiobutton_right, "toggled",
                   G_CALLBACK(on_alignment_toggled), gpointer(this));
...
void StylesheetDialog::span_columns_create() {
  checkbutton_span =
      gtk_check_button_new_with_mnemonic(_("Spans the t_wo columns"));
  gtk_widget_show(checkbutton_span);
  gtk_box_pack_start(GTK_BOX(vbox6), checkbutton_span, FALSE, FALSE, 0);

  gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(checkbutton_span),
                               spancolumns);
}

void StylesheetDialog::apocrypha_create() {
  checkbutton_apocrypha =
      gtk_check_button_new_with_mnemonic(_("Refers to the Apocrypha"));
  gtk_widget_show(checkbutton_apocrypha);
  gtk_box_pack_start(GTK_BOX(vbox6), checkbutton_apocrypha, FALSE, FALSE, 0);

  gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(checkbutton_apocrypha),
                               userbool1);
}
...
void StylesheetDialog::note_numbering_type_create() {
  ...
  radiobutton_note_numbering_1 =
      gtk_radio_button_new_with_mnemonic(NULL, "1, 2, 3 ...");
  gtk_widget_show(radiobutton_note_numbering_1);
  gtk_box_pack_start(GTK_BOX(vbox11), radiobutton_note_numbering_1, FALSE,
                     FALSE, 0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_note_numbering_1),
                             radiobutton_note_numbering_1_group);
  radiobutton_note_numbering_1_group = gtk_radio_button_get_group(
      GTK_RADIO_BUTTON(radiobutton_note_numbering_1));

  radiobutton_note_numbering_a =
      gtk_radio_button_new_with_mnemonic(NULL, _("a, b, c ..."));
  gtk_widget_show(radiobutton_note_numbering_a);
  gtk_box_pack_start(GTK_BOX(vbox11), radiobutton_note_numbering_a, FALSE,
                     FALSE, 0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_note_numbering_a),
                             radiobutton_note_numbering_1_group);
  radiobutton_note_numbering_1_group = gtk_radio_button_get_group(
      GTK_RADIO_BUTTON(radiobutton_note_numbering_a));

  radiobutton_note_numbering_user =
      gtk_radio_button_new_with_mnemonic(NULL, _("User defined"));
  gtk_widget_show(radiobutton_note_numbering_user);
  gtk_box_pack_start(GTK_BOX(vbox11), radiobutton_note_numbering_user, FALSE,
                     FALSE, 0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_note_numbering_user),
                             radiobutton_note_numbering_1_group);
  radiobutton_note_numbering_1_group = gtk_radio_button_get_group(
      GTK_RADIO_BUTTON(radiobutton_note_numbering_user));
  ...
  g_signal_connect((gpointer)radiobutton_note_numbering_1, "toggled",
                   G_CALLBACK(on_radiobutton_note_numbering_toggled),
                   gpointer(this));
  g_signal_connect((gpointer)radiobutton_note_numbering_a, "toggled",
                   G_CALLBACK(on_radiobutton_note_numbering_toggled),
                   gpointer(this));
  g_signal_connect((gpointer)radiobutton_note_numbering_user, "toggled",
                   G_CALLBACK(on_radiobutton_note_numbering_toggled),
                   gpointer(this));
  ...
  case nntNumerical: {
    gtk_toggle_button_set_active(
        GTK_TOGGLE_BUTTON(radiobutton_note_numbering_1), true);
    break;
  }
  case nntAlphabetical: {
    gtk_toggle_button_set_active(
        GTK_TOGGLE_BUTTON(radiobutton_note_numbering_a), true);
    break;
  }
  case nntUserDefined: {
    gtk_toggle_button_set_active(
        GTK_TOGGLE_BUTTON(radiobutton_note_numbering_user), true);
    break;
  }
  }
...
void StylesheetDialog::note_numering_restart_create() {
  ...
  radiobutton_note_numbering_restart_never =
      gtk_radio_button_new_with_mnemonic(NULL, _("never"));
  gtk_widget_show(radiobutton_note_numbering_restart_never);
  gtk_box_pack_start(GTK_BOX(vbox12), radiobutton_note_numbering_restart_never,
                     FALSE, FALSE, 0);
  gtk_radio_button_set_group(
      GTK_RADIO_BUTTON(radiobutton_note_numbering_restart_never),
      radiobutton_note_numbering_restart_never_group);
  radiobutton_note_numbering_restart_never_group = gtk_radio_button_get_group(
      GTK_RADIO_BUTTON(radiobutton_note_numbering_restart_never));

  radiobutton_note_numbering_restart_book =
      gtk_radio_button_new_with_mnemonic(NULL, _("every book"));
  gtk_widget_show(radiobutton_note_numbering_restart_book);
  gtk_box_pack_start(GTK_BOX(vbox12), radiobutton_note_numbering_restart_book,
                     FALSE, FALSE, 0);
  gtk_radio_button_set_group(
      GTK_RADIO_BUTTON(radiobutton_note_numbering_restart_book),
      radiobutton_note_numbering_restart_never_group);
  radiobutton_note_numbering_restart_never_group = gtk_radio_button_get_group(
      GTK_RADIO_BUTTON(radiobutton_note_numbering_restart_book));

  radiobutton_note_numbering_restart_chapter =
      gtk_radio_button_new_with_mnemonic(NULL, _("every chapter"));
  gtk_widget_show(radiobutton_note_numbering_restart_chapter);
  gtk_box_pack_start(GTK_BOX(vbox12),
                     radiobutton_note_numbering_restart_chapter, FALSE, FALSE,
                     0);
  gtk_radio_button_set_group(
      GTK_RADIO_BUTTON(radiobutton_note_numbering_restart_chapter),
      radiobutton_note_numbering_restart_never_group);
  radiobutton_note_numbering_restart_never_group = gtk_radio_button_get_group(
      GTK_RADIO_BUTTON(radiobutton_note_numbering_restart_chapter));

  NoteNumberingRestartType note_numbering_type =
      (NoteNumberingRestartType)userint2;
  switch (note_numbering_type) {
  case nnrtNever: {
    gtk_toggle_button_set_active(
        GTK_TOGGLE_BUTTON(radiobutton_note_numbering_restart_never), true);
    break;
  }
  case nnrtBook: {
    gtk_toggle_button_set_active(
        GTK_TOGGLE_BUTTON(radiobutton_note_numbering_restart_book), true);
    break;
  }
  default: {
    gtk_toggle_button_set_active(
        GTK_TOGGLE_BUTTON(radiobutton_note_numbering_restart_chapter), true);
    break;
  }
  }
}

void StylesheetDialog::on_radiobutton_note_numbering_toggled(
    GtkToggleButton *togglebutton, gpointer user_data) {
...
void StylesheetDialog::print_chapter_at_first_verse_create() {
  print_chapter_at_first_verse = gtk_check_button_new_with_mnemonic(
      _("Print chapter number at the first verse"));
  gtk_widget_show(print_chapter_at_first_verse);
  gtk_box_pack_start(GTK_BOX(vbox6), print_chapter_at_first_verse, FALSE, FALSE,
                     0);

  g_signal_connect(
      (gpointer)print_chapter_at_first_verse, "toggled",
      G_CALLBACK(on_radiobutton_print_chapter_at_first_verse_create_toggled),
      gpointer(this));

  gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(print_chapter_at_first_verse),
                               userbool1);
}

void StylesheetDialog::
    on_radiobutton_print_chapter_at_first_verse_create_toggled(
        GtkToggleButton *togglebutton, gpointer user_data) {
  ((StylesheetDialog *)user_data)
      ->on_radiobutton_print_chapter_at_first_verse_create();
}
...
void StylesheetDialog::book_id_new_page_create() {
  ...
  checkbutton_id_newpage =
      gtk_check_button_new_with_mnemonic(_("Start on a new page"));
  ...
  checkbutton_id_oddpage =
      gtk_check_button_new_with_mnemonic(_("with an odd number"));
  gtk_widget_show(checkbutton_id_oddpage);
  gtk_box_pack_start(GTK_BOX(hbox_id), checkbutton_id_oddpage, FALSE, FALSE, 0);

  gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(checkbutton_id_newpage),
                               userbool1);
  gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(checkbutton_id_oddpage),
                               userbool2);

  g_signal_connect((gpointer)checkbutton_id_newpage, "toggled",
                   G_CALLBACK(on_checkbutton_id_newpage_toggled),
                   gpointer(this));

  on_checkbutton_id_newpage();
}

void StylesheetDialog::on_radiobutton_identifier_toggled(
    GtkToggleButton *togglebutton, gpointer user_data) {
...
void StylesheetDialog::on_checkbutton_id_newpage_toggled(
    GtkToggleButton *togglebutton, gpointer user_data) {
...
void StylesheetDialog::end_note_placement_create() {
  ...
  radiobutton_print_endnotes_after_book =
      gtk_radio_button_new_with_mnemonic(NULL, _("after each book"));
  gtk_widget_show(radiobutton_print_endnotes_after_book);
  gtk_box_pack_start(GTK_BOX(vbox16), radiobutton_print_endnotes_after_book,
                     FALSE, FALSE, 0);
  gtk_radio_button_set_group(
      GTK_RADIO_BUTTON(radiobutton_print_endnotes_after_book),
      radiobutton_print_endnotes_after_book_group);
  radiobutton_print_endnotes_after_book_group = gtk_radio_button_get_group(
      GTK_RADIO_BUTTON(radiobutton_print_endnotes_after_book));

  radiobutton_print_endnotes_after_everything_else =
      gtk_radio_button_new_with_mnemonic(NULL, _("after everything else"));
  gtk_widget_show(radiobutton_print_endnotes_after_everything_else);
  gtk_box_pack_start(GTK_BOX(vbox16),
                     radiobutton_print_endnotes_after_everything_else, FALSE,
                     FALSE, 0);
  gtk_radio_button_set_group(
      GTK_RADIO_BUTTON(radiobutton_print_endnotes_after_everything_else),
      radiobutton_print_endnotes_after_book_group);
  radiobutton_print_endnotes_after_book_group = gtk_radio_button_get_group(
      GTK_RADIO_BUTTON(radiobutton_print_endnotes_after_everything_else));
  ...
  radiobutton_print_endnotes_at_marker =
      gtk_radio_button_new_with_mnemonic(NULL, _("upon encountering marker"));
  gtk_widget_show(radiobutton_print_endnotes_at_marker);
  gtk_box_pack_start(GTK_BOX(hbox14), radiobutton_print_endnotes_at_marker,
                     FALSE, FALSE, 0);
  gtk_radio_button_set_group(
      GTK_RADIO_BUTTON(radiobutton_print_endnotes_at_marker),
      radiobutton_print_endnotes_after_book_group);
  radiobutton_print_endnotes_after_book_group = gtk_radio_button_get_group(
      GTK_RADIO_BUTTON(radiobutton_print_endnotes_at_marker));
  ...
  gtk_box_pack_start(GTK_BOX(hbox14), entry_print_endnotes_marker, FALSE, FALSE,
                     0);
  ...
  case eptAfterBook: {
    gtk_toggle_button_set_active(
        GTK_TOGGLE_BUTTON(radiobutton_print_endnotes_after_book), true);
    break;
  }
  case eptAfterEverything: {
    gtk_toggle_button_set_active(
        GTK_TOGGLE_BUTTON(radiobutton_print_endnotes_after_everything_else),
        true);
    break;
  }
  case eptAtMarker: {
    gtk_toggle_button_set_active(
        GTK_TOGGLE_BUTTON(radiobutton_print_endnotes_at_marker), true);
    break;
  }
  }
  on_radiobutton_print_endnotes_at_marker();
  gtk_entry_set_text(GTK_ENTRY(entry_print_endnotes_marker),
                     userstring2.c_str());
}

void StylesheetDialog::on_radiobutton_print_endnotes_at_marker_toggled(
    GtkToggleButton *togglebutton, gpointer user_data) {
...
void StylesheetDialog::on_radiobutton_print_endnotes_at_marker() {
  gtk_widget_set_sensitive(entry_print_endnotes_marker,
                           gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(
                               radiobutton_print_endnotes_at_marker)));
}

void StylesheetDialog::on_checkbutton_table_element_toggled(
    GtkToggleButton *togglebutton, gpointer user_data) {
...
void StylesheetDialog::on_radiobutton_subtype_wordlist_toggled(
    GtkToggleButton *togglebutton, gpointer user_data) {
...
void StylesheetDialog::column_number_create() {
  ...
  spinbutton_column_number =
      gtk_spin_button_new(GTK_ADJUSTMENT(spinbutton_column_number_adj), 1, 0);
  gtk_widget_show(spinbutton_column_number);
  gtk_box_pack_start(GTK_BOX(hbox15), spinbutton_column_number, FALSE, FALSE,
                     0);
  gtk_spin_button_set_numeric(GTK_SPIN_BUTTON(spinbutton_column_number), TRUE);

  // Make the settings.
  gtk_spin_button_set_value(GTK_SPIN_BUTTON(spinbutton_column_number),
                            userint1);
}

void StylesheetDialog::print_in_running_header_create() {
  checkbutton_print_in_running_header_left = gtk_check_button_new_with_mnemonic(
      _("Print this in running header of left page"));
  gtk_widget_show(checkbutton_print_in_running_header_left);
  gtk_box_pack_start(GTK_BOX(vbox6), checkbutton_print_in_running_header_left,
                     FALSE, FALSE, 0);

  gtk_toggle_button_set_active(
      GTK_TOGGLE_BUTTON(checkbutton_print_in_running_header_left), userbool2);

  checkbutton_print_in_running_header_right =
      gtk_check_button_new_with_mnemonic(
          _("Print this in running header of right page"));
  gtk_widget_show(checkbutton_print_in_running_header_right);
  gtk_box_pack_start(GTK_BOX(vbox6), checkbutton_print_in_running_header_right,
                     FALSE, FALSE, 0);

  gtk_toggle_button_set_active(
      GTK_TOGGLE_BUTTON(checkbutton_print_in_running_header_right), userbool3);
}
...
void StylesheetDialog::restarts_paragraph_create() {
  checkbutton_restarts_paragraph =
      gtk_check_button_new_with_mnemonic(_("Restart paragraph"));
  gtk_widget_show(checkbutton_restarts_paragraph);
  gtk_box_pack_start(GTK_BOX(vbox6), checkbutton_restarts_paragraph, FALSE,
                     FALSE, 0);

  gtk_toggle_button_set_active(
      GTK_TOGGLE_BUTTON(checkbutton_restarts_paragraph), userbool1);
}
