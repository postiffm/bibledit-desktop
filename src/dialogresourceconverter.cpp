...
ResourceConverterDialog::ResourceConverterDialog(
    const ustring &working_directory) {
  ...
  gtk_window_set_title(GTK_WINDOW(resourceconverterdialog),
                       _("Resource Converter"));
  gtk_window_set_position(GTK_WINDOW(resourceconverterdialog),
                          GTK_WIN_POS_CENTER_ON_PARENT);
  gtk_window_set_modal(GTK_WINDOW(resourceconverterdialog), TRUE);

  dialog_vbox1 =
      gtk_dialog_get_content_area(GTK_DIALOG(resourceconverterdialog));
  ...
  // Dialog action.
  dialog_action_area1 =
      gtk_dialog_get_action_area(GTK_DIALOG(resourceconverterdialog));
  gtk_widget_show(dialog_action_area1);
  gtk_button_box_set_layout(GTK_BUTTON_BOX(dialog_action_area1),
                            GTK_BUTTONBOX_END);

  new InDialogHelp(resourceconverterdialog, NULL, &shortcuts,
                   "file/resource/converter");

  helpbutton = gtk_button_new_from_stock("gtk-help");
  gtk_dialog_add_action_widget(GTK_DIALOG(resourceconverterdialog), helpbutton,
                               GTK_RESPONSE_NONE);

  cancelbutton = gtk_button_new_from_stock("gtk-cancel");
  gtk_widget_show(cancelbutton);
  gtk_dialog_add_action_widget(GTK_DIALOG(resourceconverterdialog),
  ...
  gtk_dialog_add_action_widget(GTK_DIALOG(resourceconverterdialog), okbutton,
                               GTK_RESPONSE_OK);
...
void ResourceConverterDialog::build_table_and_type(Shortcuts &shortcuts) {
  ...
  build_button(image_type_ok, label_type_ok, label_type_short, button_type,
               _("Type"), shortcuts, G_CALLBACK(on_type_button_clicked),
               label_type_long);
}

void ResourceConverterDialog::build_entry(
    GtkWidget *&image_ok, GtkWidget *&label_ok, GtkWidget *&label,
    const gchar *label_text, GtkWidget *&entry, const ustring &entry_text,
    GCallback handler) {
  GtkWidget *hseparator;
  hseparator = gtk_hseparator_new();
  gtk_widget_show(hseparator);
  gtk_table_attach(GTK_TABLE(table1), hseparator, 0, 4, table_attachment_offset,
                   table_attachment_offset + 1,
  ...
  gtk_table_attach(GTK_TABLE(table1), image_ok, 0, 1, table_attachment_offset,
                   table_attachment_offset + 1, (GtkAttachOptions)(0),
                   (GtkAttachOptions)(0), 0, 0);

  label_ok = gtk_label_new("");
  gtk_widget_show(label_ok);
  gtk_table_attach(GTK_TABLE(table1), label_ok, 1, 2, table_attachment_offset,
                   table_attachment_offset + 1, (GtkAttachOptions)(GTK_FILL),
                   (GtkAttachOptions)(0), 0, 0);
  gtk_misc_set_alignment(GTK_MISC(label_ok), 0, 0.5);

  label = gtk_label_new(label_text);
  gtk_widget_show(label);
  gtk_table_attach(GTK_TABLE(table1), label, 2, 4, table_attachment_offset,
                   table_attachment_offset + 1, (GtkAttachOptions)(GTK_FILL),
                   (GtkAttachOptions)(0), 0, 0);
  ...
  gtk_table_attach(GTK_TABLE(table1), entry, 0, 4, table_attachment_offset,
                   table_attachment_offset + 1,
                   (GtkAttachOptions)(GTK_EXPAND | GTK_FILL),
                   (GtkAttachOptions)(0), 0, 0);
  table_attachment_offset++;
...
void ResourceConverterDialog::build_button(
    GtkWidget *&image_ok, GtkWidget *&label_ok, GtkWidget *&label_short,
    GtkWidget *&button, const gchar *button_text, Shortcuts &shortcuts,
    GCallback handler, GtkWidget *&label_long) {
  GtkWidget *hseparator;
  hseparator = gtk_hseparator_new();
  gtk_widget_show(hseparator);
  gtk_table_attach(GTK_TABLE(table1), hseparator, 0, 4, table_attachment_offset,
  ...
  gtk_table_attach(GTK_TABLE(table1), label_short, 2, 3,
                   table_attachment_offset, table_attachment_offset + 1,
                   (GtkAttachOptions)(GTK_FILL), (GtkAttachOptions)(0), 0, 0);
  gtk_misc_set_alignment(GTK_MISC(label_short), 0, 0.5);

  button = gtk_button_new();
  gtk_widget_show(button);
  gtk_table_attach(GTK_TABLE(table1), button, 3, 4, table_attachment_offset,
                   table_attachment_offset + 1, (GtkAttachOptions)(GTK_FILL),
                   (GtkAttachOptions)(0), 0, 0);
  table_attachment_offset++;
  ...
  image_button_surface =
      gtk_image_new_from_stock("gtk-index", GTK_ICON_SIZE_BUTTON);
  ...
  gtk_table_attach(GTK_TABLE(table1), label_long, 0, 4, table_attachment_offset,
                   table_attachment_offset + 1, (GtkAttachOptions)(GTK_FILL),
                   (GtkAttachOptions)(0), 0, 0);
...
void ResourceConverterDialog::build_checkbutton_button(
    GtkWidget *&image_ok, GtkWidget *&label_ok, GtkWidget *&checkbutton,
    const gchar *checkbutton_text, GCallback checkbutton_handler,
    GtkWidget *&button, const gchar *button_text, GCallback button_handler,
    Shortcuts &shortcuts, GtkWidget *&label) {
  ...
  gtk_table_attach(GTK_TABLE(table1), checkbutton, 2, 3,
                   table_attachment_offset, table_attachment_offset + 1,
                   (GtkAttachOptions)(GTK_FILL), (GtkAttachOptions)(0), 0, 0);
  ...
  label = gtk_label_new("");
  gtk_widget_show(label);
  gtk_table_attach(GTK_TABLE(table1), label, 0, 4, table_attachment_offset,
                   table_attachment_offset + 1, (GtkAttachOptions)(GTK_FILL),
                   (GtkAttachOptions)(0), 0, 0);
  gtk_misc_set_alignment(GTK_MISC(label), 0, 0.5);
  table_attachment_offset++;

  g_signal_connect((gpointer)checkbutton, "toggled", checkbutton_handler,
                   gpointer(this));
  g_signal_connect((gpointer)button, "clicked", button_handler, gpointer(this));
}

void ResourceConverterDialog::build_textview(GtkWidget *&image_ok,
                                             GtkWidget *&label_ok,
                                             GtkWidget *&label,
                                             GtkWidget *&textview, gchar *text,
                                             GCallback handler) {
  GtkWidget *hseparator;
  hseparator = gtk_hseparator_new();
  gtk_widget_show(hseparator);
  ...
  gtk_table_attach(GTK_TABLE(table1), scrolledwindow, 0, 4,
                   table_attachment_offset, table_attachment_offset + 1,
  ...
  g_signal_connect((gpointer)textview, "key_press_event", handler,
                   gpointer(this));
}

// Entry, combo, entry.
void ResourceConverterDialog::build_entry_combo_entry(
    GtkWidget *&image_ok, GtkWidget *&label_ok, GtkWidget *&label,
    GtkWidget *&label_entry_1, GtkWidget *&entry_1, GtkWidget *&label_combo,
    GtkWidget *&combo, GtkWidget *&label_entry_2, GtkWidget *&entry_2,
  ...
  gtk_widget_show(hbox);
  gtk_table_attach(GTK_TABLE(table1), hbox, 0, 4, table_attachment_offset,
                   table_attachment_offset + 1, (GtkAttachOptions)(GTK_FILL),
                   (GtkAttachOptions)(GTK_EXPAND | GTK_FILL), 0, 0);
...
void ResourceConverterDialog::on_type_button_clicked(GtkButton *button,
                                                     gpointer user_data) {
...
void ResourceConverterDialog::on_type_button(bool no_ask) {
  ...
  if (!no_ask) {
    ...
    for (unsigned int i = 0; i < rctEnd; i++) {
      types.push_back(
          resource_conversion_type_to_text((ResourceConversionType)i));
    }
    ListviewDialog dialog(
        _("Select resource conversion type"), types,
        resource_conversion_type_to_text(resource_conversion_type), false,
        NULL);
...
bool ResourceConverterDialog::type_gui() {
  ...
  bool ok = !type.empty();
  gtk_label_set_text(GTK_LABEL(label_type_short),
                     _("Select the resource conversion type"));
...
void ResourceConverterDialog::build_gui(Shortcuts &shortcuts) {
  ...
  case rctChapterStartsAtPatternVerseOneStartsAtChapterVerseStartsAtPattern: {
    build_button(image_open_file_ok, label_open_file_ok, label_open_file_short,
                 button_open_file, _("Open"), shortcuts,
                 G_CALLBACK(on_open_file_button_clicked), label_open_file_long);

    build_button(image_view_file_ok, label_view_file_ok, label_view_file_short,
                 button_view_file_html, _("View"), shortcuts,
                 G_CALLBACK(on_view_file_button_clicked), label_view_file_long);

    build_entry_combo_entry(
        image_chapter_pattern_ok, label_chapter_pattern_ok,
        label_chapter_pattern, label_chapter_pattern_1, entry_chapter_pattern_1,
        label_chapter_pattern_combo, combo_chapter_pattern,
        label_chapter_pattern_2, entry_chapter_pattern_2,
        G_CALLBACK(on_chapter_pattern_entry_changed), shortcuts);
    gtk_entry_set_text(GTK_ENTRY(entry_chapter_pattern_1),
                       chapter_pattern_prefix.c_str());
    ...
    gtk_entry_set_text(GTK_ENTRY(entry_chapter_pattern_2),
                       chapter_pattern_suffix.c_str());
    gtk_label_set_text(GTK_LABEL(label_chapter_pattern),
                       _("Enter the text pattern to detect the chapter"));
    gtk_label_set_text(GTK_LABEL(label_chapter_pattern_1), _("Prefix"));
    gtk_label_set_text(GTK_LABEL(label_chapter_pattern_combo),
                       _("Chapter number"));
    gtk_label_set_text(GTK_LABEL(label_chapter_pattern_2), _("Suffix"));

    build_entry_combo_entry(
        image_verse_pattern_ok, label_verse_pattern_ok, label_verse_pattern,
        label_verse_pattern_1, entry_verse_pattern_1, label_verse_pattern_combo,
        combo_verse_pattern, label_verse_pattern_2, entry_verse_pattern_2,
        G_CALLBACK(on_verse_pattern_entry_changed), shortcuts);
    gtk_entry_set_text(GTK_ENTRY(entry_verse_pattern_1),
                       verse_pattern_prefix.c_str());
    ...
    gtk_entry_set_text(GTK_ENTRY(entry_verse_pattern_2),
                       verse_pattern_suffix.c_str());
    gtk_label_set_text(GTK_LABEL(label_verse_pattern),
                       _("Enter the text pattern to detect the verse"));
    ...
    build_button(image_write_anchors_ok, label_write_anchors_ok,
                 label_write_anchors_short, button_write_anchors, _("Write"),
                 shortcuts, G_CALLBACK(on_write_anchors_button_clicked),
                 label_write_anchors_long);
...
void ResourceConverterDialog::on_okbutton_clicked(GtkButton *button,
                                                  gpointer user_data) {
  ((ResourceConverterDialog *)user_data)->on_okbutton();
}

void ResourceConverterDialog::on_okbutton() { chapter_pattern_gui(); }
...
void ResourceConverterDialog::on_open_file_button_clicked(GtkButton *button,
                                                          gpointer user_data) {
...
bool ResourceConverterDialog::open_file_gui() {
  ...
  gtk_label_set_text(GTK_LABEL(label_open_file_short),
                     _("Open a file for conversion"));
...
void ResourceConverterDialog::on_view_file_button_clicked(GtkButton *button,
                                                          gpointer user_data) {
  ((ResourceConverterDialog *)user_data)->on_view_file_button();
}

void ResourceConverterDialog::on_view_file_button() {
  ustring tempfile = gw_build_filename(Directories->get_temp(),
                                       "resource-converter-view-file");
...
void ResourceConverterDialog::on_chapter_pattern_entry_changed(
...
bool ResourceConverterDialog::chapter_pattern_gui() {
  bool ok = true;
  chapter_pattern_prefix =
      gtk_entry_get_text(GTK_ENTRY(entry_chapter_pattern_1));
  chapter_pattern_index = combobox_get_active_index(combo_chapter_pattern);
  chapter_pattern_suffix =
      gtk_entry_get_text(GTK_ENTRY(entry_chapter_pattern_2));
...
void ResourceConverterDialog::on_verse_pattern_entry_changed(
    GtkEditable *editable, gpointer user_data) {
...
void ResourceConverterDialog::on_write_anchors_button_clicked(
...
void ResourceConverterDialog::on_write_anchors_button() {
  ...
  switch (resource_conversion_type) {
  case rctChapterStartsAtPatternVerseOneStartsAtChapterVerseStartsAtPattern: {
    resource_conversion_insert_anchors(
        lines, chapter_pattern_prefix, chapter_pattern_index,
        chapter_pattern_suffix, verse_pattern_prefix, verse_pattern_index,
        verse_pattern_suffix);
    break;
  }
  case rctEnd: {
    break;
