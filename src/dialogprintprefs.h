...
private:
  ...
  GtkAdjustment *spinbutton_top_adj;
  GtkWidget *spinbutton_top;
  GtkAdjustment *spinbutton_bottom_adj;
  GtkWidget *spinbutton_bottom;
  GtkAdjustment *spinbutton_columngap_adj;
  ...
  GtkWidget *hbox2;
  GtkWidget *label12;
  GtkAdjustment *spinbutton_header_font_size_adj;
