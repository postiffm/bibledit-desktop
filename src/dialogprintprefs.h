...
private:
  ...
  GtkWidget *okbutton1;
  static void on_spinbutton_height_changed(GtkEditable *editable,
                                           gpointer user_data);
  void on_spinbutton_height();
  static void on_spinbutton_width_changed(GtkEditable *editable,
                                          gpointer user_data);
  void on_spinbutton_width();
  static void on_combo_entry_format_changed(GtkEditable *editable,
                                            gpointer user_data);
