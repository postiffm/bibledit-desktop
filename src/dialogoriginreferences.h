...
private:
  static void on_radiobutton_action_toggled(GtkToggleButton *togglebutton,
                                            gpointer user_data);
  void on_radiobutton_action();
  static void on_checkbutton_reference_toggled(GtkToggleButton *togglebutton,
                                               gpointer user_data);
  static void on_entry_reference_changed(GtkEditable *editable,
                                         gpointer user_data);
  void on_reference();
