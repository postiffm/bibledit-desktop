...
private:
  ...
  bool try_git_store_data_in_repository(const ustring &repository,
                                        const gchar *data);
  bool try_git_check_data_in_repository(const ustring &repository,
                                        const gchar *data);
  ...
  static void on_entry_repository_changed(GtkEditable *editable,
                                          gpointer user_data);
