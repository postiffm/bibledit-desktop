...
OriginReferencesDialog::OriginReferencesDialog(int dummy) {
  ...
  gtk_window_set_title(GTK_WINDOW(originreferencesdialog),
                       _("Bible notes mass update"));
  gtk_window_set_position(GTK_WINDOW(originreferencesdialog),
                          GTK_WIN_POS_CENTER_ON_PARENT);
  gtk_window_set_modal(GTK_WINDOW(originreferencesdialog), TRUE);

  dialog_vbox1 =
      gtk_dialog_get_content_area(GTK_DIALOG(originreferencesdialog));
  gtk_widget_show(dialog_vbox1);

  label3 = gtk_label_new(_("This tool can update all the footnotes, endnotes "
                           "and crossreferences in the project."));
  ...
  gtk_box_pack_start(GTK_BOX(dialog_vbox1), checkbutton_footnotes, FALSE, FALSE,
                     0);
  ...
  gtk_box_pack_start(GTK_BOX(dialog_vbox1), checkbutton_endnotes, FALSE, FALSE,
                     0);
  ...
  radiobutton_nothing = gtk_radio_button_new_with_mnemonic(
      NULL, _("_Make no changes but give statistics only"));
  gtk_widget_show(radiobutton_nothing);
  gtk_box_pack_start(GTK_BOX(dialog_vbox1), radiobutton_nothing, FALSE, FALSE,
                     0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_nothing),
                             radiobutton_remove_group);
  radiobutton_remove_group =
      gtk_radio_button_get_group(GTK_RADIO_BUTTON(radiobutton_nothing));

  shortcuts.button(checkbutton_xrefs);

  radiobutton_remove =
      gtk_radio_button_new_with_mnemonic(NULL, _("_Remove all the references"));
  gtk_widget_show(radiobutton_remove);
  gtk_box_pack_start(GTK_BOX(dialog_vbox1), radiobutton_remove, FALSE, FALSE,
                     0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_remove),
                             radiobutton_remove_group);
  radiobutton_remove_group =
      gtk_radio_button_get_group(GTK_RADIO_BUTTON(radiobutton_remove));
  ...
  radiobutton_add =
      gtk_radio_button_new_with_mnemonic(NULL, _("Add references"));
  gtk_widget_show(radiobutton_add);
  gtk_box_pack_start(GTK_BOX(hbox1), radiobutton_add, FALSE, FALSE, 0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_add),
                             radiobutton_remove_group);
  radiobutton_remove_group =
      gtk_radio_button_get_group(GTK_RADIO_BUTTON(radiobutton_add));
  ...
  gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(checkbutton_book),
                               settings->session.bnmu_add_book);
  ...
  gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(checkbutton_chapter),
                               settings->session.bnmu_add_chapter);
  ...
  gtk_entry_set_text(GTK_ENTRY(entry_dot),
                     settings->session.bnmu_verse_prefix.c_str());
  ...
  gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(checkbutton_verse),
                               settings->session.bnmu_add_verse);
  ...
  gtk_entry_set_text(GTK_ENTRY(entry2),
                     settings->session.bnmu_verse_suffix.c_str());
  ...
  radiobutton_text_label =
      gtk_radio_button_new_with_mnemonic(NULL, _("Add missing _text labels"));
  gtk_widget_show(radiobutton_text_label);
  gtk_box_pack_start(GTK_BOX(dialog_vbox1), radiobutton_text_label, FALSE,
                     FALSE, 0);
  gtk_radio_button_set_group(GTK_RADIO_BUTTON(radiobutton_text_label),
                             radiobutton_remove_group);
  radiobutton_remove_group =
      gtk_radio_button_get_group(GTK_RADIO_BUTTON(radiobutton_text_label));

  dialog_action_area1 =
      gtk_dialog_get_action_area(GTK_DIALOG(originreferencesdialog));
  gtk_widget_show(dialog_action_area1);
  gtk_button_box_set_layout(GTK_BUTTON_BOX(dialog_action_area1),
                            GTK_BUTTONBOX_END);

  new InDialogHelp(originreferencesdialog, NULL, &shortcuts,
                   "tools/bible-notes-mass-update");

  cancelbutton = gtk_button_new_from_stock("gtk-cancel");
  gtk_widget_show(cancelbutton);
  gtk_dialog_add_action_widget(GTK_DIALOG(originreferencesdialog), cancelbutton,
                               GTK_RESPONSE_CANCEL);
  gtk_widget_set_can_default(GTK_WIDGET(cancelbutton), true);

  okbutton = gtk_button_new_from_stock("gtk-ok");
  gtk_widget_show(okbutton);
  gtk_dialog_add_action_widget(GTK_DIALOG(originreferencesdialog), okbutton,
                               GTK_RESPONSE_OK);
  ...
  g_signal_connect((gpointer)radiobutton_nothing, "toggled",
                   G_CALLBACK(on_radiobutton_action_toggled), gpointer(this));
  ...
  g_signal_connect((gpointer)entry_dot, "changed",
                   G_CALLBACK(on_entry_reference_changed), gpointer(this));
...
void OriginReferencesDialog::on_radiobutton_action_toggled(
...
void OriginReferencesDialog::on_checkbutton_reference_toggled(
    GtkToggleButton *togglebutton, gpointer user_data) {
  ((OriginReferencesDialog *)user_data)->on_reference();
}

void OriginReferencesDialog::on_entry_reference_changed(GtkEditable *editable,
                                                        gpointer user_data) {
  ((OriginReferencesDialog *)user_data)->on_reference();
}
...
void OriginReferencesDialog::on_reference() {
  ustring exampletext = origin_reference_produce(
      gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(checkbutton_book)), 1,
      _("English"),
      gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(checkbutton_chapter)), 1,
      gtk_entry_get_text(GTK_ENTRY(entry_dot)),
      gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(checkbutton_verse)), "1",
      gtk_entry_get_text(GTK_ENTRY(entry2)), true);
  gtk_label_set_text(GTK_LABEL(label_example), exampletext.c_str());
}

void OriginReferencesDialog::on_okbutton_clicked(GtkButton *button,
                                                 gpointer user_data) {
...
void OriginReferencesDialog::on_okbutton() {
  ...
  if (action != oratNothing) {
    if (gtkw_dialog_question(originreferencesdialog,
                             _("Are you sure you wish to edit the notes?")) ==
        GTK_RESPONSE_NO)
      return;
    if (gtkw_dialog_question(
            originreferencesdialog,
            _("This will permanently modify your project.\nThe changes cannot "
  ...
  settings->session.bnmu_verse_prefix =
      gtk_entry_get_text(GTK_ENTRY(entry_dot));
  ...
  OriginReferences originreferences(
      ...
      action, gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(checkbutton_book)),
      gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(checkbutton_chapter)),
      gtk_entry_get_text(GTK_ENTRY(entry_dot)),
      gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(checkbutton_verse)),
      gtk_entry_get_text(GTK_ENTRY(entry2)), true);
