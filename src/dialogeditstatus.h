...
public:
  EditStatusDialog(const ustring &project_in, unsigned int book,
...
private:
  ...
  static gboolean on_treeview_books_button_event(GtkWidget *widget,
                                                 GdkEventButton *event,
                                                 gpointer user_data);
  static gboolean on_treeview_books_key_event(GtkWidget *widget,
                                              GdkEventKey *event,
                                              gpointer user_data);
  ...
  void load_chapters();
  static gboolean on_treeview_chapters_button_event(GtkWidget *widget,
                                                    GdkEventButton *event,
                                                    gpointer user_data);
  static gboolean on_treeview_chapters_key_event(GtkWidget *widget,
                                                 GdkEventKey *event,
                                                 gpointer user_data);
  ...
  void load_verses();
  static gboolean on_treeview_verses_button_event(GtkWidget *widget,
                                                  GdkEventButton *event,
                                                  gpointer user_data);
  static gboolean on_treeview_verses_key_event(GtkWidget *widget,
                                               GdkEventKey *event,
                                               gpointer user_data);
  ...
  static void on_checkbutton_status_toggled(GtkToggleButton *togglebutton,
                                            gpointer user_data);
