...
*/
{
  event_id = g_timeout_add_full(G_PRIORITY_DEFAULT, 300000,
...
ProjectConfiguration *Settings::projectconfig(ustring project,
...
// Returns the ProjectConfiguration object for "project".
{
  ...
  // Configuraton was not loaded yet, create a new object and return a pointer
  // to it.
  ProjectConfiguration *projectconfiguration =
      new ProjectConfiguration(project, save_on_destroy);
