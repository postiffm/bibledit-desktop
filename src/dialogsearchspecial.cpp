...
#define RESULTS_REMOVE                                                         \
  _("Remove them from the ones already in the references window")
#define RESULTS_SHARE                                                          \
  _("Share them with the ones already in the references window")
...
SearchSpecialDialog::SearchSpecialDialog(int dummy) {
  ...
  gtk_window_set_position(GTK_WINDOW(searchspecialdialog),
                          GTK_WIN_POS_CENTER_ON_PARENT);
  gtk_window_set_modal(GTK_WINDOW(searchspecialdialog), TRUE);
  gtk_window_set_type_hint(GTK_WINDOW(searchspecialdialog),
  ...
  gtk_notebook_set_tab_label(
      GTK_NOTEBOOK(notebook_mode),
      gtk_notebook_get_nth_page(GTK_NOTEBOOK(notebook_mode), 0), label19);
  ...
  gtk_notebook_set_tab_label(
      GTK_NOTEBOOK(notebook_mode),
      gtk_notebook_get_nth_page(GTK_NOTEBOOK(notebook_mode), 1), label20);
  ...
  gtk_entry_set_text(GTK_ENTRY(word_entry),
                     settings->session.searchword.c_str());
  ...
  gtk_box_pack_start(GTK_BOX(vbox6), checkbutton_casesensitive, FALSE, FALSE,
                     0);

  // Set case sensitive.
  gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(checkbutton_casesensitive),
                               settings->session.search_case_sensitive);

  checkbutton_current_book =
      gtk_check_button_new_with_mnemonic(_("Search in c_urrent book only"));
  ...
  gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(checkbutton_current_book),
                               settings->session.search_current_book);

  checkbutton_current_chapter =
      gtk_check_button_new_with_mnemonic(_("Search in current cha_pter only"));
  gtk_widget_show(checkbutton_current_chapter);
  gtk_box_pack_start(GTK_BOX(vbox6), checkbutton_current_chapter, FALSE, FALSE,
                     0);

  // Set searching in current chapter.
  gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(checkbutton_current_chapter),
                               settings->session.search_current_chapter);

  label27 = gtk_label_new("");
  gtk_widget_show(label27);
  gtk_notebook_set_tab_label(
      GTK_NOTEBOOK(notebook_case_current),
      gtk_notebook_get_nth_page(GTK_NOTEBOOK(notebook_case_current), 0),
      label27);
  ...
  gtk_notebook_set_tab_label(
      GTK_NOTEBOOK(notebook_case_current),
      gtk_notebook_get_nth_page(GTK_NOTEBOOK(notebook_case_current), 1),
      label28);
  ...
  gtk_notebook_set_tab_label(
      GTK_NOTEBOOK(notebook_case_current),
      gtk_notebook_get_nth_page(GTK_NOTEBOOK(notebook_case_current), 2),
      label29);
  ...
  gtk_notebook_set_tab_label(
      GTK_NOTEBOOK(notebook_case_current),
      gtk_notebook_get_nth_page(GTK_NOTEBOOK(notebook_case_current), 3),
      label30);
  ...
  checkbutton_glob =
      gtk_check_button_new_with_mnemonic(_("_Interpret * and ? as wildcards"));
  gtk_widget_show(checkbutton_glob);
  gtk_box_pack_start(GTK_BOX(vbox5), checkbutton_glob, FALSE, FALSE, 0);

  // Set active or not.
  gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(checkbutton_glob),
                               settings->session.search_globbing);

  checkbutton_start_word =
      gtk_check_button_new_with_mnemonic(_("Match _start of word"));
  gtk_widget_show(checkbutton_start_word);
  gtk_box_pack_start(GTK_BOX(vbox5), checkbutton_start_word, FALSE, FALSE, 0);

  // Set active or not.
  gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(checkbutton_start_word),
                               settings->session.search_start_word_match);

  checkbutton_end_word =
      gtk_check_button_new_with_mnemonic(_("Match _end of word"));
  gtk_widget_show(checkbutton_end_word);
  gtk_box_pack_start(GTK_BOX(vbox5), checkbutton_end_word, FALSE, FALSE, 0);

  // Set active or not.
  gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(checkbutton_end_word),
  ...
  gtk_notebook_set_tab_label(
      GTK_NOTEBOOK(notebook_advanced),
      gtk_notebook_get_nth_page(GTK_NOTEBOOK(notebook_advanced), 1), label32);
  ...
  label14 =
      gtk_label_new_with_mnemonic(_("What to do with the search _results"));
  ...
  gtk_notebook_set_tab_label(
      ...
      gtk_notebook_get_nth_page(GTK_NOTEBOOK(notebook_results), 0), label35);
  ...
  gtk_notebook_set_tab_label(
      GTK_NOTEBOOK(notebook_results),
      gtk_notebook_get_nth_page(GTK_NOTEBOOK(notebook_results), 1), label36);
  ...
  gtk_notebook_set_tab_label(
      GTK_NOTEBOOK(notebook_results),
      gtk_notebook_get_nth_page(GTK_NOTEBOOK(notebook_results), 2), label37);
  ...
  gtk_notebook_set_tab_label(
      GTK_NOTEBOOK(notebook_results),
      gtk_notebook_get_nth_page(GTK_NOTEBOOK(notebook_results), 3), label38);

  dialog_action_area1 =
      gtk_dialog_get_action_area(GTK_DIALOG(searchspecialdialog));
  ...
  gtk_dialog_add_action_widget(GTK_DIALOG(searchspecialdialog), cancelbutton,
                               GTK_RESPONSE_CANCEL);
  gtk_widget_set_can_default(GTK_WIDGET(cancelbutton), true);

  findbutton = gtk_button_new_from_stock("gtk-find");
  gtk_widget_show(findbutton);
  gtk_dialog_add_action_widget(GTK_DIALOG(searchspecialdialog), findbutton,
                               GTK_RESPONSE_OK);
  gtk_widget_set_sensitive(findbutton, FALSE);
  gtk_widget_set_can_default(GTK_WIDGET(findbutton), true);

  g_signal_connect((gpointer)searchspecialdialog, "activate_focus",
                   G_CALLBACK(on_searchspecialdialog_activate_focus),
                   gpointer(this));
  g_signal_connect((gpointer)word_entry, "changed",
                   G_CALLBACK(on_word_entry_changed), gpointer(this));
  g_signal_connect((gpointer)word_entry, "activate",
                   G_CALLBACK(on_word_entry_activate), gpointer(this));
  g_signal_connect((gpointer)checkbutton_current_book, "toggled",
                   G_CALLBACK(on_checkbutton_current_book_toggled),
                   gpointer(this));
  ...
  g_signal_connect((gpointer)findbutton, "clicked",
                   G_CALLBACK(on_findbutton_clicked), gpointer(this));
  g_signal_connect_after((gpointer)notebook_mode, "switch_page",
  ...
  // Present the window after a while because other windows created may take
  // away the focus.
...
void SearchSpecialDialog::on_word_entry_changed(GtkEditable *editable,
                                                gpointer user_data) {
...
void SearchSpecialDialog::set_gui() {
  ...
  bool searchcurrentbook =
      gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(checkbutton_current_book));
...
void SearchSpecialDialog::on_findbutton_clicked(GtkButton *button,
                                                gpointer user_data) {
...
void SearchSpecialDialog::on_find() {
  ...
  settings->session.search_case_sensitive = gtk_toggle_button_get_active(
      GTK_TOGGLE_BUTTON(checkbutton_casesensitive));
  settings->session.search_current_book =
      gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(checkbutton_current_book));
  settings->session.search_current_chapter = gtk_toggle_button_get_active(
      GTK_TOGGLE_BUTTON(checkbutton_current_chapter));
  settings->session.search_globbing =
      gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(checkbutton_glob));
  settings->session.search_start_word_match =
      gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(checkbutton_start_word));
  settings->session.search_end_word_match =
      gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(checkbutton_end_word));
  settings->session.search_page =
      gtk_notebook_get_current_page(GTK_NOTEBOOK(notebook_mode));
  ...
  switch (settings->session.searchresultstype) {
  case sstLoad:
    settings->session.highlights
        .clear(); // Fall through, all the way to the bottom.
  case sstAdd:
  case sstSubtract:
  case sstShare: {
    SessionHighlights sessionhighlights(
        ...
        settings->session.search_globbing,
        settings->session.search_start_word_match,
        settings->session.search_end_word_match, settings->session.area_type,
        settings->session.area_id, settings->session.area_intro,
        settings->session.area_heading, settings->session.area_chapter,
        settings->session.area_study, settings->session.area_notes,
        settings->session.area_xref, settings->session.area_verse);
...
void SearchSpecialDialog::on_button_books_clicked(GtkButton *button,
                                                  gpointer user_data) {
...
void SearchSpecialDialog::on_checkbutton_current_book_toggled(
    GtkToggleButton *togglebutton, gpointer user_data) {
  ((SearchSpecialDialog *)user_data)->set_gui();
}

void SearchSpecialDialog::on_button_area_clicked(GtkButton *button,
                                                 gpointer user_data) {
...
void SearchSpecialDialog::on_searchspecialdialog_activate_focus(
...
void SearchSpecialDialog::on_notebook_mode_switch_page(GtkNotebook *notebook,
...
void SearchSpecialDialog::on_word_entry_activate(GtkEntry *entry,
                                                 gpointer user_data) {
...
void SearchSpecialDialog::timeout() { allow_activate = true; }
