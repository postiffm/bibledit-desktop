...
MainWindow::MainWindow(unsigned long xembed, GtkAccelGroup *_accelerator_group,
                       Settings *_settings, URLTransport *_urltransport,
                       VCS *_vcs)
    : navigation(0), httpd(0) {
  // Store pointers to the settings, etc. so we don't have to rely on "extern"
  ...
  gtk_accel_group_connect(
      accelerator_group, GDK_KEY_X, GDK_CONTROL_MASK, GtkAccelFlags(0),
      g_cclosure_new_swap(G_CALLBACK(accelerator_cut_callback), gpointer(this),
                          NULL));
  gtk_accel_group_connect(
      accelerator_group, GDK_KEY_C, GDK_CONTROL_MASK, GtkAccelFlags(0),
      g_cclosure_new_swap(G_CALLBACK(accelerator_copy_callback), gpointer(this),
                          NULL));
  gtk_accel_group_connect(
      accelerator_group, GDK_KEY_V, GDK_CONTROL_MASK, GtkAccelFlags(0),
      g_cclosure_new_swap(G_CALLBACK(accelerator_paste_callback),
                          gpointer(this), NULL));
  gtk_accel_group_connect(
      accelerator_group, GDK_KEY_Z, GDK_CONTROL_MASK, GtkAccelFlags(0),
      g_cclosure_new_swap(G_CALLBACK(accelerator_undo_callback), gpointer(this),
                          NULL));
  gtk_accel_group_connect(
      accelerator_group, GDK_KEY_Z,
      GdkModifierType(GDK_CONTROL_MASK | GDK_SHIFT_MASK), GtkAccelFlags(0),
      g_cclosure_new_swap(G_CALLBACK(accelerator_redo_callback), gpointer(this),
                          NULL));
  gtk_accel_group_connect(
      accelerator_group, GDK_KEY_N, GDK_CONTROL_MASK, GtkAccelFlags(0),
      g_cclosure_new_swap(G_CALLBACK(accelerator_new_project_note_callback),
                          gpointer(this), NULL));
  gtk_accel_group_connect(
      accelerator_group, GDK_KEY_Down, GDK_MOD1_MASK, GtkAccelFlags(0),
      g_cclosure_new_swap(G_CALLBACK(accelerator_next_verse_callback),
                          gpointer(this), NULL));
  gtk_accel_group_connect(
      accelerator_group, GDK_KEY_Up, GDK_MOD1_MASK, GtkAccelFlags(0),
      g_cclosure_new_swap(G_CALLBACK(accelerator_previous_verse_callback),
                          gpointer(this), NULL));
  gtk_accel_group_connect(
      accelerator_group, GDK_KEY_Page_Down, GDK_MOD1_MASK, GtkAccelFlags(0),
      g_cclosure_new_swap(G_CALLBACK(accelerator_next_chapter_callback),
                          gpointer(this), NULL));
  gtk_accel_group_connect(
      accelerator_group, GDK_KEY_Page_Up, GDK_MOD1_MASK, GtkAccelFlags(0),
      g_cclosure_new_swap(G_CALLBACK(accelerator_previous_chapter_callback),
                          gpointer(this), NULL));
  gtk_accel_group_connect(
      accelerator_group, GDK_KEY_Page_Down,
      (GdkModifierType)(GDK_CONTROL_MASK | GDK_MOD1_MASK), GtkAccelFlags(0),
      g_cclosure_new_swap(G_CALLBACK(accelerator_next_book_callback),
                          gpointer(this), NULL));
  gtk_accel_group_connect(
      accelerator_group, GDK_KEY_Page_Up,
      (GdkModifierType)(GDK_CONTROL_MASK | GDK_MOD1_MASK), GtkAccelFlags(0),
      g_cclosure_new_swap(G_CALLBACK(accelerator_previous_book_callback),
                          gpointer(this), NULL));
  gtk_accel_group_connect(
      accelerator_group, GDK_KEY_Right, GDK_MOD1_MASK, GtkAccelFlags(0),
      g_cclosure_new_swap(
          G_CALLBACK(accelerator_next_reference_in_history_callback),
          gpointer(this), NULL));
  gtk_accel_group_connect(
      accelerator_group, GDK_KEY_Left, GDK_MOD1_MASK, GtkAccelFlags(0),
      g_cclosure_new_swap(
          G_CALLBACK(accelerator_previous_reference_in_history_callback),
          gpointer(this), NULL));
  gtk_accel_group_connect(
      accelerator_group, GDK_KEY_G, GDK_CONTROL_MASK, GtkAccelFlags(0),
      g_cclosure_new_swap(G_CALLBACK(accelerator_go_to_reference_callback),
                          gpointer(this), NULL));
  gtk_accel_group_connect(
      accelerator_group, GDK_KEY_W, GDK_CONTROL_MASK, GtkAccelFlags(0),
      g_cclosure_new_swap(G_CALLBACK(accelerator_close_window_callback),
                          gpointer(this), NULL));
  if (guifeatures.styles()) {
    gtk_accel_group_connect(
        accelerator_group, GDK_KEY_S, GDK_CONTROL_MASK, GtkAccelFlags(0),
        g_cclosure_new_swap(G_CALLBACK(accelerator_goto_styles_area_callback),
                            gpointer(this), NULL));
  }
  gtk_accel_group_connect(
      accelerator_group, GDK_KEY_Q, GDK_CONTROL_MASK, GtkAccelFlags(0),
      g_cclosure_new_swap(G_CALLBACK(accelerator_quit_program_callback),
                          gpointer(this), NULL));
  gtk_accel_group_connect(
      accelerator_group, GDK_KEY_F5, GdkModifierType(0), GtkAccelFlags(0),
      g_cclosure_new_swap(G_CALLBACK(accelerator_activate_text_area_callback),
                          gpointer(this), NULL));
  gtk_accel_group_connect(
      accelerator_group, GDK_KEY_F5, GDK_SHIFT_MASK, GtkAccelFlags(0),
      g_cclosure_new_swap(G_CALLBACK(accelerator_activate_tools_area_callback),
                          gpointer(this), NULL));
  if (guifeatures.project_notes()) {
    gtk_accel_group_connect(
        accelerator_group, GDK_KEY_F5, GDK_CONTROL_MASK, GtkAccelFlags(0),
        g_cclosure_new_swap(
            G_CALLBACK(accelerator_activate_notes_area_callback),
            gpointer(this), NULL));
  }
  if (guifeatures.references_and_find()) {
    gtk_accel_group_connect(
        accelerator_group, GDK_KEY_F6, GdkModifierType(0), GtkAccelFlags(0),
        g_cclosure_new_swap(
            G_CALLBACK(accelerator_next_reference_in_reference_area_callback),
            gpointer(this), NULL));
    gtk_accel_group_connect(
        accelerator_group, GDK_KEY_F6, GDK_SHIFT_MASK, GtkAccelFlags(0),
        g_cclosure_new_swap(
            G_CALLBACK(
                accelerator_previous_reference_in_reference_area_callback),
            gpointer(this), NULL));
  }
  gtk_accel_group_connect(
      accelerator_group, GDK_KEY_Right,
      (GdkModifierType)(GDK_CONTROL_MASK | GDK_MOD1_MASK), GtkAccelFlags(0),
      g_cclosure_new_swap(G_CALLBACK(accelerator_next_project_callback),
                          gpointer(this), NULL));
  gtk_accel_group_connect(
      accelerator_group, GDK_KEY_Left,
      (GdkModifierType)(GDK_CONTROL_MASK | GDK_MOD1_MASK), GtkAccelFlags(0),
      g_cclosure_new_swap(G_CALLBACK(accelerator_previous_project_callback),
                          gpointer(this), NULL));
  gtk_accel_group_connect(
      accelerator_group, GDK_KEY_O, GDK_CONTROL_MASK, GtkAccelFlags(0),
      g_cclosure_new_swap(G_CALLBACK(accelerator_open_project_callback),
                          gpointer(this), NULL));
  if (guifeatures.printing()) {
    gtk_accel_group_connect(
        accelerator_group, GDK_KEY_P, GDK_CONTROL_MASK, GtkAccelFlags(0),
        g_cclosure_new_swap(G_CALLBACK(accelerator_print_callback),
                            gpointer(this), NULL));
  }
  if (guifeatures.references_and_find()) {
    gtk_accel_group_connect(
        accelerator_group, GDK_KEY_F, GDK_CONTROL_MASK, GtkAccelFlags(0),
        g_cclosure_new_swap(G_CALLBACK(accelerator_find_callback),
                            gpointer(this), NULL));
  }
  if (guifeatures.replace()) {
    gtk_accel_group_connect(
        accelerator_group, GDK_KEY_R, GDK_CONTROL_MASK, GtkAccelFlags(0),
        g_cclosure_new_swap(G_CALLBACK(accelerator_replace_callback),
                            gpointer(this), NULL));
  }
  gtk_accel_group_connect(
      accelerator_group, GDK_KEY_F1, GdkModifierType(0), GtkAccelFlags(0),
      g_cclosure_new_swap(G_CALLBACK(accelerator_main_help_callback),
                          gpointer(this), NULL));
  gtk_accel_group_connect(
      accelerator_group, GDK_KEY_F2, GdkModifierType(0), GtkAccelFlags(0),
      g_cclosure_new_swap(G_CALLBACK(accelerator_main_jumpto_callback),
                          gpointer(this), NULL));
  // For USFM view, we first had defined the Ctrl-U for that. The U is the first
  // letter of USFM,
  // and also in for example Firefox, the Ctrl-U views the source code.
  // But since the Ctrl-U clashed with the Ctrl-U for underline in the note
  // editor,
  // the accelerator key for viewing USFM code was changed to Ctrl-\.
  // The backslash is the first character of the USFM code.
  gtk_accel_group_connect(
      accelerator_group, GDK_KEY_backslash, GDK_CONTROL_MASK, GtkAccelFlags(0),
      g_cclosure_new_swap(G_CALLBACK(accelerator_view_usfm_code),
                          gpointer(this), NULL));
  ...
  if (xembed) {
    ...
    // GtkAccelGroup*, Settings*, URLTransport*, VCS*)':
    // mainwindow.cpp:251:54: warning: cast to pointer from integer of different
  ...
  g_signal_connect((gpointer)window_main, "delete_event",
                   G_CALLBACK(on_window_delete_event), gpointer(this));
  ...
  if (guifeatures.project_management()) {
    ...
    gtk_image_menu_item_set_image(GTK_IMAGE_MENU_ITEM(copy_project_to),
                                  image2688);
    ...
    gtk_image_menu_item_set_image(GTK_IMAGE_MENU_ITEM(compare_with1),
                                  image2764);
  }
  ...
  if (guifeatures.project_management()) {
    ...
    gtk_image_menu_item_set_image(GTK_IMAGE_MENU_ITEM(project_changes),
                                  image19115);
  }
  ...
  projects_send_receive1 =
      gtk_image_menu_item_new_with_mnemonic(_("_Send / receive"));
  ...
  gtk_image_menu_item_set_image(GTK_IMAGE_MENU_ITEM(projects_send_receive1),
                                image34440);
  ...
  if (guifeatures.styles()) {
    ...
    image10735 =
        gtk_image_new_from_stock("gtk-print-preview", GTK_ICON_SIZE_MENU);
  ...
  if (guifeatures.styles()) {
    ...
    gtk_image_menu_item_set_image(GTK_IMAGE_MENU_ITEM(stylesheet_open),
                                  image31346);
  }
  ...
  if (guifeatures.styles()) {
    ...
    stylesheets_expand_all =
        gtk_image_menu_item_new_with_mnemonic(_("_Expand all"));
    ...
    gtk_image_menu_item_set_image(GTK_IMAGE_MENU_ITEM(stylesheets_expand_all),
                                  image10736);
  }
  ...
  if (guifeatures.styles()) {
    ...
    stylesheets_collapse_all =
        gtk_image_menu_item_new_with_mnemonic(_("_Collapse all"));
    ...
    gtk_image_menu_item_set_image(GTK_IMAGE_MENU_ITEM(stylesheets_collapse_all),
                                  image10737);
  }
  ...
  if (guifeatures.styles()) {
    ...
    gtk_image_menu_item_set_image(GTK_IMAGE_MENU_ITEM(style_insert),
                                  image10738);
  }
  ...
  if (guifeatures.styles_management()) {
    ...
    stylesheet_edit_mode =
        gtk_check_menu_item_new_with_mnemonic(_("Edit _mode"));
  ...
  if (guifeatures.styles_management()) {
    ...
    gtk_image_menu_item_set_image(GTK_IMAGE_MENU_ITEM(menu_stylesheet),
                                  image10740);
  }
  ...
  if (guifeatures.styles_management()) {
    ...
    gtk_menu_item_set_submenu(GTK_MENU_ITEM(menu_stylesheet),
                              menu_stylesheet_menu);
  }
  ...
  if (guifeatures.styles_management()) {
    ...
    gtk_image_menu_item_set_image(GTK_IMAGE_MENU_ITEM(stylesheet_switch),
                                  image10741);
  }
  ...
  if (guifeatures.styles_management()) {
    ...
    gtk_image_menu_item_set_image(GTK_IMAGE_MENU_ITEM(stylesheets_new),
                                  image10742);
  }
  ...
  if (guifeatures.styles_management()) {
    ...
    gtk_image_menu_item_set_image(GTK_IMAGE_MENU_ITEM(stylesheets_delete),
                                  image10743);
  }
  ...
  if (guifeatures.styles_management()) {
    ...
    gtk_image_menu_item_set_image(GTK_IMAGE_MENU_ITEM(stylesheets_rename),
                                  image10744);
  }
  ...
  if (guifeatures.project_notes_management()) {
    ...
    consultation_notes_send_receive =
        gtk_image_menu_item_new_with_mnemonic(_("_Send / Receive"));
    gtk_widget_show(consultation_notes_send_receive);
    gtk_container_add(GTK_CONTAINER(notes2_menu),
                      consultation_notes_send_receive);
  }
  ...
  gtk_image_menu_item_set_image(GTK_IMAGE_MENU_ITEM(file_resources),
                                image27365);
  ...
  gtk_image_menu_item_set_image(GTK_IMAGE_MENU_ITEM(file_resources_open),
                                image27366);
  ...
  gtk_image_menu_item_set_image(GTK_IMAGE_MENU_ITEM(file_resources_close),
                                image27367);
  ...
  gtk_image_menu_item_set_image(GTK_IMAGE_MENU_ITEM(file_resources_new),
                                image27514);
  ...
  gtk_image_menu_item_set_image(GTK_IMAGE_MENU_ITEM(file_resources_edit),
                                image27515);
  ...
  gtk_image_menu_item_set_image(GTK_IMAGE_MENU_ITEM(file_resources_delete),
                                image27664);
  ...
  copy_with_formatting =
      gtk_image_menu_item_new_with_mnemonic(_("Copy _with formatting"));
  ...
  gtk_image_menu_item_set_image(GTK_IMAGE_MENU_ITEM(copy_with_formatting),
                                image18220);
  ...
  if (guifeatures.replace()) {
    ...
    find_and_replace1 =
        gtk_image_menu_item_new_from_stock("gtk-find-and-replace", NULL);
  ...
  if (guifeatures.project_notes()) {
    ...
    find_in_notes1 =
        gtk_image_menu_item_new_with_mnemonic(_("Find in Project _notes"));
    ...
    gtk_image_menu_item_set_image(GTK_IMAGE_MENU_ITEM(find_in_notes1),
                                  image1430);
  }
  ...
  if (guifeatures.project_notes()) {
    ...
    get_references_from_note = gtk_image_menu_item_new_with_mnemonic(
        _("_Get references from project note"));
    ...
    gtk_image_menu_item_set_image(GTK_IMAGE_MENU_ITEM(get_references_from_note),
                                  image3158);
  }
  ...
  gtk_image_menu_item_set_image(GTK_IMAGE_MENU_ITEM(edit_bible_note),
                                image20483);
  ...
  gtk_image_menu_item_set_image(GTK_IMAGE_MENU_ITEM(view_text_font),
                                image20235);
  ...
  gtk_menu_item_set_submenu(GTK_MENU_ITEM(view_chapter_item),
                            view_chapter_submenu);
  // was gtk_check_menu...
  chapterViewGroup = NULL;
  view_formatted = (GtkRadioMenuItem *)gtk_radio_menu_item_new_with_mnemonic(
      chapterViewGroup, _("_Formatted"));
  // gtk3 gtk_radio_menu_item_join_group(view_formatted, NULL);
  chapterViewGroup =
      gtk_radio_menu_item_get_group(GTK_RADIO_MENU_ITEM(view_formatted));
  gtk_widget_show((GtkWidget *)view_formatted);
  gtk_container_add(GTK_CONTAINER(view_chapter_submenu),
                    (GtkWidget *)view_formatted);
  gtk_check_menu_item_set_active(GTK_CHECK_MENU_ITEM(view_formatted),
                                 TRUE); // default

  view_usfm_code = (GtkRadioMenuItem *)gtk_radio_menu_item_new_with_mnemonic(
      chapterViewGroup, _("_USFM code"));
  // gtk3 gtk_radio_menu_item_join_group(view_usfm_code, view_formatted);
  chapterViewGroup =
      gtk_radio_menu_item_get_group(GTK_RADIO_MENU_ITEM(view_usfm_code));
  gtk_widget_show((GtkWidget *)view_usfm_code);
  gtk_container_add(GTK_CONTAINER(view_chapter_submenu),
                    (GtkWidget *)view_usfm_code);

  view_experimental = (GtkRadioMenuItem *)gtk_radio_menu_item_new_with_mnemonic(
      chapterViewGroup, _("_Experimental"));
  // gtk3 gtk_radio_menu_item_join_group(view_experimental, view_usfm_code);
  chapterViewGroup =
      gtk_radio_menu_item_get_group(GTK_RADIO_MENU_ITEM(view_experimental));
  gtk_widget_show((GtkWidget *)view_experimental);
  gtk_container_add(GTK_CONTAINER(view_chapter_submenu),
                    (GtkWidget *)view_experimental);
  //-----------------------------------------------------------------------------
  ...
  view_related_verses =
      gtk_check_menu_item_new_with_mnemonic(_("_Related verses"));
  ...
  //----------------------------------------------------------------------
  view_verse_external =
      gtk_image_menu_item_new_with_mnemonic(_("_External Resource"));
  ...
  gtk_menu_item_set_submenu(GTK_MENU_ITEM(view_verse_external),
                            view_external_submenu);
  ...
  insert_special_character =
      gtk_image_menu_item_new_with_mnemonic(_("_Special character"));
  ...
  gtk_image_menu_item_set_image(GTK_IMAGE_MENU_ITEM(insert_special_character),
                                image25281);
  ...
  if (guifeatures.checks()) {
    ...
    chapters_and_verses1 =
        gtk_image_menu_item_new_with_mnemonic(_("_Chapters and verses"));
    ...
    gtk_image_menu_item_set_image(GTK_IMAGE_MENU_ITEM(chapters_and_verses1),
                                  image5580);
    ...
    gtk_image_menu_item_set_image(GTK_IMAGE_MENU_ITEM(validate_usfms1),
                                  image5579);
    ...
    gtk_image_menu_item_set_image(GTK_IMAGE_MENU_ITEM(compare_usfm1),
                                  image6748);

    check_markers_spacing =
        gtk_image_menu_item_new_with_mnemonic(_("_Spacing"));
    ...
    gtk_image_menu_item_set_image(GTK_IMAGE_MENU_ITEM(check_markers_spacing),
                                  image17930);
    ...
    gtk_image_menu_item_set_image(GTK_IMAGE_MENU_ITEM(count_characters),
                                  image6868);

    unwanted_patterns =
        gtk_image_menu_item_new_with_mnemonic(_("_Unwanted patterns"));
    ...
    gtk_image_menu_item_set_image(GTK_IMAGE_MENU_ITEM(unwanted_patterns),
                                  image7494);
    ...
    check_capitalization =
        gtk_image_menu_item_new_with_mnemonic(_("_Capitalization"));
    ...
    gtk_image_menu_item_set_image(GTK_IMAGE_MENU_ITEM(check_capitalization),
                                  image7112);
    ...
    gtk_image_menu_item_set_image(GTK_IMAGE_MENU_ITEM(check_repetition),
                                  image7238);
    ...
    gtk_image_menu_item_set_image(GTK_IMAGE_MENU_ITEM(unwanted_words),
                                  image7631);

    word_count_inventory =
        gtk_image_menu_item_new_with_mnemonic(_("_Inventory"));
    ...
    gtk_image_menu_item_set_image(GTK_IMAGE_MENU_ITEM(word_count_inventory),
                                  image13715);

    check_punctuation =
        gtk_image_menu_item_new_with_mnemonic(_("_Punctuation"));
    ...
    gtk_image_menu_item_set_image(GTK_IMAGE_MENU_ITEM(check_punctuation),
                                  image7366);

    check_punctuation_menu = gtk_menu_new();
    gtk_menu_item_set_submenu(GTK_MENU_ITEM(check_punctuation),
                              check_punctuation_menu);

    check_matching_pairs =
        gtk_image_menu_item_new_with_mnemonic(_("_Matching pairs"));
    gtk_widget_show(check_matching_pairs);
    gtk_container_add(GTK_CONTAINER(check_punctuation_menu),
                      check_matching_pairs);

    image7367 = gtk_image_new_from_stock("gtk-refresh", GTK_ICON_SIZE_MENU);
    gtk_widget_show(image7367);
    gtk_image_menu_item_set_image(GTK_IMAGE_MENU_ITEM(check_matching_pairs),
                                  image7367);
    ...
    gtk_image_menu_item_set_image(GTK_IMAGE_MENU_ITEM(check_references),
                                  image21826);

    check_references_menu = gtk_menu_new();
    gtk_menu_item_set_submenu(GTK_MENU_ITEM(check_references),
                              check_references_menu);

    check_references_inventory =
        gtk_image_menu_item_new_with_mnemonic(_("_Inventory"));
    gtk_widget_show(check_references_inventory);
    gtk_container_add(GTK_CONTAINER(check_references_menu),
                      check_references_inventory);

    image21827 = gtk_image_new_from_stock("gtk-info", GTK_ICON_SIZE_MENU);
    gtk_widget_show(image21827);
    gtk_image_menu_item_set_image(
        GTK_IMAGE_MENU_ITEM(check_references_inventory), image21827);

    check_references_validate =
        gtk_image_menu_item_new_with_mnemonic(_("_Validate"));
    gtk_widget_show(check_references_validate);
    gtk_container_add(GTK_CONTAINER(check_references_menu),
                      check_references_validate);

    image21828 =
        gtk_image_new_from_stock("gtk-spell-check", GTK_ICON_SIZE_MENU);
    gtk_widget_show(image21828);
    gtk_image_menu_item_set_image(
        GTK_IMAGE_MENU_ITEM(check_references_validate), image21828);
    ...
    gtk_image_menu_item_set_image(GTK_IMAGE_MENU_ITEM(checks_passages),
                                  image24103);

    checks_passages_menu = gtk_menu_new();
    gtk_menu_item_set_submenu(GTK_MENU_ITEM(checks_passages),
                              checks_passages_menu);

    check_nt_quotations_from_the_ot =
        gtk_image_menu_item_new_with_mnemonic(_("_OT quotations in the NT"));
    gtk_widget_show(check_nt_quotations_from_the_ot);
    gtk_container_add(GTK_CONTAINER(checks_passages_menu),
                      check_nt_quotations_from_the_ot);

    image24104 = gtk_image_new_from_stock("gtk-edit", GTK_ICON_SIZE_MENU);
    gtk_widget_show(image24104);
    gtk_image_menu_item_set_image(
        GTK_IMAGE_MENU_ITEM(check_nt_quotations_from_the_ot), image24104);

    synoptic_parallel_passages_from_the_nt =
        gtk_image_menu_item_new_with_mnemonic(
            _("_Synoptic parallels in the NT"));
    ...
    parallels_from_the_ot =
        gtk_image_menu_item_new_with_mnemonic(_("_Parallels in the OT"));
    ...
    gtk_image_menu_item_set_image(GTK_IMAGE_MENU_ITEM(parallels_from_the_ot),
                                  image24106);
    ...
    check_spelling_error =
        gtk_image_menu_item_new_with_mnemonic(_("_Spelling error"));
    ...
    gtk_image_menu_item_set_image(GTK_IMAGE_MENU_ITEM(check_spelling_error),
                                  image34138);

    check_spelling_error_menu = gtk_menu_new();
    gtk_menu_item_set_submenu(GTK_MENU_ITEM(check_spelling_error),
                              check_spelling_error_menu);

    check_spelling_error_next =
        gtk_image_menu_item_new_with_mnemonic(_("_Next"));
    gtk_widget_show(check_spelling_error_next);
    gtk_container_add(GTK_CONTAINER(check_spelling_error_menu),
                      check_spelling_error_next);
    ...
    gtk_image_menu_item_set_image(
        GTK_IMAGE_MENU_ITEM(check_spelling_error_next), image34139);

    check_spelling_error_previous =
        gtk_image_menu_item_new_with_mnemonic(_("_Previous"));
    ...
    gtk_image_menu_item_set_image(
        GTK_IMAGE_MENU_ITEM(check_spelling_error_previous), image34140);
    ...
    gtk_image_menu_item_set_image(GTK_IMAGE_MENU_ITEM(check_spelling_bulk),
                                  image35887);
  }
  ...
  if (guifeatures.tools()) {
    ...
    notes_transfer = gtk_image_menu_item_new_with_mnemonic(
        _("_Transfer text to project notes"));
    ...
    gtk_image_menu_item_set_image(GTK_IMAGE_MENU_ITEM(notes_transfer),
                                  image14659);

    tool_origin_references_in_bible_notes =
        gtk_image_menu_item_new_with_mnemonic(_("_Bible notes mass update"));
    gtk_widget_show(tool_origin_references_in_bible_notes);
    gtk_container_add(GTK_CONTAINER(menutools_menu),
                      tool_origin_references_in_bible_notes);
    ...
    gtk_image_menu_item_set_image(
        GTK_IMAGE_MENU_ITEM(tool_origin_references_in_bible_notes), image16248);

    tool_project_notes_mass_update1 =
        gtk_image_menu_item_new_with_mnemonic(_("_Project notes mass update"));
    ...
    gtk_image_menu_item_set_image(
        GTK_IMAGE_MENU_ITEM(tool_project_notes_mass_update1), image17187);

    tool_generate_word_lists =
        gtk_image_menu_item_new_with_mnemonic(_("_Generate word lists"));
    ...
    gtk_image_menu_item_set_image(GTK_IMAGE_MENU_ITEM(tool_generate_word_lists),
                                  image20671);

    tool_simple_text_corrections =
        gtk_image_menu_item_new_with_mnemonic(_("_Simple text corrections"));
    ...
    gtk_image_menu_item_set_image(
        GTK_IMAGE_MENU_ITEM(tool_simple_text_corrections), image21054);

    tool_transfer_project_notes_to_text = gtk_image_menu_item_new_with_mnemonic(
        _("Tr_ansfer project notes to text"));
    ...
    gtk_image_menu_item_set_image(
        GTK_IMAGE_MENU_ITEM(tool_transfer_project_notes_to_text), image29089);
  }

  tool_go_to_reference =
      gtk_image_menu_item_new_with_mnemonic(_("G_o to reference (Ctrl-G)"));
  ...
  gtk_image_menu_item_set_image(GTK_IMAGE_MENU_ITEM(tool_go_to_reference),
                                image36137);
  ...
  gtk_image_menu_item_set_image(GTK_IMAGE_MENU_ITEM(tools_maintenance),
                                image36259);
  ...
  gtk_menu_item_set_submenu(GTK_MENU_ITEM(menuitem_preferences),
                            menuitem_preferences_menu);
  ...
  if (guifeatures.preferences()) {
    ...
    notes_preferences =
        gtk_image_menu_item_new_with_mnemonic(_("Project _notes"));
    gtk_widget_show(notes_preferences);
    gtk_container_add(GTK_CONTAINER(menuitem_preferences_menu),
                      notes_preferences);

    image2116 = gtk_image_new_from_stock("gtk-dialog-info", GTK_ICON_SIZE_MENU);
    gtk_widget_show(image2116);
    gtk_image_menu_item_set_image(GTK_IMAGE_MENU_ITEM(notes_preferences),
                                  image2116);
    ...
    gtk_image_menu_item_set_image(GTK_IMAGE_MENU_ITEM(printingprefs),
                                  image3493);

    reference_exchange1 =
        gtk_image_menu_item_new_with_mnemonic(_("_Reference exchange"));
    ...
    gtk_image_menu_item_set_image(GTK_IMAGE_MENU_ITEM(reference_exchange1),
                                  image5972);
    ...
    preferences_windows_outpost =
        gtk_image_menu_item_new_with_mnemonic(_("_Windows Outpost"));
    ...
    gtk_image_menu_item_set_image(
        GTK_IMAGE_MENU_ITEM(preferences_windows_outpost), image14287);

    preferences_tidy_text =
        gtk_image_menu_item_new_with_mnemonic(_("_Tidy text"));
    ...
    gtk_image_menu_item_set_image(GTK_IMAGE_MENU_ITEM(preferences_tidy_text),
                                  image16359);

    preferences_remote_repository =
        gtk_image_menu_item_new_with_mnemonic(_("R_emote repository"));
    ...
    gtk_image_menu_item_set_image(
        GTK_IMAGE_MENU_ITEM(preferences_remote_repository), image33654);
  }
  ...
  gtk_image_menu_item_set_image(GTK_IMAGE_MENU_ITEM(preferences_gui),
                                image20936);
  ...
  if (guifeatures.preferences()) {
    ...
    preferences_password =
        gtk_image_menu_item_new_with_mnemonic(_("P_assword"));
    ...
    gtk_image_menu_item_set_image(GTK_IMAGE_MENU_ITEM(preferences_password),
                                  image20937);

    preferences_text_replacement =
        gtk_image_menu_item_new_with_mnemonic(_("Te_xt replacement"));
    ...
    gtk_image_menu_item_set_image(
        GTK_IMAGE_MENU_ITEM(preferences_text_replacement), image23181);
    ...
    preferences_planning =
        gtk_image_menu_item_new_with_mnemonic(_("P_lanning"));
    ...
    gtk_image_menu_item_set_image(GTK_IMAGE_MENU_ITEM(preferences_planning),
                                  image26888);
    ...
    gtk_image_menu_item_set_image(GTK_IMAGE_MENU_ITEM(preferences_filters),
                                  image28360);
    ...
    gtk_image_menu_item_set_image(GTK_IMAGE_MENU_ITEM(preferences_compare),
                                  image32676);
  }
  ...
  gtk_scrolled_window_set_policy(GTK_SCROLLED_WINDOW(scrolledwindow_layout),
                                 GTK_POLICY_NEVER, GTK_POLICY_NEVER);
  gtk_scrolled_window_set_shadow_type(
      GTK_SCROLLED_WINDOW(scrolledwindow_layout), GTK_SHADOW_IN);

  layout = gtk_layout_new(NULL, NULL);
  gtk_widget_show(layout);
  gtk_container_add(GTK_CONTAINER(scrolledwindow_layout), layout);
  // The real size of the layout will be set once space has been allocated to
  // the parent scrolled window
  ...
  // Menu callbacks.
  if (new1)
    g_signal_connect((gpointer)new1, "activate", G_CALLBACK(on_new1_activate),
                     gpointer(this));
  if (open1)
    g_signal_connect((gpointer)open1, "activate", G_CALLBACK(on_open1_activate),
                     gpointer(this));
  if (delete1)
    g_signal_connect((gpointer)delete1, "activate",
                     G_CALLBACK(on_delete1_activate), gpointer(this));
  if (properties1)
    g_signal_connect((gpointer)properties1, "activate",
                     G_CALLBACK(on_properties1_activate), gpointer(this));
  if (copy_project_to)
    g_signal_connect((gpointer)copy_project_to, "activate",
                     G_CALLBACK(on_copy_project_to_activate), gpointer(this));
  if (compare_with1)
    g_signal_connect((gpointer)compare_with1, "activate",
                     G_CALLBACK(on_compare_with1_activate), gpointer(this));
  if (project_changes)
    g_signal_connect((gpointer)project_changes, "activate",
                     G_CALLBACK(on_project_changes_activate), gpointer(this));
  if (file_projects_merge)
    g_signal_connect((gpointer)file_projects_merge, "activate",
                     G_CALLBACK(on_file_projects_merge_activate),
                     gpointer(this));
  g_signal_connect((gpointer)projects_send_receive1, "activate",
                   G_CALLBACK(on_projects_send_receive1_activate),
                   gpointer(this));
  if (stylesheet_open)
    g_signal_connect((gpointer)stylesheet_open, "activate",
                     G_CALLBACK(on_stylesheet_open_activate), gpointer(this));
  if (new_note)
    g_signal_connect((gpointer)new_note, "activate",
                     G_CALLBACK(on_new_note_activate), gpointer(this));
  if (delete_note)
    g_signal_connect((gpointer)delete_note, "activate",
                     G_CALLBACK(on_delete_note_activate), gpointer(this));
  if (consultation_notes_send_receive)
    g_signal_connect((gpointer)consultation_notes_send_receive, "activate",
                     G_CALLBACK(on_consultant_notes_send_receive_activate),
                     gpointer(this));
  if (file_resources)
    g_signal_connect((gpointer)file_resources, "activate",
                     G_CALLBACK(on_file_resources_activate), gpointer(this));
  if (file_resources_open)
    g_signal_connect((gpointer)file_resources_open, "activate",
                     G_CALLBACK(on_file_resources_open_activate),
                     gpointer(this));
  if (file_resources_close)
    g_signal_connect((gpointer)file_resources_close, "activate",
                     G_CALLBACK(on_file_resources_close_activate),
                     gpointer(this));
  if (file_resources_new)
    g_signal_connect((gpointer)file_resources_new, "activate",
                     G_CALLBACK(on_file_resources_new_activate),
                     gpointer(this));
  if (file_resources_edit)
    g_signal_connect((gpointer)file_resources_edit, "activate",
                     G_CALLBACK(on_file_resources_edit_activate),
                     gpointer(this));
  if (file_resources_delete)
    g_signal_connect((gpointer)file_resources_delete, "activate",
                     G_CALLBACK(on_file_resources_delete_activate),
                     gpointer(this));
  if (keyterms_delete)
    g_signal_connect((gpointer)keyterms_delete, "activate",
                     G_CALLBACK(on_keyterms_delete_activate), gpointer(this));
  if (print)
    g_signal_connect((gpointer)print, "activate", G_CALLBACK(on_print_activate),
                     gpointer(this));
  g_signal_connect((gpointer)file_import, "activate",
                   G_CALLBACK(on_file_import_activate), gpointer(this));
  g_signal_connect((gpointer)file_export, "activate",
                   G_CALLBACK(on_file_export_activate), gpointer(this));
  g_signal_connect((gpointer)file_backup, "activate",
                   G_CALLBACK(on_file_backup_activate), gpointer(this));
  g_signal_connect((gpointer)file_restore, "activate",
                   G_CALLBACK(on_file_restore_activate), gpointer(this));
  if (close1)
    g_signal_connect((gpointer)close1, "activate",
                     G_CALLBACK(on_close1_activate), gpointer(this));
  if (quit1)
    g_signal_connect((gpointer)quit1, "activate", G_CALLBACK(on_quit1_activate),
                     gpointer(this));
  if (menuitem_edit)
    g_signal_connect((gpointer)menuitem_edit, "activate",
                     G_CALLBACK(on_edit1_activate), gpointer(this));
  if (cut1)
    g_signal_connect((gpointer)cut1, "activate", G_CALLBACK(on_cut1_activate),
                     gpointer(this));
  if (copy1)
    g_signal_connect((gpointer)copy1, "activate", G_CALLBACK(on_copy1_activate),
                     gpointer(this));
  if (copy_with_formatting)
    g_signal_connect((gpointer)copy_with_formatting, "activate",
                     G_CALLBACK(on_copy_with_formatting_activate),
                     gpointer(this));
  if (paste1)
    g_signal_connect((gpointer)paste1, "activate",
                     G_CALLBACK(on_paste1_activate), gpointer(this));
  if (undo1)
    g_signal_connect((gpointer)undo1, "activate", G_CALLBACK(on_undo1_activate),
                     gpointer(this));
  if (redo1)
    g_signal_connect((gpointer)redo1, "activate", G_CALLBACK(on_redo1_activate),
                     gpointer(this));
  if (find1)
    g_signal_connect((gpointer)find1, "activate",
                     G_CALLBACK(on_findspecial1_activate), gpointer(this));
  if (find_and_replace1)
    g_signal_connect((gpointer)find_and_replace1, "activate",
                     G_CALLBACK(on_find_and_replace1_activate), gpointer(this));
  if (find_in_notes1)
    g_signal_connect((gpointer)find_in_notes1, "activate",
                     G_CALLBACK(on_find_in_notes1_activate), gpointer(this));
  if (get_references_from_note)
    g_signal_connect((gpointer)get_references_from_note, "activate",
                     G_CALLBACK(on_get_references_from_note_activate),
                     gpointer(this));
  if (edit_revert)
    g_signal_connect((gpointer)edit_revert, "activate",
                     G_CALLBACK(on_edit_revert_activate), gpointer(this));
  if (edit_bible_note)
    g_signal_connect((gpointer)edit_bible_note, "activate",
                     G_CALLBACK(on_edit_bible_note_activate), gpointer(this));
  if (edit_planning)
    g_signal_connect((gpointer)edit_planning, "activate",
                     G_CALLBACK(on_edit_planning_activate), gpointer(this));
  if (menuitem_view)
    g_signal_connect((gpointer)menuitem_view, "activate",
                     G_CALLBACK(on_menuitem_view_activate), gpointer(this));
  if (view_text_font)
    g_signal_connect((gpointer)view_text_font, "activate",
                     G_CALLBACK(on_view_text_font_activate), gpointer(this));
  if (viewnotes)
    g_signal_connect((gpointer)viewnotes, "activate",
                     G_CALLBACK(on_viewnotes_activate), gpointer(this));
  if (view_formatted) {
    g_signal_connect((gpointer)view_formatted, "activate",
                     G_CALLBACK(on_view_chapteras_activate), gpointer(this));
    g_signal_connect((gpointer)view_formatted, "toggled",
                     G_CALLBACK(on_view_formatted_toggled), gpointer(this));
  }
  if (view_usfm_code) {
    g_signal_connect((gpointer)view_usfm_code, "activate",
                     G_CALLBACK(on_view_chapteras_activate), gpointer(this));
    g_signal_connect((gpointer)view_usfm_code, "toggled",
                     G_CALLBACK(on_view_usfm_code_toggled), gpointer(this));
  }
  if (view_experimental) {
    g_signal_connect((gpointer)view_experimental, "activate",
                     G_CALLBACK(on_view_chapteras_activate), gpointer(this));
    g_signal_connect((gpointer)view_experimental, "toggled",
                     G_CALLBACK(on_view_experimental_toggled), gpointer(this));
  }

  if (view_planning)
    g_signal_connect((gpointer)view_planning, "activate",
                     G_CALLBACK(on_view_planning_activate), gpointer(this));
  if (view_related_verses)
    g_signal_connect((gpointer)view_related_verses, "activate",
                     G_CALLBACK(on_view_related_verses_activate),
                     gpointer(this));
  g_signal_connect((gpointer)view_references, "activate",
                   G_CALLBACK(on_view_references_activate), gpointer(this));
  if (view_concordance) {
    g_signal_connect((gpointer)view_concordance, "activate",
                     G_CALLBACK(on_view_concordance_activate), gpointer(this));
  }
  if (view_outline)
    g_signal_connect((gpointer)view_outline, "activate",
                     G_CALLBACK(on_view_outline_activate), gpointer(this));
  g_signal_connect((gpointer)view_tile_windows, "activate",
                   G_CALLBACK(on_view_tile_windows_activate), gpointer(this));
#ifdef WIN32
  if (view_bibleworks) {
    g_signal_connect((gpointer)view_bibleworks, "activate",
                     G_CALLBACK(on_view_bibleworks_activate), gpointer(this));
  }
#endif
  if (view_biblegateway) {
    g_signal_connect((gpointer)view_biblegateway, "activate",
                     G_CALLBACK(on_view_biblegateway_activate), gpointer(this));
  }
  if (view_biblestudytools) {
    g_signal_connect((gpointer)view_biblestudytools, "activate",
                     G_CALLBACK(on_view_biblestudytools_activate),
                     gpointer(this));
  }
  if (view_blueletterbible) {
    g_signal_connect((gpointer)view_blueletterbible, "activate",
                     G_CALLBACK(on_view_blueletterbible_activate),
                     gpointer(this));
  }
  if (view_bibleorg) {
    g_signal_connect((gpointer)view_bibleorg, "activate",
                     G_CALLBACK(on_view_bibleorg_activate), gpointer(this));
  }

  if (insert1)
    g_signal_connect((gpointer)insert1, "activate",
                     G_CALLBACK(on_insert1_activate), gpointer(this));
  if (insert_special_character)
    g_signal_connect((gpointer)insert_special_character, "activate",
                     G_CALLBACK(on_insert_special_character_activate),
                     gpointer(this));
  if (insert_footnote)
    g_signal_connect((gpointer)insert_footnote, "activate",
                     G_CALLBACK(on_insert_footnote_activate), gpointer(this));
  if (insert_xref)
    g_signal_connect((gpointer)insert_xref, "activate",
                     G_CALLBACK(on_insert_xref_activate), gpointer(this));
  if (validate_usfms1)
    g_signal_connect((gpointer)validate_usfms1, "activate",
                     G_CALLBACK(on_validate_usfms1_activate), gpointer(this));
  if (count_usfms1)
    g_signal_connect((gpointer)count_usfms1, "activate",
                     G_CALLBACK(on_count_usfms1_activate), gpointer(this));
  if (compare_usfm1)
    g_signal_connect((gpointer)compare_usfm1, "activate",
                     G_CALLBACK(on_compare_usfm1_activate), gpointer(this));
  if (check_markers_spacing)
    g_signal_connect((gpointer)check_markers_spacing, "activate",
                     G_CALLBACK(on_check_markers_spacing_activate),
                     gpointer(this));
  if (chapters_and_verses1)
    g_signal_connect((gpointer)chapters_and_verses1, "activate",
                     G_CALLBACK(on_chapters_and_verses1_activate),
                     gpointer(this));
  if (count_characters)
    g_signal_connect((gpointer)count_characters, "activate",
                     G_CALLBACK(on_count_characters_activate), gpointer(this));
  if (unwanted_patterns)
    g_signal_connect((gpointer)unwanted_patterns, "activate",
                     G_CALLBACK(on_unwanted_patterns_activate), gpointer(this));
  if (check_capitalization)
    g_signal_connect((gpointer)check_capitalization, "activate",
                     G_CALLBACK(on_check_capitalization_activate),
                     gpointer(this));
  if (check_repetition)
    g_signal_connect((gpointer)check_repetition, "activate",
                     G_CALLBACK(on_check_repetition_activate), gpointer(this));
  if (unwanted_words)
    g_signal_connect((gpointer)unwanted_words, "activate",
                     G_CALLBACK(on_unwanted_words_activate), gpointer(this));
  if (check_matching_pairs)
    g_signal_connect((gpointer)check_matching_pairs, "activate",
                     G_CALLBACK(on_check_matching_pairs_activate),
                     gpointer(this));
  if (word_count_inventory)
    g_signal_connect((gpointer)word_count_inventory, "activate",
                     G_CALLBACK(on_word_count_inventory_activate),
                     gpointer(this));
  if (check_references_inventory)
    g_signal_connect((gpointer)check_references_inventory, "activate",
                     G_CALLBACK(on_check_references_inventory_activate),
                     gpointer(this));
  if (check_references_validate)
    g_signal_connect((gpointer)check_references_validate, "activate",
                     G_CALLBACK(on_check_references_validate_activate),
                     gpointer(this));
  if (check_nt_quotations_from_the_ot)
    g_signal_connect((gpointer)check_nt_quotations_from_the_ot, "activate",
                     G_CALLBACK(on_check_nt_quotations_from_the_ot_activate),
                     gpointer(this));
  if (synoptic_parallel_passages_from_the_nt)
    g_signal_connect(
        (gpointer)synoptic_parallel_passages_from_the_nt, "activate",
        G_CALLBACK(on_synoptic_parallel_passages_from_the_nt_activate),
        gpointer(this));
  if (parallels_from_the_ot)
    g_signal_connect((gpointer)parallels_from_the_ot, "activate",
                     G_CALLBACK(on_parallels_from_the_ot_activate),
                     gpointer(this));
  if (check_key_terms)
    g_signal_connect((gpointer)check_key_terms, "activate",
                     G_CALLBACK(on_check_key_terms_activate), gpointer(this));
  if (my_checks)
    g_signal_connect((gpointer)my_checks, "activate",
                     G_CALLBACK(on_my_checks_activate), gpointer(this));
  if (check_usfm)
    g_signal_connect((gpointer)check_usfm, "activate",
                     G_CALLBACK(on_check_usfm_activate), gpointer(this));
  if (check_spelling_error_next)
    g_signal_connect((gpointer)check_spelling_error_next, "activate",
                     G_CALLBACK(on_check_spelling_error_next_activate),
                     gpointer(this));
  if (check_spelling_error_previous)
    g_signal_connect((gpointer)check_spelling_error_previous, "activate",
                     G_CALLBACK(on_check_spelling_error_previous_activate),
                     gpointer(this));
  if (check_spelling_bulk)
    g_signal_connect((gpointer)check_spelling_bulk, "activate",
                     G_CALLBACK(on_check_spelling_bulk_activate),
                     gpointer(this));
  if (menutools)
    g_signal_connect((gpointer)menutools, "activate",
                     G_CALLBACK(on_menutools_activate), gpointer(this));
  if (notes_transfer)
    g_signal_connect((gpointer)notes_transfer, "activate",
                     G_CALLBACK(on_notes_transfer_activate), gpointer(this));
  if (tool_origin_references_in_bible_notes)
    g_signal_connect(
        (gpointer)tool_origin_references_in_bible_notes, "activate",
        G_CALLBACK(on_tool_origin_references_in_bible_notes_activate),
        gpointer(this));
  if (tool_project_notes_mass_update1)
    g_signal_connect((gpointer)tool_project_notes_mass_update1, "activate",
                     G_CALLBACK(on_tool_project_notes_mass_update1_activate),
                     gpointer(this));
  if (tool_generate_word_lists)
    g_signal_connect((gpointer)tool_generate_word_lists, "activate",
                     G_CALLBACK(on_tool_generate_word_lists_activate),
                     gpointer(this));
  if (tool_simple_text_corrections)
    g_signal_connect((gpointer)tool_simple_text_corrections, "activate",
                     G_CALLBACK(on_tool_simple_text_corrections_activate),
                     gpointer(this));
  if (tool_transfer_project_notes_to_text)
    g_signal_connect(
        (gpointer)tool_transfer_project_notes_to_text, "activate",
        G_CALLBACK(on_tool_transfer_project_notes_to_text_activate),
        gpointer(this));
  g_signal_connect((gpointer)tool_go_to_reference, "activate",
                   G_CALLBACK(on_tool_go_to_reference_activate),
                   gpointer(this));
  g_signal_connect((gpointer)tools_maintenance, "activate",
                   G_CALLBACK(on_tools_maintenance_activate), gpointer(this));
  if (notes_preferences)
    g_signal_connect((gpointer)notes_preferences, "activate",
                     G_CALLBACK(on_notes_preferences_activate), gpointer(this));
  if (printingprefs)
    g_signal_connect((gpointer)printingprefs, "activate",
                     G_CALLBACK(on_printingprefs_activate), gpointer(this));
  if (reference_exchange1)
    g_signal_connect((gpointer)reference_exchange1, "activate",
                     G_CALLBACK(on_reference_exchange1_activate),
                     gpointer(this));
  if (prefs_books)
    g_signal_connect((gpointer)prefs_books, "activate",
                     G_CALLBACK(on_prefs_books_activate), gpointer(this));
  ...
  if (preferences_tidy_text)
    g_signal_connect((gpointer)preferences_tidy_text, "activate",
                     G_CALLBACK(on_preferences_tidy_text_activate),
                     gpointer(this));
  if (preferences_remote_repository)
    g_signal_connect((gpointer)preferences_remote_repository, "activate",
                     G_CALLBACK(on_preferences_remote_repository_activate),
                     gpointer(this));
  if (preferences_gui)
    g_signal_connect((gpointer)preferences_gui, "activate",
                     G_CALLBACK(on_preferences_gui_activate), gpointer(this));
  if (preferences_password)
    g_signal_connect((gpointer)preferences_password, "activate",
                     G_CALLBACK(on_preferences_password_activate),
                     gpointer(this));
  if (preferences_text_replacement)
    g_signal_connect((gpointer)preferences_text_replacement, "activate",
                     G_CALLBACK(on_preferences_text_replacement_activate),
                     gpointer(this));
  if (pdf_viewer1)
    g_signal_connect((gpointer)pdf_viewer1, "activate",
                     G_CALLBACK(on_pdf_viewer1_activate), gpointer(this));
  if (preferences_planning)
    g_signal_connect((gpointer)preferences_planning, "activate",
                     G_CALLBACK(on_preferences_planning_activate),
                     gpointer(this));
  if (preferences_filters)
    g_signal_connect((gpointer)preferences_filters, "activate",
                     G_CALLBACK(on_preferences_filters_activate),
                     gpointer(this));
  if (preferences_compare)
    g_signal_connect((gpointer)preferences_compare, "activate",
                     G_CALLBACK(on_preferences_compare_activate),
                     gpointer(this));
  if (help_main)
    g_signal_connect((gpointer)help_main, "activate",
                     G_CALLBACK(on_help_main_activate), gpointer(this));
  if (system_log1)
    g_signal_connect((gpointer)system_log1, "activate",
                     G_CALLBACK(on_system_log1_activate), gpointer(this));
  if (about1)
    g_signal_connect((gpointer)about1, "activate",
                     G_CALLBACK(on_about1_activate), gpointer(this));
  g_signal_connect((gpointer)scrolledwindow_layout, "size_allocate",
                   G_CALLBACK(on_scrolledwindow_layout_size_allocate),
                   gpointer(this));
  navigation.build(toolbar);
  g_signal_connect((gpointer)navigation.new_reference_signal, "clicked",
                   G_CALLBACK(on_navigation_new_reference_clicked),
                   gpointer(this));
  ...
  // Store project of last session because it gets affected when the editors
  // build.
...
void MainWindow::on_delete1_activate(GtkMenuItem *menuitem,
                                     gpointer user_data) {
...
void MainWindow::deleteproject() {
  ...
  if (dialog.run() == GTK_RESPONSE_OK) {
    int result;
    result = gtkw_dialog_question(
        window_main,
        _("Are you sure you want to delete project ") + dialog.focus + "?");
    if (result == GTK_RESPONSE_YES) {
      result = gtkw_dialog_question(
          window_main, _("Are you really sure to delete project ") +
                           dialog.focus +
                           _(", something worth perhaps years of work?"));
    }
    if (result == GTK_RESPONSE_YES) {
...
void MainWindow::viewlog() {
  ...
  // This window can float while the user does other things, so the syslogdialog
  // has some
  // persistent state to manage this feature. It takes care of killing the
  // window, restarting a
...
void MainWindow::showabout() {
  gtk_show_about_dialog(
      GTK_WINDOW(window_main), "version", PACKAGE_VERSION, "website",
      PACKAGE_BUGREPORT, "copyright",
      _("Copyright (c) 2003-2013 Teus Benschop"), "translator-credits",
      _("translator-credits"), "license",
...
void MainWindow::menu_edit() {
  ...
  // The "owner-change" signal of the clipboard is not a reliable indicator for
  // pastable content.
  bool cut = true;
  bool copy = true;
  bool paste = true;
  ...
  vector<Reference> results;
  {
    ...
    if (replacedialog.run() == GTK_RESPONSE_OK) {
      ...
      if (window_references) {
        window_references->set(replacedialog.results,
                               settings->genconfig.project_get(), NULL);
      }
    } else {
      return;
    }
...
void MainWindow::on_insert1_activate(GtkMenuItem *menuitem,
                                     gpointer user_data) {
...
// Sets the labels of the underlying menu items right.
{
  ...
  gtk_widget_set_sensitive(insert_special_character,
                           (editor_window && (editor_window->focused)));

  // Inserting footnote and xref.
  gtk_widget_set_sensitive(insert_footnote,
                           (editor_window && (editor_window->focused)));
  gtk_widget_set_sensitive(insert_xref,
                           (editor_window && (editor_window->focused)));
}
...
{
  save_editors();
  EntryDialog dialog(_("New project name"),
                     _("Enter a name of a non-existent project\nwhere this "
                       "project will be copied to."),
                     settings->genconfig.project_get());
  if (dialog.run() == GTK_RESPONSE_OK) {
    // Does the project exist?
    if ((project_exists(dialog.entered_value)) ||
        (dialog.entered_value == "data")) {
...
// This function is called when the navigation object goes to another reference.
{
  ...
  settings->genconfig.chapter_set(
      convert_to_string(navigation.reference.chapter_get()));
  ...
  // These may not take verses like 10a or 10-12, but only numbers like 10 or
  // 12.
  ...
  if (window_show_related_verses) {
    window_show_related_verses->go_to(settings->genconfig.project_get(),
                                      navigation.reference);
  }
}

void MainWindow::goto_next_verse() { navigation.nextverse(); }

void MainWindow::goto_previous_verse() { navigation.previousverse(); }

void MainWindow::goto_next_chapter() { navigation.nextchapter(); }

void MainWindow::goto_previous_chapter() { navigation.previouschapter(); }

void MainWindow::goto_next_book() { navigation.nextbook(); }

void MainWindow::goto_previous_book() { navigation.previousbook(); }
  ...
  if (editor_window) {
    ...
    if (dialog.run() == GTK_RESPONSE_OK) {
      if (dialog.newreference) {
        ...
        // This focusing causes the navigation to take the values as they are in
        // the configuration.
        ...
        settings->genconfig.chapter_set(
            convert_to_string(dialog.reference.chapter_get()));
...
// This one is called when an editor signals that the cursor is now on another
// verse.
{
  WindowEditor *last_focused_editor = last_focused_editor_window();
  if (last_focused_editor) {
...
void MainWindow::on_tools_area_activate() {
  if (window_show_related_verses) {
    if (focused_tool_button ==
        window_show_related_verses->focus_in_signal_button) {
...
void MainWindow::on_tool_go_to_reference_activate(GtkMenuItem *menuitem,
                                                  gpointer user_data) {
...
void MainWindow::on_copy_with_formatting_activate(GtkMenuItem *menuitem,
                                                  gpointer user_data) {
  ((MainWindow *)user_data)->on_copy_with_formatting();
}

void MainWindow::on_copy_with_formatting() {
  // Using the accelerator in the GtkTextView give weird results. The
  // accelerator has been removed.
  WindowEditor *editor_window = last_focused_editor_window();
  if (editor_window) {
    if (editor_window->focused) {
      // In case of the text editor, the USFM code is copied, not the plain
      // text.
      GtkClipboard *clipboard = gtk_clipboard_get(GDK_SELECTION_CLIPBOARD);
      gtk_clipboard_set_text(clipboard,
                             editor_window->text_get_selection().c_str(), -1);
    }
  }
}
...
void MainWindow::on_view_references_activate(GtkMenuItem *menuitem,
                                             gpointer user_data) {
...
void MainWindow::on_view_references() {
  ...
  if (gtk_check_menu_item_get_active(GTK_CHECK_MENU_ITEM(view_references))) {
    ...
    window_references = new WindowReferences(
        layout, accelerator_group, windows_startup_pointer != G_MAXINT,
        references_management_enabled);
    g_signal_connect(
        (gpointer)window_references->delete_signal_button, "clicked",
        G_CALLBACK(on_window_references_delete_button_clicked), gpointer(this));
    g_signal_connect((gpointer)window_references->focus_in_signal_button,
                     "clicked", G_CALLBACK(on_window_focus_button_clicked),
                     gpointer(this));
    g_signal_connect((gpointer)window_references->signal_button, "clicked",
                     G_CALLBACK(on_window_references_signal_button_clicked),
                     gpointer(this));
  }
}

void MainWindow::on_view_concordance_activate(GtkMenuItem *menuitem,
                                              gpointer user_data) {
...
void MainWindow::on_view_concordance() {
  if (gtk_check_menu_item_get_active(GTK_CHECK_MENU_ITEM(view_concordance))) {
    // This tabbed window may already be created, so it need not be created
    // again
    if (!window_info) {
      window_info = new WindowTabbed(layout, accelerator_group,
                                     windows_startup_pointer != G_MAXINT);
    }
    window_info->Concordance();
    g_signal_connect((gpointer)window_info->delete_signal_button, "clicked",
                     G_CALLBACK(on_window_info_delete_button_clicked),
                     gpointer(this));
    g_signal_connect((gpointer)window_info->focus_in_signal_button, "clicked",
                     G_CALLBACK(on_window_focus_button_clicked),
                     gpointer(this));
    g_signal_connect((gpointer)window_info->signal_button, "clicked",
                     G_CALLBACK(on_window_info_signal_button_clicked),
                     gpointer(this));
  }
}
...
void MainWindow::on_window_references_delete_button_clicked(
...
void MainWindow::on_window_info_delete_button_clicked(GtkButton *button,
                                                      gpointer user_data) {
...
void MainWindow::on_window_info_delete_button() {
  if (window_info) {
    delete window_info;
    window_info = NULL;
    gtk_check_menu_item_set_active(GTK_CHECK_MENU_ITEM(view_concordance),
                                   FALSE);
    // ^^^ for now...need to change to view_info or so
  }
}

void MainWindow::on_window_references_signal_button_clicked(GtkButton *button,
                                                            gpointer user_data)
// This routine is called when the reference window fires a signal that
...
// Handler for when the user clicked a reference in the references window so as
// to go to that reference.
{
...
void MainWindow::on_window_info_signal_button_clicked(GtkButton *button,
                                                      gpointer user_data)
// This routine is called when the info window fires a signal that something has
// happened.
{
...
// Handler for when the user clicks something in the window we will do the right
// thing
{
  // Get the editor window. If none, bail out.
  WindowEditor *editor_window = last_focused_editor_window();
...
void MainWindow::on_show_quick_references_signal_button_clicked(
    GtkButton *button, gpointer user_data) {
...
void MainWindow::on_show_quick_references_signal_button(GtkButton *button) {
  ...
  if (yes_no_always_dialog(_("This note has references.\nWould you like to "
                             "load these in the references list?"),
                           ynadtLoadReferences, false, true)) {
...
void MainWindow::view_project_notes() {
  ...
  if (window_notes) {
    ...
    // New notes window.
    window_notes = new WindowNotes(layout, accelerator_group,
                                   windows_startup_pointer != G_MAXINT);
    g_signal_connect((gpointer)window_notes->delete_signal_button, "clicked",
                     G_CALLBACK(on_window_notes_delete_button_clicked),
                     gpointer(this));
    g_signal_connect((gpointer)window_notes->focus_in_signal_button, "clicked",
                     G_CALLBACK(on_window_focus_button_clicked),
                     gpointer(this));
    g_signal_connect(
        (gpointer)window_notes->references_available_signal_button, "clicked",
        G_CALLBACK(on_window_notes_references_available_button_clicked),
        gpointer(this));
...
void MainWindow::on_window_notes_delete_button_clicked(GtkButton *button,
                                                       gpointer user_data) {
...
void MainWindow::on_new_note_activate(GtkMenuItem *menuitem,
                                      gpointer user_data) {
...
void MainWindow::on_delete_note_activate(GtkMenuItem *menuitem,
                                         gpointer user_data) {
  gtkw_dialog_info(((MainWindow *)user_data)->window_main,
                   _("A note can be deleted by clicking on the [delete] link "
                     "in the notes view"));
}

void MainWindow::on_consultant_notes_send_receive_activate(
...
void MainWindow::on_viewnotes_activate(GtkMenuItem *menuitem,
                                       gpointer user_data) {
...
void MainWindow::on_window_notes_references_available_button_clicked(
    GtkButton *button, gpointer user_data) {
...
void MainWindow::on_file_export_activate(GtkMenuItem *menuitem,
                                         gpointer user_data) {
...
void MainWindow::on_file_export() {
  ...
  export_assistant = new ExportAssistant(window_references, window_styles,
                                         window_check_keyterms);
  g_signal_connect((gpointer)export_assistant->signal_button, "clicked",
                   G_CALLBACK(on_assistant_ready_signal), gpointer(this));
}
...
void MainWindow::on_check_httpd() {
  ...
  if (!httpd.search_whole_word.empty()) {
    ...
    SessionHighlights sessionhighlights(
        settings->session.searchword, settings->session.search_case_sensitive,
        settings->session.search_globbing,
        settings->session.search_start_word_match,
        settings->session.search_end_word_match, atRaw, false, false, false,
...
void MainWindow::on_my_checks_activate(GtkMenuItem *menuitem,
                                       gpointer user_data) {
...
void MainWindow::on_check_spelling_error_next_activate(GtkMenuItem *menuitem,
                                                       gpointer user_data) {
  ((MainWindow *)user_data)->on_check_spelling_error(true, false);
}

void MainWindow::on_check_spelling_error_previous_activate(
    GtkMenuItem *menuitem, gpointer user_data) {
...
// extremity: start checking at the extremity of the chapter that is open.
{
  ...
  if (!projectconfig->spelling_check_get()) {
    gtkw_dialog_info(
        window_main,
        _("To make this work, enable spelling checking in the project"));
    return;
  }
  ...
  // No next (or previous) error in the current chapter. Ask whether the user
  // wishes to go to other chapter.
...
void MainWindow::on_editor_spelling_checked_button_clicked(GtkButton *button,
                                                           gpointer user_data) {
...
void MainWindow::on_check_spelling_bulk_activate(GtkMenuItem *menuitem,
                                                 gpointer user_data) {
...
void MainWindow::on_stylesheet_open_activate(GtkMenuItem *menuitem,
                                             gpointer user_data) {
  ((MainWindow *)user_data)->on_stylesheet_open();
}

void MainWindow::on_stylesheet_open() { display_window_styles(); }

void MainWindow::on_goto_styles_area() {
  // Create or active the styles window.
  display_window_styles();
  // Focus the window to enable the user to start inserting the style using the
  // keyboard.
  if (window_styles) {
    window_styles->focus_set();
  }
...
void MainWindow::display_window_styles() {
  ...
  if (!window_styles) {
    ...
    window_styles = new WindowStyles(
        layout, accelerator_group, windows_startup_pointer != G_MAXINT, style,
        style_menu, stylesheets_expand_all, stylesheets_collapse_all,
        style_insert, stylesheet_edit_mode, style_new, style_properties,
        style_delete, stylesheet_switch, stylesheets_new, stylesheets_delete,
        stylesheets_rename);
    g_signal_connect((gpointer)window_styles->delete_signal_button, "clicked",
                     G_CALLBACK(on_window_styles_delete_button_clicked),
                     gpointer(this));
    g_signal_connect((gpointer)window_styles->focus_in_signal_button, "clicked",
                     G_CALLBACK(on_window_focus_button_clicked),
                     gpointer(this));
    g_signal_connect((gpointer)window_styles->apply_signal, "clicked",
                     G_CALLBACK(on_style_button_apply_clicked), gpointer(this));
    g_signal_connect((gpointer)window_styles->open_signal, "clicked",
                     G_CALLBACK(on_style_button_open_clicked), gpointer(this));
    g_signal_connect((gpointer)window_styles->edited_signal, "clicked",
                     G_CALLBACK(on_style_edited), gpointer(this));
    stylesheet_open_named(stylesheet_get_actual());
  }
}

void MainWindow::on_window_styles_delete_button_clicked(GtkButton *button,
                                                        gpointer user_data) {
...
void MainWindow::on_style_button_open_clicked(GtkButton *button,
                                              gpointer user_data)
// This is activated by the GuiStyles object if another stylesheet should be
// opened.
{
...
void MainWindow::on_style_apply(ustring marker) {
  // Variable 'marker' may be empty, in which case it is called from the Styles
  // window.
  ...
  // Bail out if there's no styles window and we haven't already been told what
  // style to use.
  if (marker == "") {
    if (!window_styles) {
      return;
  ...
  if (style.type == stChapterNumber) {
    ...
    if (gtkw_dialog_question(window_main,
                             _("Would you like to insert a new chapter?"),
...
void MainWindow::on_editor_style_changed(GtkButton *button,
                                         gpointer user_data) {
...
void MainWindow::on_insert_footnote_activate(GtkMenuItem *menuitem,
                                             gpointer user_data) {
  ((MainWindow *)user_data)->on_style_apply("f");
}

void MainWindow::on_insert_xref_activate(GtkMenuItem *menuitem,
                                         gpointer user_data) {
...
void MainWindow::on_menutools_activate(GtkMenuItem *menuitem,
                                       gpointer user_data) {}
...
// This transfers the currently visible project notes to the currently active
// project,
...
void MainWindow::on_tools_maintenance_activate(GtkMenuItem *menuitem,
                                               gpointer user_data) {
...
void MainWindow::on_preferences_gui_activate(GtkMenuItem *menuitem,
                                             gpointer user_data) {
...
void MainWindow::on_preferences_password() { password_edit(window_main); }

void MainWindow::on_tool_simple_text_corrections_activate(GtkMenuItem *menuitem,
                                                          gpointer user_data) {
...
void MainWindow::on_preferences_text_replacement_activate(GtkMenuItem *menuitem,
                                                          gpointer user_data) {
...
void MainWindow::on_insert_special_character() {
  ...
  RadiobuttonDialog dialog(
      _("Insert character"), _("Insert special character"), descriptions,
      settings->session.special_character_selection, false);
  if (dialog.run() != GTK_RESPONSE_OK)
    return;
...
void MainWindow::on_preferences_compare_activate(GtkMenuItem *menuitem,
                                                 gpointer user_data) {
...
void MainWindow::on_check_key_terms() {
  ...
  if (gtk_check_menu_item_get_active(GTK_CHECK_MENU_ITEM(check_key_terms))) {
    window_check_keyterms = new WindowCheckKeyterms(
        layout, accelerator_group, windows_startup_pointer != G_MAXINT);
    g_signal_connect((gpointer)window_check_keyterms->delete_signal_button,
                     "clicked",
                     G_CALLBACK(on_window_check_keyterms_delete_button_clicked),
                     gpointer(this));
    g_signal_connect((gpointer)window_check_keyterms->focus_in_signal_button,
                     "clicked", G_CALLBACK(on_window_focus_button_clicked),
                     gpointer(this));
    g_signal_connect((gpointer)window_check_keyterms->signal, "clicked",
                     G_CALLBACK(on_keyterms_signal_button_clicked),
                     gpointer(this));
  }
}

void MainWindow::on_window_check_keyterms_delete_button_clicked(
    GtkButton *button, gpointer user_data) {
...
void MainWindow::on_keyterms_signal_button_clicked(GtkButton *button,
                                                   gpointer user_data) {
...
// This is called when the keyterms checking window requests action to be taken.
{
  if (window_check_keyterms->new_reference_showing) {
    ...
    Reference reference(
        window_check_keyterms->new_reference_showing->book_get(),
    ...
    show_references_window();
    window_references->set(window_check_keyterms->references,
                           settings->genconfig.project_get(), NULL);
  }
}

void MainWindow::on_view_related_verses_activate(GtkMenuItem *menuitem,
                                                 gpointer user_data) {
...
void MainWindow::on_view_related_verses() {
  ...
  if (gtk_check_menu_item_get_active(
          GTK_CHECK_MENU_ITEM(view_related_verses))) {
    window_show_related_verses = new WindowShowRelatedVerses(
        layout, accelerator_group, windows_startup_pointer != G_MAXINT);
    g_signal_connect(
        (gpointer)window_show_related_verses->delete_signal_button, "clicked",
        G_CALLBACK(on_window_show_related_verses_delete_button_clicked),
        gpointer(this));
    g_signal_connect(
        (gpointer)window_show_related_verses->focus_in_signal_button, "clicked",
        G_CALLBACK(on_window_focus_button_clicked), gpointer(this));
    g_signal_connect(
        (gpointer)window_show_related_verses->button_item, "clicked",
        G_CALLBACK(on_window_show_related_verses_item_button_clicked),
        gpointer(this));
    window_show_related_verses->go_to(settings->genconfig.project_get(),
                                      navigation.reference);
  }
...
void MainWindow::on_window_show_related_verses_delete_button_clicked(
    GtkButton *button, gpointer user_data) {
...
void MainWindow::on_window_show_related_verses_delete_button() {
  if (window_show_related_verses) {
    ...
    window_show_related_verses = NULL;
    gtk_check_menu_item_set_active(GTK_CHECK_MENU_ITEM(view_related_verses),
                                   FALSE);
  }
}

void MainWindow::on_window_show_related_verses_item_button_clicked(
    GtkButton *button, gpointer user_data) {
...
void MainWindow::on_window_show_related_verses_item_button() {
  ...
  case ritKeytermId: {
    ...
    window_check_keyterms->go_to_term(
        convert_to_int(window_show_related_verses->item_id));
    break;
  }
  case ritStrongNumber: {
    ...
    for (unsigned int i = 0; i < parse.words.size(); i++) {
      // Get references for this strong's number, and add them to the main
      // store.
  ...
  case ritParallels: {
    ...
    show_references_window();
    window_references->set(references, settings->genconfig.project_get(),
                           &comments);
    break;
  }
  }
...
void MainWindow::on_keyterms_import() {
  ...
  g_signal_connect((gpointer)import_keyterms_assistant->signal_button,
                   "clicked", G_CALLBACK(on_assistant_ready_signal),
                   gpointer(this));
}

void MainWindow::on_keyterms_delete_activate(GtkMenuItem *menuitem,
                                             gpointer user_data) {
...
void MainWindow::on_keyterms_delete() {
  ...
  g_signal_connect((gpointer)delete_keyterms_assistant->signal_button,
                   "clicked", G_CALLBACK(on_assistant_ready_signal),
                   gpointer(this));
}
...
void MainWindow::on_file_backup_activate(GtkMenuItem *menuitem,
                                         gpointer user_data) {
...
void MainWindow::on_file_backup() {
  ...
  g_signal_connect((gpointer)backup_assistant->signal_button, "clicked",
                   G_CALLBACK(on_assistant_ready_signal), gpointer(this));
}

void MainWindow::on_file_restore_activate(GtkMenuItem *menuitem,
                                          gpointer user_data) {
...
void MainWindow::on_file_restore() {
  ...
  g_signal_connect((gpointer)restore_assistant->signal_button, "clicked",
                   G_CALLBACK(on_assistant_ready_signal), gpointer(this));
}
...
void MainWindow::on_preferences_remote_repository_activate(
    GtkMenuItem *menuitem, gpointer user_data) {
...
void MainWindow::on_preferences_remote_repository() {
  ...
  g_signal_connect((gpointer)remote_repository_assistant->signal_button,
                   "clicked", G_CALLBACK(on_assistant_ready_signal),
                   gpointer(this));
}
...
void MainWindow::on_project_changes() {
  ...
  g_signal_connect((gpointer)changes_assistant->signal_button, "clicked",
                   G_CALLBACK(on_assistant_ready_signal), gpointer(this));
}
...
void MainWindow::on_projects_send_receive1_activate(GtkMenuItem *menuitem,
                                                    gpointer user_data) {
...
void MainWindow::on_projects_send_receive() {
  ...
  // The reason for this is so that the translators can decide which one to do
  // first,
...
void MainWindow::on_text_font() {
  ...
  if (editor_window) {
    ProjectConfiguration *projectconfig =
        settings->projectconfig(editor_window->project());
  ...
  FontColorDialog dialog(defaultfont, fontname, linespacing, defaultcolour,
  ...
  settings->genconfig.text_editor_default_color_set(
      dialog.new_use_default_color);
  settings->genconfig.text_editor_normal_text_color_set(
      dialog.new_normal_text_color);
  settings->genconfig.text_editor_background_color_set(
      dialog.new_background_color);
  settings->genconfig.text_editor_selected_text_color_set(
      dialog.new_selected_text_color);
  settings->genconfig.text_editor_selection_color_set(
      dialog.new_selection_color);
  if (editor_window) {
    ProjectConfiguration *projectconfig =
        settings->projectconfig(editor_window->project());
    ...
    projectconfig->editor_selected_text_color_set(
        dialog.new_selected_text_color);
...
void MainWindow::on_view_outline_activate(GtkMenuItem *menuitem,
                                          gpointer user_data) {
...
void MainWindow::on_view_outline() {
  ...
  if (gtk_check_menu_item_get_active(GTK_CHECK_MENU_ITEM(view_outline))) {
    window_outline = new WindowOutline(layout, accelerator_group,
                                       windows_startup_pointer != G_MAXINT);
    g_signal_connect((gpointer)window_outline->delete_signal_button, "clicked",
                     G_CALLBACK(on_window_outline_delete_button_clicked),
                     gpointer(this));
    g_signal_connect((gpointer)window_outline->focus_in_signal_button,
                     "clicked", G_CALLBACK(on_window_focus_button_clicked),
                     gpointer(this));
    g_signal_connect(
        (gpointer)window_outline->outline->reference_changed_signal, "clicked",
        G_CALLBACK(on_button_outline_clicked), gpointer(this));
    window_outline->go_to(settings->genconfig.project_get(),
                          navigation.reference);
  }
}

void MainWindow::on_window_outline_delete_button_clicked(GtkButton *button,
                                                         gpointer user_data) {
...
void MainWindow::on_button_outline_clicked(GtkButton *button,
                                           gpointer user_data) {
...
void MainWindow::on_edit_planning() {
  PlanningEditDialog dialog(navigation.reference.book_get(),
                            navigation.reference.chapter_get());
  dialog.run();
}
...
void MainWindow::on_window_resource_delete_button_clicked(GtkButton *button,
                                                          gpointer user_data) {
...
// Get the focused resource window, or NULL if there's none.
{
  ...
  for (unsigned int i = 0; i < resource_windows.size(); i++) {
    if (resource_windows[i]->focus_in_signal_button ==
        focused_resource_button) {
...
// Opens a resource.
{
  ...
  WindowResource *resource_window =
      new WindowResource(resource, layout, accelerator_group, startup);
  g_signal_connect((gpointer)resource_window->delete_signal_button, "clicked",
                   G_CALLBACK(on_window_resource_delete_button_clicked),
                   gpointer(this));
  g_signal_connect((gpointer)resource_window->focus_in_signal_button, "clicked",
                   G_CALLBACK(on_window_focus_button_clicked), gpointer(this));
...
// Closes the focused resource.
{
  ...
  if (focused_window) {
    on_window_resource_delete_button(
        GTK_BUTTON(focused_window->delete_signal_button));
  }
}
...
void MainWindow::on_file_resources_new() {
  ...
  g_signal_connect((gpointer)resource_assistant->signal_button, "clicked",
                   G_CALLBACK(on_assistant_ready_signal), gpointer(this));
}
...
// Delete a resource.
{
  ...
  if (dialog.run() == GTK_RESPONSE_OK) {
    int result = gtkw_dialog_question(
        NULL,
        _("Are you sure you want to delete resource ") + dialog.focus + "?");
    if (result == GTK_RESPONSE_YES) {
      ustring filename;
      for (unsigned int i = 0; i < resources.size(); i++) {
      ...
      if (resource_add_name_to_deleted_ones_if_standard_template(filename)) {
        // 1. A template that comes with bibledit: We can't delete this as we
        // don't
...
/*
 ...
 |
 */
void MainWindow::on_view_tile_windows_activate(GtkMenuItem *menuitem,
                                               gpointer user_data) {
...
// This function tiles all open windows
{
  ...
  for (unsigned int i = 0; i < settings->session.open_floating_windows.size();
       i++) {
    FloatingWindow *floating_window =
        (FloatingWindow *)settings->session.open_floating_windows[i];
    if (floating_window->window_id != widEditor) {
      GdkRectangle rectangle = floating_window->rectangle_get();
      rectangle.width = (settings->session.open_floating_windows.size() >
                         editor_windows.size())
                            ? width * 0.333
                            : width;
      rectangle.height =
          height / (settings->session.open_floating_windows.size() -
                    editor_windows.size());
      rectangle.x = x;
      rectangle.y = y;
      y += rectangle.height;
...
#ifdef WIN32
void MainWindow::on_view_bibleworks_activate(GtkMenuItem *menuitem,
                                             gpointer user_data) {
...
// -lole32 is required for CoInitialize, CLSIDFromProgID, CoCreateInstance, and
// CoUninitialize
...
HRESULT AutoWrap(int autoType, VARIANT *pvResult, IDispatch *pDisp,
                 const LPOLESTR _ptName, int cArgs...) {
  // Begin variable-argument list...
  va_list marker;
  va_start(marker, cArgs);

  // The _ptName passed to us is often a string literal, so copy it to a local
  // string
  size_t len = wcslen(_ptName);
  LPOLESTR ptName =
      (LPOLESTR)malloc((len + 1) * sizeof(wchar_t)); // LPOLESTR = wchar_t*
  ...
  hr = pDisp->Invoke(dispID, IID_NULL, LOCALE_SYSTEM_DEFAULT, autoType, &dp,
                     pvResult, NULL, NULL);
  if (FAILED(hr)) {
    sprintf(buf, "IDispatch::Invoke(\"%s\"=%08lx) failed w/err 0x%08lx", szName,
            dispID, hr);
    MessageBox(NULL, buf, "AutoWrap()", 0x10010);
    return hr;
  }
...
void MainWindow::on_view_bibleworks(void) {
  ...
  ustring searchstring = book + " " +
                         std::to_string(current_reference.chapter_get()) + ":" +
                         current_reference.verse_get();
  DEBUG("Sending to Bibleworks via OLE: ->" + searchstring + "<- of " +
        std::to_string(searchstring.bytes()) + " bytes");
  ...
  // Go to verse
  {
    VARIANT parm;
    parm.vt = VT_BSTR;
    // The searchstring needs to be converted to wchar_t, a wide character
    // string (16-bit elements?)
    std::wstring wide_string(searchstring.begin(), searchstring.end());
    parm.bstrVal = ::SysAllocString(
        wide_string.c_str()); // this allocates memory, which is freed below

    VARIANT result;
    VariantInit(&result);
    AutoWrap(DISPATCH_METHOD, &result, pBwApp, (wchar_t *)L"GoToVerse", 1,
             parm);
    VariantClear(
        &parm); // this will free the memory associated with parm.bstrVal string
  }
...
void MainWindow::on_view_biblegateway_activate(GtkMenuItem *menuitem,
                                               gpointer user_data) {
...
void MainWindow::on_view_blueletterbible_activate(GtkMenuItem *menuitem,
                                                  gpointer user_data) {
...
void MainWindow::on_view_biblestudytools_activate(GtkMenuItem *menuitem,
                                                  gpointer user_data) {
...
void MainWindow::on_view_bibleorg_activate(GtkMenuItem *menuitem,
                                           gpointer user_data) {
...
void MainWindow::on_window_editor_delete_button_clicked(GtkButton *button,
                                                        gpointer user_data) {
...
// Opens an editor.
{
  ...
  WindowEditor *editor_window =
      new WindowEditor(project, layout, accelerator_group, startup);
  g_signal_connect((gpointer)editor_window->delete_signal_button, "clicked",
                   G_CALLBACK(on_window_editor_delete_button_clicked),
                   gpointer(this));
  g_signal_connect((gpointer)editor_window->focus_in_signal_button, "clicked",
                   G_CALLBACK(on_window_focus_button_clicked), gpointer(this));
  g_signal_connect((gpointer)editor_window->new_verse_signal, "clicked",
                   G_CALLBACK(on_new_verse_signalled), gpointer(this));
  g_signal_connect((gpointer)editor_window->new_styles_signal, "clicked",
                   G_CALLBACK(on_editor_style_changed), gpointer(this));
  g_signal_connect((gpointer)editor_window->quick_references_button, "clicked",
                   G_CALLBACK(on_show_quick_references_signal_button_clicked),
                   gpointer(this));
  g_signal_connect((gpointer)editor_window->word_double_clicked_signal,
                   "clicked", G_CALLBACK(on_send_word_to_toolbox_signalled),
                   gpointer(this));
  g_signal_connect((gpointer)editor_window->reload_signal, "clicked",
                   G_CALLBACK(on_editor_reload_clicked), gpointer(this));
  g_signal_connect((gpointer)editor_window->changed_signal, "clicked",
                   G_CALLBACK(on_editor_changed_clicked), gpointer(this));
  g_signal_connect((gpointer)editor_window->spelling_checked_signal, "clicked",
                   G_CALLBACK(on_editor_spelling_checked_button_clicked),
                   gpointer(this));
...
void MainWindow::on_editor_reload_clicked(GtkButton *button,
                                          gpointer user_data) {
  ((MainWindow *)user_data)->reload_all_editors(true);
}

void MainWindow::debug_view(ustring txt, GtkRadioMenuItem *menuitem,
                            viewType vt) {
  ustring menu = "none";
  ...
  bool formatted =
      gtk_check_menu_item_get_active(GTK_CHECK_MENU_ITEM(view_formatted));
  bool usfm =
      gtk_check_menu_item_get_active(GTK_CHECK_MENU_ITEM(view_usfm_code));
  bool experi =
      gtk_check_menu_item_get_active(GTK_CHECK_MENU_ITEM(view_experimental));
  ...
  case vtFormatted:
    if (!formatted) {
      DEBUG("vtFormatted but view_formatted not active!!")
    }
    break;
  case vtUSFM:
    if (!usfm) {
      DEBUG("vtUSFM but view_usfm_code not active!!")
    }
    break;
  case vtExperimental:
    if (!experi) {
      DEBUG("vtExperimental but view_experimental not active!!")
    }
    break;
  }
}
...
void MainWindow::handle_editor_focus() {
  ...
  // g_signal_handlers_block_by_func(view_formatted,
  // G_CALLBACK(on_view_chapteras_activate), gpointer(this));
  // g_signal_handlers_block_by_func(view_usfm_code,
  // G_CALLBACK(on_view_chapteras_activate), gpointer(this));
  // g_signal_handlers_block_by_func(view_experimental,
  // G_CALLBACK(on_view_chapteras_activate), gpointer(this));
  switch (vt) {
  ...
  case vtUSFM:
    ...
    break;
  case vtExperimental:
    gtk_check_menu_item_set_active(GTK_CHECK_MENU_ITEM(view_experimental),
                                   TRUE);
    break;
  }
  // Turn signals back on for this submenu
  // g_signal_handlers_unblock_by_func(view_formatted,
  // G_CALLBACK(on_view_chapteras_activate), gpointer(this));
  // g_signal_handlers_unblock_by_func(view_usfm_code,
  // G_CALLBACK(on_view_chapteras_activate), gpointer(this));
  // g_signal_handlers_unblock_by_func(view_experimental,
  // G_CALLBACK(on_view_chapteras_activate), gpointer(this));
  ...
  settings->genconfig.text_editor_font_default_set(
      projectconfig->editor_font_default_get());
  settings->genconfig.text_editor_font_name_set(
      projectconfig->editor_font_name_get());
  settings->genconfig.text_editor_default_color_set(
      projectconfig->editor_default_color_get());
  settings->genconfig.text_editor_normal_text_color_set(
...
void MainWindow::on_editor_changed_clicked(GtkButton *button,
                                           gpointer user_data) {
...
void MainWindow::on_view_formatted_toggled(GtkMenuItem *menuitem,
                                           gpointer user_data) {
...
void MainWindow::on_view_usfm_code_toggled(GtkMenuItem *menuitem,
                                           gpointer user_data) {
...
void MainWindow::on_view_experimental_toggled(GtkMenuItem *menuitem,
                                              gpointer user_data) {
...
void MainWindow::on_view_chapteras_activate(GtkRadioMenuItem *menuitem,
                                            gpointer user_data) {
...
void MainWindow::on_view_chapteras(GtkRadioMenuItem *menuitem) {
  ...
  // called twice: once for the view that is on, to indicate it is "activated"
  // off,
  // and once for the new view to be turned on.

  bool radioButtonIsOn =
...
void MainWindow::reload_all_editors(bool take_chapter_from_focused_editor) {
  ...
  // As anything could have happened to the data in the project, force a reload
  // of the navigator.
...
void MainWindow::on_file_projects_merge() {
  ...
  if (gtk_check_menu_item_get_active(
          GTK_CHECK_MENU_ITEM(file_projects_merge))) {
    window_merge = new WindowMerge(layout, accelerator_group,
                                   windows_startup_pointer != G_MAXINT);
    g_signal_connect((gpointer)window_merge->delete_signal_button, "clicked",
                     G_CALLBACK(on_window_merge_delete_button_clicked),
                     gpointer(this));
    g_signal_connect((gpointer)window_merge->focus_in_signal_button, "clicked",
                     G_CALLBACK(on_window_focus_button_clicked),
                     gpointer(this));
    g_signal_connect((gpointer)window_merge->editors_get_text_button, "clicked",
                     G_CALLBACK(on_merge_window_get_text_button_clicked),
                     gpointer(this));
    g_signal_connect((gpointer)window_merge->new_reference_button, "clicked",
                     G_CALLBACK(on_merge_window_new_reference_button_clicked),
                     gpointer(this));
    g_signal_connect((gpointer)window_merge->save_editors_button, "clicked",
                     G_CALLBACK(on_merge_window_save_editors_button_clicked),
                     gpointer(this));
    g_signal_connect((gpointer)window_merge->reload_editors_button, "clicked",
                     G_CALLBACK(on_editor_reload_clicked), gpointer(this));
    vector<ustring> open_projects;
    for (unsigned int i = 0; i < editor_windows.size(); i++) {
      open_projects.push_back(editor_windows[i]->project());
...
void MainWindow::on_window_merge_delete_button_clicked(GtkButton *button,
                                                       gpointer user_data) {
...
void MainWindow::on_window_merge_delete_button() {
  if (window_merge) {
    delete window_merge;
    window_merge = NULL;
    gtk_check_menu_item_set_active(GTK_CHECK_MENU_ITEM(file_projects_merge),
                                   FALSE);
  }
}

void MainWindow::on_merge_window_get_text_button_clicked(GtkButton *button,
                                                         gpointer user_data) {
...
void MainWindow::on_merge_window_new_reference_button_clicked(
    GtkButton *button, gpointer user_data) {
...
void MainWindow::on_merge_window_save_editors_button_clicked(
    GtkButton *button, gpointer user_data) {
  ((MainWindow *)user_data)->on_merge_window_save_editors_button();
}

void MainWindow::on_merge_window_save_editors_button() { save_editors(); }
...
void MainWindow::on_print() {
  ...
  unsigned int selection;
  {
    ...
    RadiobuttonDialog dialog(_("Print"), _("Select what to print"), labels,
                             settings->genconfig.print_job_get(), false);
    if (dialog.run() != GTK_RESPONSE_OK) {
      return;
    }
  ...
  case 3: // References.
  {
    ...
    if (refs.empty()) {
      ...
      ProjectMemory projectmemory(settings->genconfig.project_get(), true);
      view_parallel_references_pdf(projectmemory, &extra_projects, refs, true,
                                   NULL, true);
    }
    break;
  }
...
void MainWindow::accelerator_next_reference_in_history_callback(
    gpointer user_data) {
...
void MainWindow::accelerator_previous_reference_in_history_callback(
    gpointer user_data) {
...
// Closes the focused window.
{
  ...
  for (unsigned int i = 0; i < resource_windows.size(); i++) {
    ...
    if (resource_window->focused) {
      on_window_resource_delete_button(
          GTK_BUTTON(resource_window->delete_signal_button));
      break;
    }
  }
  // Outline.
  ...
  for (unsigned int i = 0; i < editor_windows.size(); i++) {
    ...
    if (editor_window->focused) {
      on_window_editor_delete_button(
          GTK_BUTTON(editor_window->delete_signal_button));
      break;
    }
  }
  handle_editor_focus();
...
void MainWindow::accelerator_next_reference_in_reference_area_callback(
    gpointer user_data) {
  ((MainWindow *)user_data)->on_next_reference();
}

void MainWindow::accelerator_previous_reference_in_reference_area_callback(
    gpointer user_data) {
...
bool MainWindow::on_window_delete_event(GtkWidget *widget, GdkEvent *event,
                                        gpointer user_data) {
  ((MainWindow *)user_data)->initiate_shutdown();
...
void MainWindow::on_assistant_ready_signal(GtkButton *button,
                                           gpointer user_data) {
...
// This handles the situation that any assistant is ready.
{
  ...
  if (resource_assistant) {
    ...
    if (!new_resource.empty()) {
      ...
      WindowResource *focused_resource_window = last_focused_resource_window();
      if (focused_resource_window) {
        focused_resource_window->resource->open(
            resource_assistant->edited_resource_get());
      }
    }
...
void MainWindow::on_check_usfm_activate(GtkMenuItem *menuitem,
                                        gpointer user_data) {
...
void MainWindow::on_check_usfm() {
  ...
  if (gtk_check_menu_item_get_active(GTK_CHECK_MENU_ITEM(check_usfm))) {
    window_check_usfm = new WindowCheckUSFM(
        layout, accelerator_group, windows_startup_pointer != G_MAXINT);
    g_signal_connect(
        (gpointer)window_check_usfm->delete_signal_button, "clicked",
        G_CALLBACK(on_window_check_usfm_delete_button_clicked), gpointer(this));
    g_signal_connect((gpointer)window_check_usfm->focus_in_signal_button,
                     "clicked", G_CALLBACK(on_window_focus_button_clicked),
                     gpointer(this));
    handle_editor_focus();
    on_editor_changed();
...
void MainWindow::on_window_check_usfm_delete_button_clicked(
    GtkButton *button, gpointer user_data) {
...
void MainWindow::on_file_import_activate(GtkMenuItem *menuitem,
                                         gpointer user_data) {
...
void MainWindow::on_file_import() {
  ...
  import_assistant = new ImportAssistant(references_window, styles_window,
                                         window_check_keyterms, windowsoutpost);
  g_signal_connect((gpointer)import_assistant->signal_button, "clicked",
                   G_CALLBACK(on_assistant_ready_signal), gpointer(this));
}
...
void MainWindow::on_scrolledwindow_layout_size_allocate(
    GtkWidget *widget, GdkRectangle *allocation, gpointer user_data) {
...
// The size of the parent scrolled window determines the size of the layout.
{
  ...
  if ((allocation->width != (gint)(width + 3)) ||
      (allocation->height != (gint)(height + 3))) {
    // Set new size.
...
bool MainWindow::on_windows_startup() {
  ...
  while ((windows_startup_pointer < window_data.ids.size()) &&
         !window_started) {
    if (window_data.shows[windows_startup_pointer]) {
      ...
      case widCheckKeyterms: {
        gtk_check_menu_item_set_active(GTK_CHECK_MENU_ITEM(check_key_terms),
                                       TRUE);
        break;
      }
      case widStyles: {
      ...
      case widShowVerses: {
        // The window was removed. Xiphos and similar programs provide this
      ...
      case widSourceLanguages: {
        // The window was removed since the external applications provide source
        // text and do it much better than Bibledit.
        break;
      }
      case widTabbed: {
        // What kind of tabbed window? Bible text, or informational? Which tabs
        // were opened?
      }
      }
      window_started = true;
  ...
  // At the end of all focus the right editor, the one that had focus last time
  // on shutdown.
...
void MainWindow::on_window_focus_button_clicked(GtkButton *button,
                                                gpointer user_data) {
...
// Called when a window gets focused.
{
  ...
  if (window_show_related_verses)
    window_show_related_verses->focus_set(
        window_show_related_verses->focus_in_signal_button == widget);
  if (window_merge)
    window_merge->focus_set(window_merge->focus_in_signal_button == widget);
  for (unsigned int i = 0; i < resource_windows.size(); i++)
    resource_windows[i]->focus_set(
        resource_windows[i]->focus_in_signal_button == widget);
  if (window_outline)
    window_outline->focus_set(window_outline->focus_in_signal_button == widget);
  if (window_check_keyterms)
    window_check_keyterms->focus_set(
        window_check_keyterms->focus_in_signal_button == widget);
  if (window_styles)
  ...
  if (window_references)
    window_references->focus_set(window_references->focus_in_signal_button ==
                                 widget);
  if (window_info) {
    window_info->focus_set(window_info->focus_in_signal_button == widget);
  }
  for (unsigned int i = 0; i < editor_windows.size(); i++) {
    editor_windows[i]->focus_set(editor_windows[i]->focus_in_signal_button ==
                                 widget);
  }
  if (window_check_usfm)
    window_check_usfm->focus_set(window_check_usfm->focus_in_signal_button ==
                                 widget);
}
...
bool MainWindow::on_interprocess_communications_initiate_listener_timeout(
    gpointer data) {
...
void MainWindow::interprocess_communications_initiate_listener() {
  ...
  url.append(convert_to_string(
      interprocess_communications_initiate_listener_message_id));
  GtkWidget *button;
  button = urltransport->send_message_expect_reply(url);
  g_signal_connect(
      (gpointer)button, "clicked",
      G_CALLBACK(on_interprocess_communications_listener_button_clicked),
      gpointer(this));
}

void MainWindow::on_interprocess_communications_listener_button_clicked(
    GtkButton *button, gpointer user_data) {
  ((MainWindow *)user_data)
      ->on_interprocess_communications_listener_button(button);
}

void MainWindow::on_interprocess_communications_listener_button(
    GtkButton *button) {
  ...
  if (urltransport->reply_is_ok) {
    ...
    if (!parseline.lines.empty()) {
      interprocess_communications_initiate_listener_message_id =
          convert_to_int(parseline.lines[0]);
      if (parseline.lines.size() > 2) {
        ...
        if (subject == "focus") {
          ...
          if (parse.words.size() >= 3) {
            Reference received_reference(convert_to_int(parse.words[0]),
                                         convert_to_int(parse.words[1]),
                                         parse.words[2]);
  ...
  // If there was an error, it waits a bit longer before restarting the
  // listener.
  ...
  interprocess_communications_initiate_listener_event_id = g_timeout_add_full(
      G_PRIORITY_DEFAULT, milliseconds,
      GSourceFunc(on_interprocess_communications_initiate_listener_timeout),
      gpointer(this), NULL);
}
