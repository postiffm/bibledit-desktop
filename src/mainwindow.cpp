...
MainWindow::MainWindow(unsigned long xembed, GtkAccelGroup *accelerator_group) : navigation(0), httpd(0) {
  ...
  GTK_ADJUSTMENT(GTK_LAYOUT(layout)->hadjustment)
      ->step_increment = 10;
  GTK_ADJUSTMENT(GTK_LAYOUT(layout)->vadjustment)
      ->step_increment = 10;
