...
private:
  ...
  void on_ok();
  void on_cancel();
  static void projectdialog_on_nameentry_changed(GtkEditable *editable,
                                                 gpointer user_data);
  static void projectdialog_on_okbutton1_clicked(GtkButton *button,
                                                 gpointer user_data);
  static void projectdialog_on_addbutton_clicked(GtkButton *button,
                                                 gpointer user_data);
  static void projectdialog_on_deletebutton_clicked(GtkButton *button,
                                                    gpointer user_data);
  static void projectdialog_on_cancelbutton1_clicked(GtkButton *button,
                                                     gpointer user_data);
  static void on_checkbutton_editable_toggled(GtkToggleButton *togglebutton,
                                              gpointer user_data);
  static void on_checkbutton_dependent_toggled(GtkToggleButton *togglebutton,
                                               gpointer user_data);
  ...
  static void on_button_dictionaries_clicked(GtkButton *button,
                                             gpointer user_data);
  void on_button_dictionaries();
  static void on_checkbutton_spelling_toggled(GtkToggleButton *togglebutton,
                                              gpointer user_data);
};
