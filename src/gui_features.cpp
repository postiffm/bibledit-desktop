...
GuiFeatures::GuiFeatures(int dummy) {
  ...
  // The order of this pattern handling should agree to the order used in the
  // features dialog source.
...
bool GuiFeatures::printing() { return !b_basics && (b_full || b_printing); }
...
bool GuiFeatures::styles() { return !b_basics && (b_full || b_styles); }
...
bool GuiFeatures::replace() { return !b_basics && (b_full || b_replace); }

bool GuiFeatures::checks() { return !b_basics && (b_full || b_checks); }

bool GuiFeatures::tools() { return !b_basics && (b_full || b_tools); }
