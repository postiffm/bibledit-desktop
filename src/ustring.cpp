...
//
inline ustring::size_type utf8_byte_offset(const std::string &str, ustring::size_type offset) {
...
ustring::size_type utf8_find_first_of(const std::string &str, ustring::size_type offset,
  ...
  const GlibScopedPtr<gunichar> ucs4_match(g_utf8_to_ucs4_fast(utf8_match, utf8_match_size, &ucs4_match_size));
...
ustring::SequenceToString<ustring::iterator, gunichar>::SequenceToString(ustring::iterator pbegin, ustring::iterator pend)
    : std::string(pbegin.base(), pend.base()) {}

ustring::SequenceToString<ustring::const_iterator, gunichar>::SequenceToString(ustring::const_iterator pbegin, ustring::const_iterator pend)
    : std::string(pbegin.base(), pend.base()) {}
