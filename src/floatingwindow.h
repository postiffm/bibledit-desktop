...
public:
  FloatingWindow(GtkWidget *layout_in, WindowID window_id_in, ustring title_in,
                 bool startup);
...
private:
  ...
  static gboolean on_title_bar_button_press_event(GtkWidget *widget,
                                                  GdkEventButton *event,
                                                  gpointer user_data);
  gboolean on_title_bar_button_press(GdkEventButton *event);
  static gboolean on_title_bar_button_release_event(GtkWidget *widget,
                                                    GdkEventButton *event,
                                                    gpointer user_data);
  gboolean on_title_bar_button_release(GdkEventButton *event);
  static gboolean on_title_bar_motion_notify_event(GtkWidget *widget,
                                                   GdkEventMotion *event,
                                                   gpointer user_data);
  gboolean on_title_bar_motion_notify(GdkEventMotion *event);
  bool dragging_window;
  static gboolean on_status_bar_button_press_event(GtkWidget *widget,
                                                   GdkEventButton *event,
                                                   gpointer user_data);
  gboolean on_status_bar_button_press(GdkEventButton *event);
  static gboolean on_status_bar_button_release_event(GtkWidget *widget,
                                                     GdkEventButton *event,
                                                     gpointer user_data);
  gboolean on_status_bar_button_release(GdkEventButton *event);
  static gboolean on_status_bar_motion_notify_event(GtkWidget *widget,
                                                    GdkEventMotion *event,
                                                    gpointer user_data);
  ...
  // Cursor control.
  static gboolean on_titlebar_enter_notify_event(GtkWidget *widget,
                                                 GdkEventCrossing *event,
                                                 gpointer user_data);
  gboolean on_titlebar_enter_notify(GdkEventCrossing *event);
  static gboolean on_titlebar_leave_notify_event(GtkWidget *widget,
                                                 GdkEventCrossing *event,
                                                 gpointer user_data);
  gboolean on_titlebar_leave_notify(GdkEventCrossing *event);
  static gboolean on_statusbar_enter_notify_event(GtkWidget *widget,
                                                  GdkEventCrossing *event,
                                                  gpointer user_data);
  gboolean on_statusbar_enter_notify(GdkEventCrossing *event);
  static gboolean on_statusbar_leave_notify_event(GtkWidget *widget,
                                                  GdkEventCrossing *event,
                                                  gpointer user_data);
  gboolean on_statusbar_leave_notify(GdkEventCrossing *event);
  static gboolean on_label_close_enter_notify_event(GtkWidget *widget,
                                                    GdkEventCrossing *event,
                                                    gpointer user_data);
  gboolean on_label_close_enter_notify(GdkEventCrossing *event);
  static gboolean on_label_close_leave_notify_event(GtkWidget *widget,
                                                    GdkEventCrossing *event,
                                                    gpointer user_data);
  gboolean on_label_close_leave_notify(GdkEventCrossing *event);

  // Close link.
  static gboolean on_label_close_button_press_event(GtkWidget *widget,
                                                    GdkEventButton *event,
                                                    gpointer user_data);
