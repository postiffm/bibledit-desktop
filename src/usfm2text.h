...
public:
  ...
  void set_margins(double top_cm, double bottom_cm, double inner_cm,
                   double outer_cm);
  ...
  void add_print_portion(unsigned int book_in,
...
private:
  ...
  void output_text_starting_new_paragraph(ustring &line,
  ...
  void output_text_character_style(ustring &line, Usfm2XslFoStyle *stylepointer,
                                   Usfm2XslFoStyle *&fo_block_style,
                                   Usfm2XslFoStyle *&fo_inline_style,
                                   size_t marker_length, bool is_opener);
  void output_elastic(ustring &line, Usfm2XslFoStyle *&fo_block_style,
                      Usfm2XslFoStyle *&fo_inline_style, size_t marker_length);
  void output_spacing_paragraph(ustring &line, Usfm2XslFoStyle *&fo_block_style,
                                Usfm2XslFoStyle *&fo_inline_style,
                                size_t marker_length, bool is_opener);
  void output_keep_on_page(ustring &line, Usfm2XslFoStyle *&fo_block_style,
                           Usfm2XslFoStyle *&fo_inline_style,
                           size_t marker_length, bool is_opener);
  void output_font_family_size_line_height(ustring &line,
                                           Usfm2XslFoStyle *&fo_block_style,
                                           Usfm2XslFoStyle *&fo_inline_style,
                                           size_t marker_length,
                                           bool is_opener);
  ...
  void output_chapter_number_try_normal(ustring &line,
                                        Usfm2XslFoStyle *stylepointer,
                                        Usfm2XslFoStyle *&fo_block_style,
                                        Usfm2XslFoStyle *&fo_inline_style,
                                        size_t marker_length,
  ...
  void
  output_chapter_number_try_at_first_verse(ustring line,
                                           Usfm2XslFoStyle *&fo_block_style);
  map<unsigned int, unsigned int> highest_chapter_number;
  void output_running_header(ustring &line, Usfm2XslFoStyle *stylepointer,
  ...
  // Table processing.
  void output_text_table(ustring &line, Usfm2XslFoStyle *&fo_block_style,
                         Usfm2XslFoStyle *&fo_inline_style,
                         size_t marker_length);
  ...
  void output_text_note(ustring &line, Usfm2XslFoStyle *stylepointer,
                        Usfm2XslFoStyle *&fo_block_style, size_t marker_length,
                        bool is_opener);
  Usfm2XslFoStyle *
  get_default_paragraph_style_for_note(Usfm2XslFoStyle *notestyle);
  void note_callers_new_book();
  void note_callers_new_chapter();
  void buffer_endnote(ustring &line, Usfm2XslFoStyle *stylepointer,
                      size_t marker_length, bool is_opener);
  vector<ustring> buffered_endnote_texts;
  vector<Usfm2XslFoStyle *> buffered_endnote_styles;
  EndnotePositionType endnote_position;
  void dump_endnotes(Usfm2XslFoStyle *&fo_block_style,
                     Usfm2XslFoStyle *&fo_inline_style);
  bool include_full_references_with_notes;
  void optionally_add_full_references(ustring &line,
                                      Usfm2XslFoStyle *stylepointer);
  ...
  void output_id_page_break(Usfm2XslFoStyle *stylepointer,
                            Usfm2XslFoStyle *&fo_block_style,
                            Usfm2XslFoStyle *&fo_inline_style);
  void output_other_page_break(ustring &line, Usfm2XslFoStyle *stylepointer,
                               Usfm2XslFoStyle *&fo_block_style,
                               Usfm2XslFoStyle *&fo_inline_style,
                               size_t marker_length);
  void output_page_break(Usfm2XslFoStyle *&fo_block_style,
                         Usfm2XslFoStyle *&fo_inline_style, bool oddpage);
  bool do_not_allow_new_page;

  // Pictures.
  void output_picture(ustring &line, Usfm2XslFoStyle *stylepointer,
                      Usfm2XslFoStyle *&fo_block_style,
                      Usfm2XslFoStyle *&fo_inline_style, size_t marker_length);
  ...
  void toc_collect_text(ustring &line, size_t marker_length, bool longtext,
                        unsigned int book);
  void toc_insert_referent(ustring &line, Usfm2XslFoStyle *&fo_block_style,
                           Usfm2XslFoStyle *&fo_inline_style,
                           size_t marker_length);
  void toc_insert_body(ustring &line, Usfm2XslFoStyle *&fo_block_style,
                       Usfm2XslFoStyle *&fo_inline_style, size_t marker_length);

  // Verse processing.
  bool output_verse_number(Usfm2XslFoStyle *stylepointer,
                           Usfm2XslFoStyle *&fo_block_style,
                           Usfm2XslFoStyle *&fo_inline_style,
                           size_t marker_length);
