...
private:
  ...
  static void on_assistant_cancel_signal(GtkAssistant *assistant,
                                         gpointer user_data);
  static void on_assistant_close_signal(GtkAssistant *assistant,
                                        gpointer user_data);
  static bool on_assistant_delete_event(GtkWidget *widget, GdkEvent *event,
                                        gpointer user_data);
