...
private:
  static void on_comboboxbook_changed(GtkComboBox *combobox,
                                      gpointer user_data);
  void on_book_changed();
  static void on_comboboxchapter_changed(GtkComboBox *combobox,
                                         gpointer user_data);
  void on_chapter_changed();
  static void on_treeviewrevisions_row_activated(GtkTreeView *treeview,
                                                 GtkTreePath *path,
  ...
  vector<unsigned int>
      seconds; // Stores the seconds of the dates now loaded in the dialog.
  bool revisionloaded;
  unsigned int branch;
