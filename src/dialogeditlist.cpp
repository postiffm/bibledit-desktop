...
EditListDialog::EditListDialog(vector<ustring> *lines, const ustring &title,
                               const ustring &info, bool remove, bool add,
                               bool sort, bool import, bool exprt,
                               bool duplicates, bool reorderable,
  ...
  gtk_window_set_position(GTK_WINDOW(editlistdialog),
  ...
  if (remove) {
    ...
    gtk_table_attach(GTK_TABLE(table1), buttonremove, buttonpointer,
                     buttonpointer + 1, 0, 1, (GtkAttachOptions)(GTK_FILL),
  ...
  if (add) {
    ...
    gtk_table_attach(GTK_TABLE(table1), button_add, buttonpointer,
                     buttonpointer + 1, 0, 1, (GtkAttachOptions)(GTK_FILL),
                     (GtkAttachOptions)(0), 0, 0);
    // Position of next button.
    buttonpointer++;
  ...
  if (sort) {
    ...
    gtk_table_attach(GTK_TABLE(table1), button_sort, buttonpointer,
                     buttonpointer + 1, 0, 1, (GtkAttachOptions)(GTK_FILL),
                     (GtkAttachOptions)(0), 0, 0);
    ...
    image1 =
        gtk_image_new_from_stock("gtk-sort-ascending", GTK_ICON_SIZE_BUTTON);
  ...
  if (import) {
    ...
    gtk_table_attach(GTK_TABLE(table1), button_import, buttonpointer,
                     buttonpointer + 1, 0, 1, (GtkAttachOptions)(GTK_FILL),
                     (GtkAttachOptions)(0), 0, 0);
  ...
  if (exprt) {
    ...
    gtk_table_attach(GTK_TABLE(table1), button_export, buttonpointer,
                     buttonpointer + 1, 0, 1, (GtkAttachOptions)(GTK_FILL),
                     (GtkAttachOptions)(0), 0, 0);
  ...
  if (duplicates) {
    ...
    gtk_table_attach(GTK_TABLE(table1), button_doubles, buttonpointer,
                     buttonpointer + 1, 0, 1, (GtkAttachOptions)(GTK_FILL),
                     (GtkAttachOptions)(0), 0, 0);
  ...
  gtk_dialog_add_action_widget(GTK_DIALOG(editlistdialog), cancelbutton,
                               GTK_RESPONSE_CANCEL);
  gtk_widget_set_can_default(GTK_WIDGET(cancelbutton), true);

  okbutton = gtk_button_new_from_stock("gtk-ok");
  gtk_widget_show(okbutton);
  gtk_dialog_add_action_widget(GTK_DIALOG(editlistdialog), okbutton,
                               GTK_RESPONSE_OK);
  gtk_widget_set_can_default(GTK_WIDGET(okbutton), true);

  g_signal_connect_after((gpointer)treeview1, "cursor_changed",
  ...
  g_signal_connect_after((gpointer)treeview1, "select_all",
                         G_CALLBACK(on_treeview1_select_all), gpointer(this));
  g_signal_connect_after((gpointer)treeview1, "select_cursor_parent",
                         G_CALLBACK(on_treeview1_select_cursor_parent),
                         gpointer(this));
  g_signal_connect_after((gpointer)treeview1, "select_cursor_row",
                         G_CALLBACK(on_treeview1_select_cursor_row),
                         gpointer(this));
  g_signal_connect_after((gpointer)treeview1, "toggle_cursor_row",
                         G_CALLBACK(on_treeview1_toggle_cursor_row),
                         gpointer(this));
  g_signal_connect_after((gpointer)treeview1, "unselect_all",
                         G_CALLBACK(on_treeview1_unselect_all), gpointer(this));
  if (remove)
    g_signal_connect((gpointer)buttonremove, "clicked",
                     G_CALLBACK(on_removebutton_clicked), gpointer(this));
  if (add)
  ...
  if (import)
    g_signal_connect((gpointer)button_import, "clicked",
                     G_CALLBACK(on_button_import_clicked), gpointer(this));
  if (exprt)
    g_signal_connect((gpointer)button_export, "clicked",
                     G_CALLBACK(on_button_export_clicked), gpointer(this));
  if (duplicates)
    g_signal_connect((gpointer)button_doubles, "clicked",
                     G_CALLBACK(on_button_doubles_clicked), gpointer(this));
...
EditListDialog::~EditListDialog() { gtk_widget_destroy(editlistdialog); }

int EditListDialog::run() { return gtk_dialog_run(GTK_DIALOG(editlistdialog)); }

void EditListDialog::on_okbutton_clicked(GtkButton *button,
                                         gpointer user_data) {
...
void EditListDialog::on_removebutton_clicked(GtkButton *button,
                                             gpointer user_data) {
...
void EditListDialog::on_remove() {
  ...
  gtk_tree_selection_selected_foreach(select, EditListDialog::on_collect_iters,
                                      gpointer(&iters));
...
void EditListDialog::on_collect_iters(GtkTreeModel *model, GtkTreePath *path,
                                      GtkTreeIter *iter, gpointer data) {
  ((vector<GtkTreeIter> *)data)->push_back(*iter);
}

void EditListDialog::on_button_add_clicked(GtkButton *button,
                                           gpointer user_data) {
...
void EditListDialog::on_button_sort_clicked(GtkButton *button,
                                            gpointer user_data) {
...
void EditListDialog::on_button_import_clicked(GtkButton *button,
                                              gpointer user_data) {
...
void EditListDialog::on_button_export_clicked(GtkButton *button,
                                              gpointer user_data) {
...
void EditListDialog::on_button_doubles_clicked(GtkButton *button,
                                               gpointer user_data) {
...
void EditListDialog::on_duplicates() {
  ...
  if (duplicates_removed == 0) {
    ...
    if (gtkw_dialog_question(editlistdialog,
                             _("Do you want to remove ") +
                                 convert_to_string(duplicates_removed) +
                                 _(" duplicates?"),
...
void EditListDialog::on_treeview1_cursor_changed(GtkTreeView *treeview,
                                                 gpointer user_data) {
...
void EditListDialog::on_cursor() {
  if (buttonremove) {
    ...
    gtk_tree_selection_selected_foreach(
        select, EditListDialog::on_collect_iters, gpointer(&iters));
    gtk_widget_set_sensitive(buttonremove, iters.size() > 0);
  }
}

gboolean EditListDialog::on_treeview1_move_cursor(GtkTreeView *treeview,
...
gboolean EditListDialog::on_treeview1_select_all(GtkTreeView *treeview,
                                                 gpointer user_data) {
  ((EditListDialog *)user_data)->on_cursor();
  return FALSE;
}
...
gboolean
EditListDialog::on_treeview1_select_cursor_parent(GtkTreeView *treeview,
                                                  gpointer user_data) {
  return FALSE;
}

gboolean EditListDialog::on_treeview1_select_cursor_row(GtkTreeView *treeview,
                                                        gboolean start_editing,
                                                        gpointer user_data) {
  return FALSE;
}

gboolean EditListDialog::on_treeview1_toggle_cursor_row(GtkTreeView *treeview,
                                                        gpointer user_data) {
  return FALSE;
}

gboolean EditListDialog::on_treeview1_unselect_all(GtkTreeView *treeview,
                                                   gpointer user_data) {
  ((EditListDialog *)user_data)->on_cursor();
  return FALSE;
}
