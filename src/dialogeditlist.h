...
public:
  EditListDialog(vector<ustring> *lines, const ustring &title,
                 const ustring &info, bool remove, bool add, bool sort,
                 bool import, bool exprt, bool duplicates, bool reorderable,
...
private:
  ...
  void on_remove();
  static void on_collect_iters(GtkTreeModel *model, GtkTreePath *path,
  ...
  static gboolean on_treeview1_move_cursor(GtkTreeView *treeview,
                                           ...
                                           gpointer user_data);
  static gboolean on_treeview1_select_all(GtkTreeView *treeview,
                                          gpointer user_data);
  static gboolean on_treeview1_select_cursor_parent(GtkTreeView *treeview,
                                                    gpointer user_data);
  static gboolean on_treeview1_select_cursor_row(GtkTreeView *treeview,
                                                 gboolean start_editing,
                                                 gpointer user_data);
  static gboolean on_treeview1_toggle_cursor_row(GtkTreeView *treeview,
                                                 gpointer user_data);
  static gboolean on_treeview1_unselect_all(GtkTreeView *treeview,
                                            gpointer user_data);
