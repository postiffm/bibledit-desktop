...
public:
  WindowCheckUSFM(GtkWidget *parent_layout, GtkAccelGroup *accelerator_group,
                  bool startup);
  virtual ~WindowCheckUSFM();
  void set_parameters(GtkTextBuffer *buffer, const ustring &project_in,
                      unsigned int book_in, unsigned int chapter_in);
...
private:
  ...
  static void on_button_discover_markup_clicked(GtkButton *button,
                                                gpointer user_data);
