...
WindowShowRelatedVerses::WindowShowRelatedVerses(GtkWidget *parent_layout, GtkAccelGroup *accelerator_group, bool startup) : FloatingWindow(parent_layout, widShowRelatedVerses, "Related verses", startup), myreference(0)
