...
public:
  WindowMerge(GtkWidget *parent_layout, GtkAccelGroup *accelerator_group,
              bool startup);
  virtual ~WindowMerge();
...
private:
  ...
  static void on_combobox_master_changed(GtkComboBox *combobox,
                                         gpointer user_data);
...
private:
  ...
  static void on_combobox_edited_changed(GtkComboBox *combobox,
                                         gpointer user_data);
...
private:
  ...
  bool cross_book_boundaries(bool next, unsigned int &cross_book,
...
private:
  ...
  void copy_master_to_edited_chapter(unsigned int bk, unsigned int ch,
                                     bool gui);
