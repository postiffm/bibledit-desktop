...
public:
  ...
  void me2original(const ustring &system, int mybook, int mychapter,
                   int myverse, vector<int> &originalchapter,
                   vector<int> &originalverse);
  void original2me(const ustring &system, int originalbook, int originalchapter,
                   int originalverse, vector<int> &mychapter,
                   vector<int> &myverse);
