...
protected:
  ...
  void on_file_project_open(const ustring& project, const ustring& window_title, bool startup=false, viewType vt=vtFormatted);
  void add_new_editor_window(const ustring & project, const ustring& window_title, bool startup, viewType vt);
