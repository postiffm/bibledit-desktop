...
public:
  MainWindow(unsigned long xembed, GtkAccelGroup *_accelerator_group,
             Settings *_settings, URLTransport *_urltransport, VCS *_vcs);
  ~MainWindow();
  int run();
...
protected:
  ...
  GtkRadioMenuItem
      *view_experimental; // experimental no-paragraph divided editor
  ...
  void newproject();
  static void on_properties1_activate(GtkMenuItem *menuitem,
                                      gpointer user_data);
  void editproject();
  ...
  static void on_system_log1_activate(GtkMenuItem *menuitem,
                                      gpointer user_data);
  void viewlog();
  static void on_help_main_activate(GtkMenuItem *menuitem, gpointer user_data);
  void on_help_main();
  void on_jumpto_main(); // F2 accelerator focuses the Jump to: GtkEntry * box
                         // for quick kbd navigation
  ...
  static void on_prefs_books_activate(GtkMenuItem *menuitem,
                                      gpointer user_data);
  void on_prefs_books();
  ...
  static void on_preferences_gui_activate(GtkMenuItem *menuitem,
                                          gpointer user_data);
  ...
  static void on_pdf_viewer1_activate(GtkMenuItem *menuitem,
                                      gpointer user_data);
  void on_pdf_viewer();
  static void on_insert_special_character_activate(GtkMenuItem *menuitem,
                                                   gpointer user_data);
  void on_insert_special_character();
  static void on_preferences_compare_activate(GtkMenuItem *menuitem,
                                              gpointer user_data);
  ...
  static void on_tool_go_to_reference_activate(GtkMenuItem *menuitem,
                                               gpointer user_data);
  ...
  void on_copy();
  static void on_copy_with_formatting_activate(GtkMenuItem *menuitem,
                                               gpointer user_data);
  ...
  static void on_view_references_activate(GtkMenuItem *menuitem,
                                          gpointer user_data);
  void on_view_references();
  static void on_view_concordance_activate(GtkMenuItem *menuitem,
                                           gpointer user_data);
  ...
  static void on_window_references_delete_button_clicked(GtkButton *button,
                                                         gpointer user_data);
  void on_window_references_delete_button();
  static void on_window_references_signal_button_clicked(GtkButton *button,
                                                         gpointer user_data);
  void on_window_references_signal_button();

  /* Information window: concordance, etc. */
  static void on_window_info_delete_button_clicked(GtkButton *button,
                                                   gpointer user_data);
  void on_window_info_delete_button();
  static void on_window_info_signal_button_clicked(GtkButton *button,
                                                   gpointer user_data);
  ...
  static void
  on_show_quick_references_signal_button_clicked(GtkButton *button,
                                                 gpointer user_data);
  ...
  static void on_tool_send_reference_activate(GtkMenuItem *menuitem,
                                              gpointer user_data);
  ...
  static void on_window_notes_delete_button_clicked(GtkButton *button,
                                                    gpointer user_data);
  void on_window_notes_delete_button();
  static void on_new_note_activate(GtkMenuItem *menuitem, gpointer user_data);
  void on_new_note();
  static void on_delete_note_activate(GtkMenuItem *menuitem,
                                      gpointer user_data);
  static void on_consultant_notes_send_receive_activate(GtkMenuItem *menuitem,
                                                        gpointer user_data);
  ...
  static void
  on_window_notes_references_available_button_clicked(GtkButton *button,
                                                      gpointer user_data);
  void on_window_notes_references_available_button();

  /* Export */
  static void on_file_export_activate(GtkMenuItem *menuitem,
                                      gpointer user_data);
  void on_file_export();
  ...
  static void on_count_usfms1_activate(GtkMenuItem *menuitem,
                                       gpointer user_data);
  ...
  static void on_check_nt_quotations_from_the_ot_activate(GtkMenuItem *menuitem,
                                                          gpointer user_data);
  void on_check_nt_quotations_from_the_ot();
  static void
  on_synoptic_parallel_passages_from_the_nt_activate(GtkMenuItem *menuitem,
                                                     gpointer user_data);
  ...
  static void on_check_spelling_error_next_activate(GtkMenuItem *menuitem,
                                                    gpointer user_data);
  static void on_check_spelling_error_previous_activate(GtkMenuItem *menuitem,
                                                        gpointer user_data);
  void on_check_spelling_error(bool next, bool extremity);
  static void on_editor_spelling_checked_button_clicked(GtkButton *button,
                                                        gpointer user_data);
  void on_editor_spelling_checked_button();
  bool check_spelling_at_start;
  bool check_spelling_at_end;
  static void on_check_spelling_bulk_activate(GtkMenuItem *menuitem,
                                              gpointer user_data);
  void on_check_spelling_bulk();

  /* Styles */
  static void on_stylesheet_open_activate(GtkMenuItem *menuitem,
                                          gpointer user_data);
  void on_stylesheet_open();
  void on_goto_styles_area();
  void display_window_styles();
  WindowStyles *window_styles;
  static void on_window_styles_delete_button_clicked(GtkButton *button,
                                                     gpointer user_data);
  void on_window_styles_delete_button();
  void stylesheet_open_named(const ustring &stylesheet);
  static void on_style_button_open_clicked(GtkButton *button,
                                           gpointer user_data);
  ...
  static void on_insert_footnote_activate(GtkMenuItem *menuitem,
                                          gpointer user_data);
  static void on_insert_xref_activate(GtkMenuItem *menuitem,
                                      gpointer user_data);
  ...
  static void
  on_tool_origin_references_in_bible_notes_activate(GtkMenuItem *menuitem,
                                                    gpointer user_data);
  void on_tool_origin_references_in_bible_notes();
  static void on_tool_project_notes_mass_update1_activate(GtkMenuItem *menuitem,
                                                          gpointer user_data);
  void on_tool_project_notes_mass_update();
  static void
  on_tool_transfer_project_notes_to_text_activate(GtkMenuItem *menuitem,
                                                  gpointer user_data);
  void on_tool_transfer_project_notes_to_text();
  static void on_tools_maintenance_activate(GtkMenuItem *menuitem,
                                            gpointer user_data);
  ...
  static void
  on_window_check_keyterms_delete_button_clicked(GtkButton *button,
                                                 gpointer user_data);
  void on_window_check_keyterms_delete_button();
  static void on_keyterms_signal_button_clicked(GtkButton *button,
                                                gpointer user_data);
  void keyterms_check_action();
  static void on_view_related_verses_activate(GtkMenuItem *menuitem,
                                              gpointer user_data);
  void on_view_related_verses();
  WindowShowRelatedVerses *window_show_related_verses;
  static void
  on_window_show_related_verses_delete_button_clicked(GtkButton *button,
                                                      gpointer user_data);
  void on_window_show_related_verses_delete_button();
  static void
  on_window_show_related_verses_item_button_clicked(GtkButton *button,
                                                    gpointer user_data);
  void on_window_show_related_verses_item_button();
  void on_keyterms_import();
  ImportKeytermsAssistant *import_keyterms_assistant;
  static void on_keyterms_delete_activate(GtkMenuItem *menuitem,
                                          gpointer user_data);
  void on_keyterms_delete();
  DeleteKeytermsAssistant *delete_keyterms_assistant;

  /* Backup and restore */
  static void on_file_backup_activate(GtkMenuItem *menuitem,
                                      gpointer user_data);
  void on_file_backup();
  BackupAssistant *backup_assistant;
  static void on_file_restore_activate(GtkMenuItem *menuitem,
                                       gpointer user_data);
  void on_file_restore();
  RestoreAssistant *restore_assistant;

  /* Git */
  static void on_preferences_remote_repository_activate(GtkMenuItem *menuitem,
                                                        gpointer user_data);
  ...
  static void on_edit_revert_activate(GtkMenuItem *menuitem,
                                      gpointer user_data);
  void on_edit_revert();
  static void on_projects_send_receive1_activate(GtkMenuItem *menuitem,
                                                 gpointer user_data);
  ...
  /* Outline */
  static void on_view_outline_activate(GtkMenuItem *menuitem,
                                       gpointer user_data);
  void on_view_outline();
  WindowOutline *window_outline;
  static void on_window_outline_delete_button_clicked(GtkButton *button,
                                                      gpointer user_data);
  ...
  static void on_window_resource_delete_button_clicked(GtkButton *button,
                                                       gpointer user_data);
  ...
  static void on_window_editor_delete_button_clicked(GtkButton *button,
                                                     gpointer user_data);
  ...
  static void on_view_formatted_toggled(GtkMenuItem *menuitem,
                                        gpointer user_data);
  static void on_view_usfm_code_toggled(GtkMenuItem *menuitem,
                                        gpointer user_data);
  static void on_view_experimental_toggled(GtkMenuItem *menuitem,
                                           gpointer user_data);
  void on_view_formatted_togg();
  void on_view_usfm_code_togg();
  void on_view_experimental_togg();
  static void on_view_tile_windows_activate(GtkMenuItem *menuitem,
                                            gpointer user_data);
  void on_view_tile_windows();
#ifdef WIN32
  static void on_view_bibleworks_activate(GtkMenuItem *menuitem,
                                          gpointer user_data);
  void on_view_bibleworks();
#endif
  static void on_view_biblegateway_activate(GtkMenuItem *menuitem,
                                            gpointer user_data);
  void on_view_biblegateway();
  static void on_view_blueletterbible_activate(GtkMenuItem *menuitem,
                                               gpointer user_data);
  void on_view_blueletterbible();
  static void on_view_biblestudytools_activate(GtkMenuItem *menuitem,
                                               gpointer user_data);
  void on_view_biblestudytools();
  static void on_view_bibleorg_activate(GtkMenuItem *menuitem,
                                        gpointer user_data);
  void on_view_bibleorg();
  static void on_view_chapteras_activate(GtkRadioMenuItem *menuitem,
                                         gpointer user_data);
  ...
  static void on_window_merge_delete_button_clicked(GtkButton *button,
                                                    gpointer user_data);
  void on_window_merge_delete_button();
  static void on_merge_window_get_text_button_clicked(GtkButton *button,
                                                      gpointer user_data);
  void on_merge_window_get_text_button();
  static void on_merge_window_new_reference_button_clicked(GtkButton *button,
                                                           gpointer user_data);
  void on_merge_window_new_reference_button();
  static void on_merge_window_save_editors_button_clicked(GtkButton *button,
                                                          gpointer user_data);
  ...
  static void
  accelerator_next_reference_in_history_callback(gpointer user_data);
  void accelerator_next_reference_in_history();
  static void
  accelerator_previous_reference_in_history_callback(gpointer user_data);
  ...
  static void
  accelerator_next_reference_in_reference_area_callback(gpointer user_data);
  static void
  accelerator_previous_reference_in_reference_area_callback(gpointer user_data);
  ...
  static void on_window_check_usfm_delete_button_clicked(GtkButton *button,
                                                         gpointer user_data);
  void on_window_check_usfm_delete_button();
  void check_usfm_window_ping();

  /* Import */
  static void on_file_import_activate(GtkMenuItem *menuitem,
                                      gpointer user_data);
  void on_file_import();
  ImportAssistant *import_assistant;

  /* Floating windows */
  static void on_scrolledwindow_layout_size_allocate(GtkWidget *widget,
  ...
  static void on_window_focus_button_clicked(GtkButton *button,
                                             gpointer user_data);
  ...
  static bool
  on_interprocess_communications_initiate_listener_timeout(gpointer data);
  void interprocess_communications_initiate_listener();
  static void
  on_interprocess_communications_listener_button_clicked(GtkButton *button,
                                                         gpointer user_data);
