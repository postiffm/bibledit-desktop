...
PlanningEditDialog::PlanningEditDialog(unsigned int book,
  ...
  gtk_builder_add_from_file(
      gtkbuilder, gw_build_filename(Directories->get_package_data(),
                                    "gtkbuilder.planningeditdialog.xml")
                      .c_str(),
      NULL);
  ...
  button_status =
      GTK_WIDGET(gtk_builder_get_object(gtkbuilder, "button_status"));
  shortcuts.button(button_status);
  g_signal_connect((gpointer)button_status, "clicked",
                   G_CALLBACK(on_button_status_clicked), gpointer(this));
...
int PlanningEditDialog::run() { return gtk_dialog_run(GTK_DIALOG(dialog)); }

void PlanningEditDialog::on_button_status_clicked(GtkButton *button,
                                                  gpointer user_data) {
...
void PlanningEditDialog::on_button_tasks_clicked(GtkButton *button,
                                                 gpointer user_data) {
...
void PlanningEditDialog::on_okbutton_clicked(GtkButton *button,
                                             gpointer user_data) {
