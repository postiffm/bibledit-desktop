...
ExportParatextStylesheet::ExportParatextStylesheet(int dummy) {
  ...
  {
    ReadText rt(gw_build_filename(Directories->get_package_data(), "usfm.sty"),
                true, false);
...
void ExportParatextStylesheet::convert(const ustring &name) {
  ...
  for (unsigned int i = 0; i < sheet->styles.size(); i++) {
    ...
    } // Be aware that this has not yet been implemented. The export just
      // produces the standard Paratext stylesheet.
  }
  /*
  \Marker imt
  ...
  \Description Introduction major title at introduction end, level 1 (if single
  level)
  \TextProperties paragraph publishable vernacular level_1
  \TextType Other
  \OccursUnder id
  ...
  \Marker imte1
  \Name imte1 - Introduction - [Uncommon] Major Title at Introduction End Level
  1
  \Description Introduction major title at introduction end, level 1 (if
  multiple levels)
  \TextProperties paragraph publishable vernacular level_1
  \TextType Other
  \OccursUnder id
  ...
  \Marker imte2
  \Name imte2 - Introduction - [Uncommon] Major Title at Introduction End Level
  2
  ...
  \Description Introduction references range for outline entry; for marking
  ...
  \Description Introduction prose paragraph, with no first line indent (may
  occur after poetry)
  \OccursUnder id
  \Rank 6
  \TextType Other
  ...
  \Description Introduction prose paragraph text, indented, with no first line
  indent
  \OccursUnder id
  \Rank 6
  \TextType Other
  ...
  \Description Introduction prose paragraph, quote from the body text, with no
  first line indent
  \OccursUnder id
  \Rank 6
  \TextType Other
  ...
  \Description Introduction explanatory or bridge text (e.g. explanation of
  missing book in Short Old Testament)
  \OccursUnder id c
  \TextType Other
  \TextProperties paragraph publishable vernacular
  \StyleType Paragraph
  ...
  \Description Second (alternate) chapter number (for coding dual versification;
  useful for places where different traditions of chapter breaks need to be
  supported in the same translation)
  \OccursUnder c
  \TextType Other
  \StyleType Character
  \Italic
  ...
  \Description Published chapter number (this is a chapter marking that would be
  ...
  \Description Chapter label used for translations that add a word such as
  "Chapter" before chapter numbers (e.g. Psalms). The subsequent text is the
  chapter label.
  ...
  \OccursUnder li li1 li2 li3 li4 m mi nb p pc ph phi pi pi1 pi2 pi3 pr pmo pm
  pmc pmr q q1 q2 q3 q4 qc qr qm qm1 qm2 qm3 qm4 tc1 tc2 tc3 tc4 tcr1 tcr2 tcr3
  tcr4 s3 d sp
  ...
  \Description Second (alternate) verse number (for coding dual numeration in
  Psalms; see also NRSV Exo 22.1-4)
  \OccursUnder li li1 li2 li3 li4 m mi nb p pc ph phi pi pi1 pi2 pi3 pr pmo pm
  pmc pmr q q1 q2 q3 q4 qc qr qm qm1 qm2 qm3 qm4 tc1 tc2 tc3 tc4 s3 d
  \TextType Other
  \StyleType Character
  \FontSize 12
  \Superscript
  ...
  \Description Published verse marker - this is a verse marking that would be
  used in the published text
  \OccursUnder li li1 li2 li3 li4 m mi nb p pc ph phi pi pi1 pi2 pi3 pr pmo pm
  pmc pmr q q1 q2 q3 q4 qc qr qm qm1 qm2 qm3 tc1 tc2 tc3 tc4 s3
  \TextType Other
  \StyleType Character
  \FontSize 12
  \Superscript
  ...
  \Description Paragraph text, with no first line indent (may occur after
  poetry) (basic)
  \OccursUnder c
  \Rank 4
  \TextType VerseText
  ...
  \Description Embedded text refrain (e.g. Then all the people shall say,
  "Amen!")
  \OccursUnder m mi nb p pc ph phi pi pi1 pi2 pi3 pr q q1 q2 q3 q4 qc qr
  \TextType VerseText
  \TextProperties paragraph publishable vernacular
  ...
  \Description Paragraph text, level 1 indent (if sinlge level), with first line
  indent; often used for discourse (basic)
  \OccursUnder c
  \Rank 4
  \TextType VerseText
  \TextProperties paragraph publishable vernacular
  ...
  \Description Paragraph text, level 1 indent (if multiple levels), with first
  line indent; often used for discourse
  \OccursUnder c
  \Rank 4
  \TextType VerseText
  \TextProperties paragraph publishable vernacular
  ...
  \Description Paragraph text, level 2 indent, with first line indent; often
  used for discourse
  \OccursUnder c
  \Rank 4
  \TextType VerseText
  ...
  \Description Paragraph text, level 3 indent, with first line indent; often
  used for discourse
  \OccursUnder c
  \Rank 4
  \TextType VerseText
  ...
  \Description Paragraph text, indented, with no first line indent; often used
  for discourse
  \OccursUnder c
  \Rank 4
  \TextType VerseText
  ...
  \Description Paragraph text, with no break from previous paragraph text (at
  chapter boundary) (basic)
  \OccursUnder c
  \Rank 4
  \TextType VerseText
  \TextProperties paragraph publishable vernacular
  ...
  \Description Poetry text, Acrostic markup of the first character of a line of
  acrostic poetry
  \OccursUnder q q1 q2 q3 q4 qc qr  NEST
  \Rank 4
  \TextType Other
  ...
  \Description The main title of the book repeated at the end of the book, level
  1 (if single level)
  \TextProperties paragraph publishable vernacular level_1
  \TextType Title
  \OccursUnder c
  ...
  \Description The main title of the book repeated at the end of the book, level
  1 (if multiple levels)
  \TextProperties paragraph publishable vernacular level_1
  \TextType Title
  \OccursUnder li li1 li2 li3 li4 m mi nb p pc ph phi pi pi1 pi2 pi3 pr pmo pm
  pmc pmr q q1 q2 q3 q4 qc qr qm qm1 qm2 qm3 tc1 tc2 tc3 tc4 s3 d
  \Rank 2
  \StyleType Paragraph
  \FontSize 20
  \Bold
  ...
  \Description A secondary title occurring before or after the 'ending' main
  title
  \TextProperties paragraph publishable vernacular level_2
  \TextType Title
  \OccursUnder mte1
  ...
  \OccursUnder c li li1 li2 li3 li4 m mi nb p pc ph phi pi pi1 pi2 pi3 pr pmo pm
  pmc pmr q q1 q2 q3 q4 qc qr qm qm1 qm2 qm3 qs sp tc1 tc2 tc3 tc4 mt mt1 mt2
  mt3 ms ms1 ms2 ms3 s s1 s2 s3 spd d ip cp
  ...
  \OccursUnder c li li1 li2 li3 li4 m mi nb p pc ph phi pi pi1 pi2 pi3 pr pmo pm
  pmc pmr q q1 q2 q3 q4 qc qr qm qm1 qm2 qm3 sp tc1 tc2 tc3 tc4 ms ms1 ms2 ms3 s
  s1 s2 s3 spd d ip
  \TextProperties publishable vernacular note
  \TextType NoteText
  \StyleType Note
  ...
  \Description A footnote label text item, for marking or "labelling" the type
  or alternate translation being provided in the note.
  \OccursUnder f fe
  \TextProperties publishable vernacular note
  \TextType NoteText
  \StyleType Character
  ...
  \OccursUnder li li1 li2 li3 li4 m mi nb p pc ph phi pi pi1 pi2 pi3 pr pmo pm
  pmc pmr q q1 q2 q3 q4 qc qr qm qm1 qm2 qm3 sp tc1 tc2 tc3 tc4 ms ms1 ms2 s s1
  s2 s3 spd d ip
  \TextType Other
  \TextProperties paragraph publishable vernacular
  \StyleType Character
  ...
  \OccursUnder li li1 li2 li3 li4 m mi nb p pc ph phi pi pi1 pi2 pi3 pr pmo pm
  pmc pmr q q1 q2 q3 q4 qc qr qm qm1 qm2 qm3 qs sp tc1 tc2 tc3 tc4 mt mt1 mt2
  mt3 ms ms1 ms2 s s1 s2 s3 spd d
  ...
  \Description A cross-reference indicating the source text for the preceding
  quotation.
  \OccursUnder li li1 li2 li3 li4 m mi nb p pc ph phi pi pi1 pi2 pi3 pr pmo pm
  pmc pmr q q1 q2 q3 q4 qc qr qm qm1 qm2 qm3 NEST
  \TextType VerseText
  \TextProperties publishable vernacular
  \StyleType Character
  \FontSize 10
  ...
  \Description ID or Caller for an extended (study) note. Used within a source
  project duplicte (target) text when autoring study material.
  \OccursUnder li li1 li2 li3 li4 m mi nb p pc ph phi pi pi1 pi2 pi3 pr pmo pm
  pmc pmr q q1 q2 q3 q4 qc qr qm qm1 qm2 qm3 qm4 tc1 tc2 tc3 tc4 s3 d NEST
  \TextType Other
  \StyleType Character
  \FontSize 10
  \Bold
  ...
  (basic)
  \OccursUnder li li1 li2 li3 li4 m mi nb p pc ph phi pi pi1 pi2 pi3 pr pmo pm
  pmc pmr q q1 q2 q3 q4 qc qr qm qm1 qm2 qm3 sp tc1 tc2 tc3 tc4 ip im ili ili1
  ili2 io io1 io2 f fe NEST
  \TextType VerseText
  \TextProperties publishable vernacular
  \StyleType Character
  \FontSize 12
  ...
  \OccursUnder ip im ipi imi ipq imq ipr iq iq1 iq2 iq3 li li1 li2 li3 li4 m mi
  nb p pc ph phi pi pi1 pi2 pi3 pr pmo pm pmc pmr q q1 q2 q3 q4 qc qr qm qm1 qm2
  qm3 sp tc1 tc2 tc3 tc4 ms ms1 ms2 s s1 s2 s3 spd d ip f fe NEST
  \TextType VerseText
  \TextProperties publishable vernacular
  \StyleType Character
  \FontSize 12
  ...
  \Description Deuterocanonical/LXX additions or insertions in the
  Protocanonical text
  \OccursUnder li li1 li2 li3 li4 m mi nb p pc ph phi pi pi1 pi2 pi3 pr pmo pm
  pmc pmr q q1 q2 q3 q4 qc qr qm qm1 qm2 qm3 sp tc1 tc2 tc3 tc4 ms ms1 ms2 s s1
  s2 s3 spd d ip f fe NEST
  ...
  \OccursUnder li li1 li2 li3 li4 m mi nb p pc ph phi pi pi1 pi2 pi3 pr pmo pm
  pmc pmr q q1 q2 q3 q4 qc qr qm qm1 qm2 qm3 sp tc1 tc2 tc3 tc4 ms ms1 ms2 s s1
  s2 s3 spd d ip im ili ili1 ili2 io io1 io2 f fe NEST
  \TextType VerseText
  \TextProperties publishable vernacular
  \StyleType Character
  \FontSize 12
  ...
  \OccursUnder ip im ipi imi ipq imq ipr iq iq1 iq2 iq3 li li1 li2 li3 li4 m mi
  mis nb p pc ph phi pi pi1 pi2 pi3 pr ps psi q q1 q2 q3 q4 qc qr sp tc1 tc2 tc3
  tc4 ms ms1 ms2 s s1 s2 s3 spd d ip f fe NEST
  \TextType VerseText
  \TextProperties paragraph publishable vernacular
  \StyleType Character
  \FontSize 12
  ...
  \OccursUnder li li1 li2 li3 li4 m mi nb p pc ph phi pi pi1 pi2 pi3 pr pmo pm
  pmc pmr q q1 q2 q3 q4 qc qr qm qm1 qm2 qm3 sp tc1 tc2 tc3 tc4 ms ms1 ms2 s s1
  s2 s3 spd d ip im io1 io2 f fe NEST
  \TextType VerseText
  \TextProperties publishable vernacular
  \StyleType Character
  \FontSize 12
  ...
  \Description To represent where the original text is in a secondary language
  or from an alternate text source
  \OccursUnder li li1 li2 li3 li4 m mi nb p pc ph phi pi pi1 pi2 pi3 pr pmo pm
  pmc pmr q q1 q2 q3 q4 qc qr qm qm1 qm2 qm3 sp tc1 tc2 tc3 tc4 f fe NEST
  \TextType VerseText
  \TextProperties publishable vernacular
  \StyleType Character
  \FontSize 12
  ...
  \OccursUnder ip im li li1 li2 li3 li4 m mi nb p pc ph phi pi pi1 pi2 pi3 pr
  pmo pm pmc pmr q q1 q2 q3 q4 qc qr qm qm1 qm2 qm3 sp tc1 tc2 tc3 tc4 ms ms1
  ms2 s s1 s2 s3 spd d ip f fe NEST
  \TextType VerseText
  \TextProperties paragraph publishable vernacular
  \StyleType Character
  \FontSize 12
  ...
  \OccursUnder is ip ipi im imi ili ili1 ili2 imq ipq iex iq iot io1 io2 io3 io4
  s s1 s2 s3 NEST
  \TextProperties publishable vernacular
  \StyleType Character
  \FontSize 12
  ...
  \OccursUnder ip ipi im imi ili ili1 ili2 iex io1 io2 io3 io4 cd li li1 li2 li3
  li4 m mi nb p pc ph phi pi pi1 pi2 pi3 pr pmo pm pmc pmr q q1 q2 q3 q4 qc qr
  qm qm1 qm2 qm3 sp tc1 tc2 tc3 tc4 ms ms1 ms2 s s1 s2 s3 spd d ip f fe NEST
  \TextProperties publishable vernacular
  \StyleType Character
  \FontSize 12
  \Italic
  ...
  \Description Page Break used for new reader portions and children's bibles
  ...
  \OccursUnder ip im li li1 li2 li3 li4 m mi nb p pc ph phi pi pi1 pi2 pi3 pr
  pmo pm pmc pmr d q q1 q2 q3 q4 qc qr qm qm1 qm2 qm3 tc1 tc2 tc3 tc4 s s1 s2 s3
  s4 NEST
  \TextType VerseText
  \TextProperties paragraph publishable vernacular
  \StyleType Character
  ...
  \OccursUnder li li1 li2 li3 li4 m mi nb p pc ph phi pi pi1 pi2 pi3 pr pmo pm
  pmc pmr d q q1 q2 q3 q4 qc qr qm qm1 qm2 qm3 tc1 tc2 tc3 tc4 s s1 s2 s3 s4
  NEST
  \TextType VerseText
  \TextProperties paragraph publishable vernacular
  \StyleType Character
  ...
  \OccursUnder li li1 li2 li3 li4 m mi nb p pc ph phi pi pi1 pi2 pi3 pr pmo pm
  pmc pmr q q1 q2 q3 q4 qc qr qm qm1 qm2 qm3 tc1 tc2 tc3 tc4 s s1 s2 s3 s4 NEST
  \TextType VerseText
  \TextProperties paragraph publishable vernacular
  \StyleType Character
  \FontSize 12
  ...
  \Description Periheral content division marker which should be followed by an
  additional division argument/title.
  \OccursUnder id
  \TextType Section
  \TextProperties paragraph publishable vernacular
  \StyleType Paragraph
  ...
  \Description Concordance and Names Index markup for an alternate entry target
  reference.
  \OccursUnder p
  \TextProperties publishable vernacular
  \TextType NoteText
  ...
  \Marker xtSeeAlso
  \Endmarker xtSeeAlso*
  \Name xtSeeAlso - Concordance and Names Index - Additional Entry Target
  Reference
  \Description Concordance and Names Index markup for an additional entry target
  reference.
  \OccursUnder p
  \TextProperties publishable vernacular
  \TextType Other
  ...
  \Description Paragraph text, no break with next paragraph text at chapter
  boundary
  \OccursUnder c
  \Rank 4
  \TextType VerseText
  ...
  \Description Paragraph text, indented, with no break with next paragraph text
  (at chapter boundary)
  \OccursUnder c
  \Rank 4
  \TextType VerseText
  ...
  \Description A Wordlist text item
  \OccursUnder ms s li li1 li2 li3 li4 m mi nb p pc ph phi pi pi1 pi2 pi3 pr q
  q1 q2 q3 q4 qc qr tc1 tc2 tc3 tc4 f fe NEST
  \TextProperties publishable vernacular note
  \TextType VerseText
  \TextProperties paragraph publishable vernacular
  \StyleType Character
  ...
  # 2.0x peripheral markup (replaced with \periph + Content Division
  Title/Argument)
  ...
  Lang,Credit,Version,Copies,Publisher,Id,Logo
  \OccursUnder id ide
  \TextType Other
