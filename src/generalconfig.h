...
private:
  ...
  ustring string_get(const gchar *key, ustring &store, bool &loaded,
                     const ustring &standard);
  double double_get(const gchar *key, double &store, bool &loaded,
                    double standard);
  vector<bool> vector_bool_get(const gchar *key, vector<bool> &store,
                               bool &loaded, void *dummy);
  vector<ustring> vector_string_get(const gchar *key, vector<ustring> &store,
                                    bool &loaded, void *dummy);
  vector<int> vector_int_get(const gchar *key, vector<int> &store, bool &loaded,
                             void *dummy);
  vector<double> vector_double_get(const gchar *key, vector<double> &store,
                                   bool &loaded, void *dummy);
};
