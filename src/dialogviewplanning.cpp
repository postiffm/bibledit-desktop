...
ViewPlanningDialog::ViewPlanningDialog(int dummy) {
  ...
  gtk_window_set_position(GTK_WINDOW(viewstatusdialog),
  ...
  checkbutton_perc_done_project = gtk_check_button_new_with_mnemonic(
      _("Percentage complete whole project"));
  gtk_widget_show(checkbutton_perc_done_project);
  gtk_box_pack_start(GTK_BOX(vbox4), checkbutton_perc_done_project, FALSE,
                     FALSE, 0);
  gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(checkbutton_perc_done_project),
                               TRUE);

  shortcuts.button(checkbutton_perc_done_project);

  checkbutton_perc_done_book =
      gtk_check_button_new_with_mnemonic(_("Percentage complete per book"));
  gtk_widget_show(checkbutton_perc_done_book);
  gtk_box_pack_start(GTK_BOX(vbox4), checkbutton_perc_done_book, FALSE, FALSE,
                     0);
  gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(checkbutton_perc_done_book),
                               TRUE);

  shortcuts.button(checkbutton_perc_done_book);

  checkbutton_tasks_book =
      gtk_check_button_new_with_mnemonic(_("Tasks per book"));
  ...
  checkbutton_tasks_chapter =
      gtk_check_button_new_with_mnemonic(_("Tasks per chapter"));
  gtk_widget_show(checkbutton_tasks_chapter);
  gtk_box_pack_start(GTK_BOX(vbox4), checkbutton_tasks_chapter, FALSE, FALSE,
                     0);

  shortcuts.button(checkbutton_tasks_chapter);

  checkbutton_csv_export =
      gtk_check_button_new_with_mnemonic(_("CSV exported data"));
  ...
  dialog_action_area1 =
      gtk_dialog_get_action_area(GTK_DIALOG(viewstatusdialog));
  ...
  gtk_dialog_add_action_widget(GTK_DIALOG(viewstatusdialog), cancelbutton,
                               GTK_RESPONSE_CANCEL);
  gtk_widget_set_can_default(GTK_WIDGET(cancelbutton), true);

  okbutton = gtk_button_new_from_stock("gtk-ok");
  gtk_widget_show(okbutton);
  gtk_dialog_add_action_widget(GTK_DIALOG(viewstatusdialog), okbutton,
                               GTK_RESPONSE_OK);
...
void ViewPlanningDialog::on_okbutton_clicked(GtkButton *button,
                                             gpointer user_data) {
...
void ViewPlanningDialog::on_okbutton() {
  ...
  reporting_produce_status_report(
      ...
      gtk_toggle_button_get_active(
          GTK_TOGGLE_BUTTON(checkbutton_perc_done_project)),
      gtk_toggle_button_get_active(
          GTK_TOGGLE_BUTTON(checkbutton_perc_done_book)),
      gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(checkbutton_tasks_book)),
      gtk_toggle_button_get_active(
          GTK_TOGGLE_BUTTON(checkbutton_tasks_chapter)),
