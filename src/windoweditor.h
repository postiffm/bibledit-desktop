...
public:
  WindowEditor(const ustring &project_name, GtkWidget *parent_layout,
...
protected:
  ...
  ChapterView *currView; // this is either NULL or equal to one of the following
                         // editor/view pointers
  Editor2 *editor2;
  USFMView *usfmview;
  ...
  void on_new_styles();
  static void on_quick_references_signalled(GtkButton *button,
                                            gpointer user_data);
  void on_quick_references();
  static void on_word_double_click_signalled(GtkButton *button,
                                             gpointer user_data);
  ...
  void on_changed();
  static void on_spelling_checked_signalled(GtkButton *button,
                                            gpointer user_data);
  void on_spelling_checked();
  static void on_new_widget_signal_clicked(GtkButton *button,
                                           gpointer user_data);
