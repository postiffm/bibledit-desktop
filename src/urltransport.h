...
private:
  ...
  static void on_message_ready_callback(SoupSession *session, SoupMessage *msg,
                                        gpointer user_data);
  void on_message_ready(SoupSession *session, SoupMessage *msg);

  static void on_message_in_sequence_ready_callback(SoupSession *session,
                                                    SoupMessage *msg,
                                                    gpointer user_data);
  ...
  static void on_message_with_reply_ready_callback(SoupSession *session,
                                                   SoupMessage *msg,
                                                   gpointer user_data);
