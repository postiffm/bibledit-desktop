...
public:
  RadiobuttonDialog(const ustring &title, const ustring &info,
                    const vector<ustring> &labels, unsigned int selection,
                    bool autoscale);
  ~RadiobuttonDialog();
  int run();
...
private:
  ...
  static gboolean on_radiobutton_button_press_event(GtkWidget *widget,
