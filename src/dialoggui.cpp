...
GuiDialog::GuiDialog(int dummy) {
  ...
  gtk_builder_add_from_file(gtkbuilder,
                            gw_build_filename(Directories->get_package_data(),
                                              "gtkbuilder.guidialog.xml")
                                .c_str(),
                            NULL);
  featuresdialog = GTK_WIDGET(gtk_builder_get_object(gtkbuilder, "guidialog"));
  radiobutton_basic =
      GTK_WIDGET(gtk_builder_get_object(gtkbuilder, "radiobutton_basic"));
  ...
  radiobutton_user =
      GTK_WIDGET(gtk_builder_get_object(gtkbuilder, "radiobutton_user"));
  shortcuts.button(radiobutton_user);
  checkbutton_printing =
      GTK_WIDGET(gtk_builder_get_object(gtkbuilder, "checkbutton_printing"));
  shortcuts.button(checkbutton_printing);
  checkbutton_project_management = GTK_WIDGET(
      gtk_builder_get_object(gtkbuilder, "checkbutton_project_management"));
  shortcuts.button(checkbutton_project_management);
  checkbutton_references_management = GTK_WIDGET(
      gtk_builder_get_object(gtkbuilder, "checkbutton_references_management"));
  shortcuts.button(checkbutton_references_management);
  checkbutton_styles =
      GTK_WIDGET(gtk_builder_get_object(gtkbuilder, "checkbutton_styles"));
  shortcuts.button(checkbutton_styles);
  checkbutton_styles_management = GTK_WIDGET(
      gtk_builder_get_object(gtkbuilder, "checkbutton_styles_management"));
  shortcuts.button(checkbutton_styles_management);
  checkbutton_project_notes = GTK_WIDGET(
      gtk_builder_get_object(gtkbuilder, "checkbutton_project_notes"));
  shortcuts.button(checkbutton_project_notes);
  checkbutton_project_notes_management = GTK_WIDGET(gtk_builder_get_object(
      gtkbuilder, "checkbutton_project_notes_management"));
  shortcuts.button(checkbutton_project_notes_management);
  checkbutton_references_and_find = GTK_WIDGET(
      gtk_builder_get_object(gtkbuilder, "checkbutton_references_find"));
  shortcuts.button(checkbutton_references_and_find);
  checkbutton_replace =
      GTK_WIDGET(gtk_builder_get_object(gtkbuilder, "checkbutton_replace"));
  shortcuts.button(checkbutton_replace);
  checkbutton_checks =
      GTK_WIDGET(gtk_builder_get_object(gtkbuilder, "checkbutton_checks"));
  shortcuts.button(checkbutton_checks);
  checkbutton_tools =
      GTK_WIDGET(gtk_builder_get_object(gtkbuilder, "checkbutton_tools"));
  shortcuts.button(checkbutton_tools);
  checkbutton_preferences =
      GTK_WIDGET(gtk_builder_get_object(gtkbuilder, "checkbutton_preferences"));
  shortcuts.button(checkbutton_preferences);
  checkbutton_remember_verse_chapter = GTK_WIDGET(
      gtk_builder_get_object(gtkbuilder, "checkbutton_remember_verse_chapter"));
  shortcuts.button(checkbutton_remember_verse_chapter);
  checkbutton_start_maximized = GTK_WIDGET(
      gtk_builder_get_object(gtkbuilder, "checkbutton_start_maximized"));
  shortcuts.button(checkbutton_start_maximized);
  InDialogHelp *indialoghelp =
      new InDialogHelp(featuresdialog, gtkbuilder, &shortcuts,
  ...
  g_signal_connect((gpointer)radiobutton_basic, "toggled",
                   G_CALLBACK(on_togglebutton_toggled), gpointer(this));
  ...
  g_signal_connect((gpointer)checkbutton_printing, "toggled",
                   G_CALLBACK(on_checkbutton_toggled), gpointer(this));
  g_signal_connect((gpointer)checkbutton_project_management, "toggled",
                   G_CALLBACK(on_checkbutton_toggled), gpointer(this));
  g_signal_connect((gpointer)checkbutton_references_management, "toggled",
                   G_CALLBACK(on_checkbutton_toggled), gpointer(this));
  g_signal_connect((gpointer)checkbutton_styles, "toggled",
                   G_CALLBACK(on_checkbutton_toggled), gpointer(this));
  g_signal_connect((gpointer)checkbutton_styles_management, "toggled",
                   G_CALLBACK(on_checkbutton_toggled), gpointer(this));
  g_signal_connect((gpointer)checkbutton_project_notes, "toggled",
                   G_CALLBACK(on_checkbutton_toggled), gpointer(this));
  g_signal_connect((gpointer)checkbutton_project_notes_management, "toggled",
                   G_CALLBACK(on_checkbutton_toggled), gpointer(this));
  g_signal_connect((gpointer)checkbutton_references_and_find, "toggled",
                   G_CALLBACK(on_checkbutton_toggled), gpointer(this));
  g_signal_connect((gpointer)checkbutton_replace, "toggled",
                   G_CALLBACK(on_checkbutton_toggled), gpointer(this));
  g_signal_connect((gpointer)checkbutton_checks, "toggled",
                   G_CALLBACK(on_checkbutton_toggled), gpointer(this));
  g_signal_connect((gpointer)checkbutton_tools, "toggled",
                   G_CALLBACK(on_checkbutton_toggled), gpointer(this));
  ...
  gtk_toggle_button_set_active(
      ...
      settings->genconfig.remember_verse_per_chapter_get());
  gtk_toggle_button_set_active(
      GTK_TOGGLE_BUTTON(checkbutton_start_maximized),
      settings->genconfig.start_program_maximized_get());
}
...
int GuiDialog::run() { return gtk_dialog_run(GTK_DIALOG(featuresdialog)); }
...
// Store the new features.
{
  ...
  settings->genconfig.remember_verse_per_chapter_set(
      gtk_toggle_button_get_active(
          GTK_TOGGLE_BUTTON(checkbutton_remember_verse_chapter)));
  settings->genconfig.start_program_maximized_set(gtk_toggle_button_get_active(
      GTK_TOGGLE_BUTTON(checkbutton_start_maximized)));
  ...
  if ((old_mode != new_mode) || (old_list != new_list)) {
    gtkw_dialog_info(
        featuresdialog,
        "The changes will take effect after Bibledit-Gtk has been restarted");
  }
}

void GuiDialog::on_togglebutton_toggled(GtkToggleButton *togglebutton,
                                        gpointer user_data) {
...
void GuiDialog::on_togglebutton() {
  bool usersettings =
      gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(radiobutton_user));
...
// Set the list of features.
{
  ...
  gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(checkbutton_printing),
                               bitpattern_take(pattern));
  gtk_toggle_button_set_active(
      GTK_TOGGLE_BUTTON(checkbutton_project_management),
      bitpattern_take(pattern));
  gtk_toggle_button_set_active(
      GTK_TOGGLE_BUTTON(checkbutton_references_management),
      bitpattern_take(pattern));
  gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(checkbutton_styles),
                               bitpattern_take(pattern));
  gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(checkbutton_styles_management),
                               bitpattern_take(pattern));
  gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(checkbutton_project_notes),
                               bitpattern_take(pattern));
  gtk_toggle_button_set_active(
      GTK_TOGGLE_BUTTON(checkbutton_project_notes_management),
      bitpattern_take(pattern));
  gtk_toggle_button_set_active(
      GTK_TOGGLE_BUTTON(checkbutton_references_and_find),
      bitpattern_take(pattern));
  gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(checkbutton_replace),
                               bitpattern_take(pattern));
  gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(checkbutton_checks),
                               bitpattern_take(pattern));
  gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(checkbutton_tools),
                               bitpattern_take(pattern));
  gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(checkbutton_preferences),
                               bitpattern_take(pattern));
}
...
// Get the list of features.
{
  ...
  bitpattern_add(pattern, gtk_toggle_button_get_active(
                              GTK_TOGGLE_BUTTON(checkbutton_printing)));
  bitpattern_add(pattern, gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(
                              checkbutton_project_management)));
  bitpattern_add(pattern, gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(
                              checkbutton_references_management)));
  bitpattern_add(pattern, gtk_toggle_button_get_active(
                              GTK_TOGGLE_BUTTON(checkbutton_styles)));
  bitpattern_add(pattern, gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(
                              checkbutton_styles_management)));
  bitpattern_add(pattern, gtk_toggle_button_get_active(
                              GTK_TOGGLE_BUTTON(checkbutton_project_notes)));
  bitpattern_add(pattern, gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(
                              checkbutton_project_notes_management)));
  bitpattern_add(pattern, gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(
                              checkbutton_references_and_find)));
  bitpattern_add(pattern, gtk_toggle_button_get_active(
                              GTK_TOGGLE_BUTTON(checkbutton_replace)));
  bitpattern_add(pattern, gtk_toggle_button_get_active(
                              GTK_TOGGLE_BUTTON(checkbutton_checks)));
  bitpattern_add(pattern, gtk_toggle_button_get_active(
                              GTK_TOGGLE_BUTTON(checkbutton_tools)));
  bitpattern_add(pattern, gtk_toggle_button_get_active(
                              GTK_TOGGLE_BUTTON(checkbutton_preferences)));
  return pattern;
}

void GuiDialog::on_checkbutton_toggled(GtkToggleButton *togglebutton,
                                       gpointer user_data) {
