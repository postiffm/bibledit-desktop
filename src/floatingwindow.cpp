...
FloatingWindow::FloatingWindow(GtkWidget *layout_in, WindowID window_id_in,
                               ustring title_in, bool startup)
// Base class for each floating window.
{
  ...
  eventbox_title =
      GTK_WIDGET(gtk_builder_get_object(gtkbuilder, "eventbox_title"));
  label_title = GTK_WIDGET(gtk_builder_get_object(gtkbuilder, "label_title"));
  title_set(focused);
  g_signal_connect((gpointer)eventbox_title, "button_press_event",
                   G_CALLBACK(on_widget_button_press_event), gpointer(this));
  g_signal_connect((gpointer)eventbox_title, "button_press_event",
                   G_CALLBACK(on_title_bar_button_press_event), gpointer(this));
  g_signal_connect((gpointer)eventbox_title, "button_release_event",
                   G_CALLBACK(on_title_bar_button_release_event),
                   gpointer(this));
  g_signal_connect((gpointer)eventbox_title, "motion_notify_event",
                   G_CALLBACK(on_title_bar_motion_notify_event),
                   gpointer(this));
  g_signal_connect((gpointer)eventbox_title, "enter_notify_event",
                   G_CALLBACK(on_titlebar_enter_notify_event), gpointer(this));
  g_signal_connect((gpointer)eventbox_title, "leave_notify_event",
                   G_CALLBACK(on_titlebar_leave_notify_event), gpointer(this));

  GtkWidget *eventbox_close;
  eventbox_close =
      GTK_WIDGET(gtk_builder_get_object(gtkbuilder, "eventbox_close"));
  label_close = GTK_WIDGET(gtk_builder_get_object(gtkbuilder, "label_close"));
  g_signal_connect((gpointer)eventbox_close, "button_press_event",
                   G_CALLBACK(on_widget_button_press_event), gpointer(this));
  g_signal_connect((gpointer)eventbox_close, "enter_notify_event",
                   G_CALLBACK(on_label_close_enter_notify_event),
                   gpointer(this));
  g_signal_connect((gpointer)eventbox_close, "leave_notify_event",
                   G_CALLBACK(on_label_close_leave_notify_event),
                   gpointer(this));
  g_signal_connect((gpointer)eventbox_close, "button_press_event",
                   G_CALLBACK(on_label_close_button_press_event),
                   gpointer(this));

  GtkWidget *eventbox_client;
  eventbox_client =
      GTK_WIDGET(gtk_builder_get_object(gtkbuilder, "eventbox_client"));
  vbox_client = GTK_WIDGET(gtk_builder_get_object(gtkbuilder, "vbox_client"));
  g_signal_connect((gpointer)eventbox_client, "button_press_event",
                   G_CALLBACK(on_widget_button_press_event), gpointer(this));

  GtkWidget *eventbox_status1;
  eventbox_status1 =
      GTK_WIDGET(gtk_builder_get_object(gtkbuilder, "eventbox_status1"));
  label_status1 =
      GTK_WIDGET(gtk_builder_get_object(gtkbuilder, "label_status1"));
  g_signal_connect((gpointer)eventbox_status1, "button_press_event",
                   G_CALLBACK(on_widget_button_press_event), gpointer(this));

  GtkWidget *eventbox_status2;
  eventbox_status2 =
      GTK_WIDGET(gtk_builder_get_object(gtkbuilder, "eventbox_status2"));
  label_status2 =
      GTK_WIDGET(gtk_builder_get_object(gtkbuilder, "label_status2"));
  g_signal_connect((gpointer)eventbox_status2, "button_press_event",
                   G_CALLBACK(on_widget_button_press_event), gpointer(this));

  widget_resizer =
      GTK_WIDGET(gtk_builder_get_object(gtkbuilder, "widget_resizer"));
  g_signal_connect((gpointer)widget_resizer, "button_press_event",
                   G_CALLBACK(on_widget_button_press_event), gpointer(this));
  g_signal_connect((gpointer)widget_resizer, "button_press_event",
                   G_CALLBACK(on_status_bar_button_press_event),
                   gpointer(this));
  g_signal_connect((gpointer)widget_resizer, "button_release_event",
                   G_CALLBACK(on_status_bar_button_release_event),
                   gpointer(this));
  g_signal_connect((gpointer)widget_resizer, "motion_notify_event",
                   G_CALLBACK(on_status_bar_motion_notify_event),
                   gpointer(this));
  g_signal_connect((gpointer)widget_resizer, "enter_notify_event",
                   G_CALLBACK(on_statusbar_enter_notify_event), gpointer(this));
  g_signal_connect((gpointer)widget_resizer, "leave_notify_event",
                   G_CALLBACK(on_statusbar_leave_notify_event), gpointer(this));
...
gboolean FloatingWindow::on_title_bar_button_press_event(GtkWidget *widget,
...
gboolean FloatingWindow::on_title_bar_button_release_event(
...
gboolean FloatingWindow::on_title_bar_motion_notify_event(GtkWidget *widget,
...
gboolean FloatingWindow::on_status_bar_button_press_event(GtkWidget *widget,
                                                          GdkEventButton *event,
                                                          gpointer user_data) {
...
gboolean FloatingWindow::on_status_bar_button_release_event(
    GtkWidget *widget, GdkEventButton *event, gpointer user_data) {
...
gboolean FloatingWindow::on_status_bar_motion_notify_event(
...
gboolean FloatingWindow::on_status_bar_motion_notify(GdkEventMotion *event) {
  if (resizing_window) {
    gw_destroy_source(resize_event_id);
    resize_event_id = g_timeout_add_full(G_PRIORITY_DEFAULT, 200,
                                         GSourceFunc(on_resize_timeout),
                                         gpointer(this), NULL);
    ...
    if (previous_root_x >= 0) {
      ...
      if (resize_box) {
        gtk_widget_set_size_request(vbox_window, my_gdk_rectangle.width,
                                    my_gdk_rectangle.height);
      }
    }
    previous_root_x = event_x;
    previous_root_y = event_y;
...
gboolean FloatingWindow::on_titlebar_enter_notify_event(GtkWidget *widget,
...
gboolean FloatingWindow::on_titlebar_enter_notify(GdkEventCrossing *event) {
  // Set the cursor to a shape that shows that the title bar can be moved
  // around.
...
gboolean FloatingWindow::on_titlebar_leave_notify_event(GtkWidget *widget,
                                                        GdkEventCrossing *event,
                                                        gpointer user_data) {
...
gboolean FloatingWindow::on_statusbar_enter_notify_event(
...
gboolean FloatingWindow::on_statusbar_enter_notify(GdkEventCrossing *event) {
  // Set the cursor to a shape that shows that the status bar can be used to
  // resize the window.
...
gboolean FloatingWindow::on_statusbar_leave_notify_event(
    GtkWidget *widget, GdkEventCrossing *event, gpointer user_data) {
...
gboolean FloatingWindow::on_label_close_enter_notify_event(
    GtkWidget *widget, GdkEventCrossing *event, gpointer user_data) {
...
gboolean FloatingWindow::on_label_close_leave_notify_event(
    GtkWidget *widget, GdkEventCrossing *event, gpointer user_data) {
...
gboolean FloatingWindow::on_label_close_button_press_event(
    GtkWidget *widget, GdkEventButton *event, gpointer user_data) {
...
// startup: whether the box is started at program startup.
{
  ...
  // At program startup extract the position and size of the window from the
  // general configuration.
  // It does not matter whether the space for the window is already taken up by
  // another window,
  // because the user wishes to use the coordinates that he has set for this
  // window.
  for (unsigned int i = 0; i < window_parameters.widths.size(); i++) {
    if ((window_parameters.ids[i] == window_id) &&
        (window_parameters.titles[i] == title) && startup) {
  ...
  if (!startup) {
    ...
    // Step 3: The regions of each of the open windows is substracted from the
    // available region.
    ...
    // A rectangle is considered suitable if it has at least 10% of the width,
    // and 10% of the height of the area rectangle.
    GdkRectangle *gdk_rectangles = NULL;
    gint rectangle_count = 0;
    gdk_region_get_rectangles(available_region, &gdk_rectangles,
                              &rectangle_count);
      ...
      if (rectangle.width >= (area_rectangle.width / 10)) {
        if (rectangle.height >= (area_rectangle.height / 10)) {
          if ((rectangle.width * rectangle.height) >
              (my_gdk_rectangle.width * my_gdk_rectangle.height)) {
    ...
    // Step 6: If no area big enough is found, then the window that takes most
    // space in the area is chosen,
    // the longest side is halved, and the new window is put in that freed area.
    if ((my_gdk_rectangle.width == 0) || (my_gdk_rectangle.height == 0)) {
      FloatingWindow *resize_window_pointer = NULL;
      int largest_size = 0;
      for (unsigned int i = 0;
           i < settings->session.open_floating_windows.size(); i++) {
        FloatingWindow *floating_window =
            (FloatingWindow *)settings->session.open_floating_windows[i];
        GdkRectangle rectangle = floating_window->rectangle_get();
      ...
      if (resize_window_pointer) {
        GdkRectangle resize_window_rectangle =
            resize_window_pointer->rectangle_get();
  ...
  gtk_layout_put(GTK_LAYOUT(layout), vbox_window, my_gdk_rectangle.x,
                 my_gdk_rectangle.y);
  rectangle_set(my_gdk_rectangle);
...
// Thus if the same window is opened again, it will go in the same free space as
// it was in before.
{
  ...
  for (unsigned int i = 0; i < window_params.widths.size(); i++) {
    if ((window_params.ids[i] == window_id) &&
        (window_params.titles[i] == title)) {
      window_found = true;
    }
  }
  if (!window_found) {
  ...
  for (unsigned int i = 0; i < window_params.ids.size(); i++) {
    if ((window_id == window_params.ids[i]) &&
        (title == window_params.titles[i])) {
...
// Sets the focus of the window.
{
  ...
  // It has been observed that widgets that are last added to the layout are
  // shown on top of any others.
  // Therefore remove the window from the layout, and add it again so that it
  // becomes the last one added.
  if (active) {
    // The following works to set the window above others, but the by-effects
    // are undesirable,
...
GdkRectangle FloatingWindow::rectangle_get() { return my_gdk_rectangle; }

void FloatingWindow::rectangle_set(const GdkRectangle &rectangle) {
  my_gdk_rectangle = rectangle;
  gtk_layout_move(GTK_LAYOUT(layout), vbox_window, my_gdk_rectangle.x,
                  my_gdk_rectangle.y);
  gtk_widget_set_size_request(vbox_window, my_gdk_rectangle.width,
                              my_gdk_rectangle.height);
}
...
// It looks through all widgets it has, to find out whether "widget" belongs to
// the object.
{
  focused_widget_to_look_for = widget;
  if (GTK_IS_CONTAINER(vbox_window)) {
    gtk_container_foreach(GTK_CONTAINER(vbox_window),
                          on_container_tree_callback, gpointer(this));
  }
}

void FloatingWindow::on_container_tree_callback(GtkWidget *widget,
                                                gpointer user_data) {
  ((FloatingWindow *)user_data)->container_tree_callback(widget, user_data);
}

void FloatingWindow::container_tree_callback(GtkWidget *widget,
                                             gpointer user_data)
// Recursive callback that fires the focus signal if the widget belongs to the
// object.
{
  ...
  if (GTK_IS_CONTAINER(widget)) {
    gtk_container_foreach(GTK_CONTAINER(widget), on_container_tree_callback,
                          user_data);
  }
}

gboolean FloatingWindow::on_widget_button_press_event(GtkWidget *widget,
                                                      GdkEventButton *event,
                                                      gpointer user_data) {
...
void FloatingWindow::on_widget_button_press(GtkWidget *widget,
                                            GdkEventButton *event) {
  focus_set();
}
...
// Set the title.
{
  ...
  for (unsigned int i = 0; i < 500; i++)
    spaces.append(" ");
  char *data;
  data = g_strdup_printf("<span foreground=\"%s\" background=\"%s\" "
                         "weight=\"%s\">     %s     %s</span>",
                         focused ? "white" : "black", focused ? "blue" : "grey",
                         focused ? "bold" : "normal", title.c_str(),
                         spaces.c_str());
  gtk_label_set_markup(GTK_LABEL(label_title), data);
  g_free(data);
}

void FloatingWindow::on_widget_grab_focus(GtkWidget *widget,
                                          gpointer user_data) {
...
// Connects relevant focus signals of "widget".
{
  ...
  g_signal_connect((gpointer)widget, "button_press_event",
                   G_CALLBACK(on_widget_button_press_event), gpointer(this));
  // When a widget has grabbed focus, it should store this state for later use.
  g_signal_connect_after((gpointer)widget, "grab_focus",
                         G_CALLBACK(on_widget_grab_focus), gpointer(this));
}
