...
private:
  ...
  static void on_checkbuttonbook_toggled(GtkToggleButton *togglebutton,
                                         gpointer user_data);
  static void on_checkbuttonchapter_toggled(GtkToggleButton *togglebutton,
                                            gpointer user_data);
  vector<unsigned int> selectable_books;
  static void replacedialog_on_buttonfind_clicked(GtkButton *button,
                                                  gpointer user_data);
