...
ustring interprocess_communication_message_url(InterprocessCommunicationMessageType message,
  ...
  case icstNone:
    break;
  case icstGoto:
    subject_string.append("goto");
    break;
  case icstQuit:
    subject_string.append("quit");
    break;
  case icstReload:
    subject_string.append("reload");
    break;
  case icstGetref:
    subject_string.append("getref");
    break;
  case icstPause:
    subject_string.append("pause");
    break;
  case icstContinue:
    subject_string.append("continue");
    break;
  case icstFocus:
    subject_string.append("focus");
    break;
  }
...
ustring interprocess_communication_message_url(InterprocessCommunicationMessageType message, // Todo
  ...
  case icmtClearMessages:
    ...
    break;
  case icmtStoreMessage:
    url.append("storemessage.php");
    break;
  case icmtListen:
    url.append("getmessage.php");
    break;
  case icmtSetMessage:
    url.append("setmessage.php");
    break;
  }
  url.append("?channel=");
  switch (channel) {
  ...
  case icctXiphos:
    ...
    break;
  case icctBibleTime:
    url.append("bibletime");
    break;
  case icctBibledit:
    url.append("bibledit");
    break;
  case icctVcsWorker:
    url.append("vcsworker");
    break;
  case icctVcsControl:
    url.append("vcscontrol");
    break;
  }
  url.append("&subject=");
  url.append(subject);
