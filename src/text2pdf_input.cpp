...
T2PInputParagraph::T2PInputParagraph(const ustring &font,
                                     unsigned int line_spacing_in,
...
// Transforms the addition and deletion markers into bold and strike-through
// data.
{
...
bool T2PInputParagraph::inline_get_font_size(unsigned int index, bool &in_range,
...
// Gets the inline font size at "index".
{
  ...
  size = int(font_size_points * PANGO_SCALE *
             font_size_percentage_values[index] / 100);
  if (start_index < 0) {
    start_index = 0;
  }
  return end_index > 0;
...
void T2PInputParagraph::inline_set_italic(T2PMarkupType italic,
                                          bool cleanup_only)
// Store a value for the inline italic markup.
{
  inline_set_value(italic_values, italic_start_indices, italic_end_indices,
                   italic, cleanup_only);
}

bool T2PInputParagraph::inline_get_italic(unsigned int index, bool &in_range,
                                          bool &value, int &start_index,
                                          int &end_index)
// Gets the inline italic markup at "index".
{
  return inline_get_value(italic_values, italic_start_indices,
                          italic_end_indices, italic_values_completed, italic,
                          index, in_range, value, start_index, end_index);
}

void T2PInputParagraph::inline_set_bold(T2PMarkupType bold, bool cleanup_only)
// Store a value for the inline bold markup.
{
  inline_set_value(bold_values, bold_start_indices, bold_end_indices, bold,
                   cleanup_only);
}

bool T2PInputParagraph::inline_get_bold(unsigned int index, bool &in_range,
                                        bool &value, int &start_index,
                                        int &end_index)
// Gets the inline bold markup at "index".
{
  return inline_get_value(bold_values, bold_start_indices, bold_end_indices,
                          bold_values_completed, bold, index, in_range, value,
                          start_index, end_index);
}

void T2PInputParagraph::inline_set_underline(T2PMarkupType underline,
                                             bool cleanup_only)
// Store a value for the inline underline markup.
{
  inline_set_value(underline_values, underline_start_indices,
                   underline_end_indices, underline, cleanup_only);
}

bool T2PInputParagraph::inline_get_underline(unsigned int index, bool &in_range,
                                             bool &value, int &start_index,
                                             int &end_index)
// Gets the inline underline markup at "index".
{
  return inline_get_value(underline_values, underline_start_indices,
                          underline_end_indices, underline_values_completed,
                          underline, index, in_range, value, start_index,
                          end_index);
}

void T2PInputParagraph::inline_set_small_caps(T2PMarkupType small_caps,
                                              bool cleanup_only)
// Store a value for the inline small caps markup.
{
  inline_set_value(small_caps_values, small_caps_start_indices,
                   small_caps_end_indices, small_caps, cleanup_only);
}

bool T2PInputParagraph::inline_get_small_caps(unsigned int index,
                                              bool &in_range, bool &value,
                                              int &start_index, int &end_index)
// Gets the inline small caps markup at "index".
{
  return inline_get_value(small_caps_values, small_caps_start_indices,
                          small_caps_end_indices, small_caps_values_completed,
                          small_caps, index, in_range, value, start_index,
                          end_index);
}

void T2PInputParagraph::inline_set_value(vector<int> &values,
                                         vector<int> &start_indices,
                                         vector<int> &end_indices,
                                         T2PMarkupType value, bool cleanup_only)
// Store a value for the inline markup.
{
  ...
  // Store the current values, leaving the end index undefined as its value is
...
bool T2PInputParagraph::inline_get_value(
    vector<int> &values, vector<int> &start_indices, vector<int> &end_indices,
    bool &values_completed, bool paragraph_value, unsigned int index,
    bool &in_range, bool &value, int &start_index, int &end_index)
...
bool T2PInputParagraph::inline_get_superscript(unsigned int index,
                                               bool &in_range,
                                               bool &superscript,
                                               int &start_index, int &end_index,
                                               size_t text_length) {
...
bool T2PInputParagraph::inline_get_colour(unsigned int index, bool &in_range,
...
void T2PInputParagraph::inline_set_strike_through(T2PMarkupType strike_through,
                                                  bool cleanup_only)
// Store a value for the inline strike-through markup.
{
  inline_set_value(strike_through_values, strike_through_start_indices,
                   strike_through_end_indices, strike_through, cleanup_only);
}

bool T2PInputParagraph::inline_get_strike_through(unsigned int index,
                                                  bool &in_range, bool &value,
                                                  int &start_index,
                                                  int &end_index)
// Gets the inline strike-through markup at "index".
{
  return inline_get_value(strike_through_values, strike_through_start_indices,
                          strike_through_end_indices,
                          strike_through_values_completed, t2pmtOff, index,
                          in_range, value, start_index, end_index);
}
...
vector<T2PInputParagraph *>
T2PInputParagraph::get_notes(size_t text_length_before_fitting,
                             size_t text_length_after_fitting)
