...
protected:
  ...
  GtkWidget *okbutton;
  static gboolean on_treeviewbooks_key_press_event(GtkWidget *widget,
                                                   GdkEventKey *event,
                                                   gpointer user_data);
  gboolean on_treeviewbooks_key_press(GdkEventKey *event);
  static void on_treeviewportions_row_activated(GtkTreeView *treeview,
                                                GtkTreePath *path,
...
private:
  ...
  void loadbooks();
  static void selection_foreach_function(GtkTreeModel *model, GtkTreePath *path,
