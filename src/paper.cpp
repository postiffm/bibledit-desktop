...
const char *PAPER_SIZES[NUMBER_OF_PAPERSIZES] = {
    "A3",       "A4",       "A5",       "B4 (ISO)", "B5 (ISO)",
    "B6 (ISO)", "B4 (JIS)", "B5 (JIS)", "B6 (JIS)", "Letter",
    "Legal",    "Tabloit",  "C4",       "C5",       "C6"};

double PAPER_WIDTHS[NUMBER_OF_PAPERSIZES] = {29.70, 21.00, 14.80, 25.00, 17.60,
                                             12.50, 25.70, 18.20, 12.80, 21.59,
                                             21.59, 27.96, 22.90, 16.20, 11.40};

double PAPER_HEIGHTS[NUMBER_OF_PAPERSIZES] = {
    42.00, 29.70, 21.00, 35.30, 25.00, 17.60, 36.40, 25.70,
    18.20, 27.94, 35.57, 43.13, 32.40, 22.90, 16.20};
