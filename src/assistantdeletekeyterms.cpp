...
// Assistant for deleting keyterms.
{
  ...
  gtk_assistant_set_page_title(GTK_ASSISTANT(assistant), vbox1,
                               _("Which collection would you like to delete?"));
...
void DeleteKeytermsAssistant::on_assistant_apply_signal(GtkAssistant *assistant,
                                                        gpointer user_data) {
...
gint DeleteKeytermsAssistant::assistant_forward_function(gint current_page,
                                                         gpointer user_data) {
  return ((DeleteKeytermsAssistant *)user_data)
