...
// If the vectors are not of the same size, their sizes will be adjusted.
{
  struct {
    const char *task;
    double duration;
  } default_values[] = {{"First Draft", 2}, {"Self Check", 0.4}, {"Team Check", 0.4}, {"Back Translation", 0.4}, {"Advisor Check", 0.1}, {"First Revision", 0.4}, {"First Village Check", 0.5}, {"Second Revision", 0.4}, {"Second Village Check", 0.5}, {"Third Revision", 0.4}, {"Consultant Check", 0.1}, {"Fourth Revision", 0.4}, {"First Read Through", 0.2}, {"Second Read Through", 0.2}, {"Publish", 0}, {"Post Publish Revision", 0}};
