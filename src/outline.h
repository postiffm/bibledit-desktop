...
private:
  ...
  static gboolean on_view_button_press_event(GtkWidget *widget,
                                             ...
                                             gpointer user_data);
  static gboolean on_view_key_press_event(GtkWidget *widget, GdkEventKey *event,
                                          gpointer user_data);
  bool expand_collapse(bool expand);
  void focus(Reference &reference);
  void focus_internal_children(unsigned int reference, GtkTreeIter &parent,
                               GtkTreeSelection *selection, bool &focused);
  void focus_internal_select(unsigned int reference, GtkTreeIter &iter,
                             GtkTreeSelection *selection, bool &focused);
  static void on_view_row_activated(GtkTreeView *treeview, GtkTreePath *path,
