...
void SelectProjectGui::build(GtkWidget *box, const gchar *labeltext,
  ...
  g_signal_connect((gpointer)button, "clicked", G_CALLBACK(on_button_clicked),
                   gpointer(this));

  gtk_label_set_mnemonic_widget(GTK_LABEL(label), button);
}

void SelectProjectGui::on_button_clicked(GtkButton *button,
                                         gpointer user_data) {
...
void SelectProjectGui::focus() { gtk_widget_grab_focus(button); }
