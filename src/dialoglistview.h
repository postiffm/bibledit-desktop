...
public:
  ListviewDialog(const ustring &title, vector<ustring> &list,
                 const ustring &focus, bool sortlist, gchar *help);
  ~ListviewDialog();
  void two_pages(const gchar *tab1, const gchar *tab2, vector<ustring> &list,
                 bool sortlist);
  void tab_switcher(guint accel_key, GdkModifierType accel_mods,
                    const gchar *acceleratortext, const gchar *actiontext1,
...
protected:
  ...
  static void on_treeview1_row_activated(GtkTreeView *treeview,
                                         ...
                                         gpointer user_data);
  static void on_treeview2_row_activated(GtkTreeView *treeview,
                                         GtkTreePath *path,
                                         GtkTreeViewColumn *column,
                                         gpointer user_data);
  void on_treeview();
