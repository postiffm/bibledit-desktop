...
void HtmlWriter2::form_open(const gchar *name, const gchar *action,
                            const gchar *method) {
...
void HtmlWriter2::form_close() { xmlTextWriterEndElement(writer); }

void HtmlWriter2::input_open(const gchar *name, const gchar *type,
                             unsigned int size, const gchar *value) {
...
void HtmlWriter2::input_close() { xmlTextWriterEndElement(writer); }
...
// <a href="url">text</a>
// Or for links without underline: <a href="url"
// style="text-decoration:none">text</a>
{
  ...
  // Does not work to remove the underline from the link
  // xmlTextWriterWriteAttribute(writer, BAD_CAST "style", BAD_CAST
...
void HtmlWriter2::highlight_open() {
  xmlTextWriterStartElement(writer,
                            BAD_CAST "FONT style=\"BACKGROUND-COLOR: yellow\"");
  highlight_level++;
}
