...
private:
  ...
  static void on_assistant_prepare_signal(GtkAssistant *assistant,
  ...
  static void on_button_add_files_clicked(GtkButton *button,
                                          gpointer user_data);
  void on_button_add_files(bool gui_only);
  static void on_button_add_folders_clicked(GtkButton *button,
                                            gpointer user_data);
  ...
  static void on_entry_home_page_changed(GtkEditable *editable,
                                         gpointer user_data);
  ...
  static void on_button_books_import_clicked(GtkButton *button,
                                             gpointer user_data);
  ...
  static void on_button_books2_import_clicked(GtkButton *button,
                                              gpointer user_data);
  ...
  static void on_combobox_test_changed(GtkComboBox *combobox,
                                       gpointer user_data);
  void on_url();
  ...
  static void on_assistant_apply_signal(GtkAssistant *assistant,
                                        gpointer user_data);
