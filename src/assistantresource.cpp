...
// Assistant for editing or creating a resource.
{
  ...
  // If a Resource is being edited, copy it into the working directory.
  {
    if (!edited_resource_template.empty()) {
      ustring resource_directory =
          gw_path_get_dirname(edited_resource_template);
      if (resource_directory == Directories->get_package_data()) {
        ...
        if (system(command.c_str()))
          ; // This one does not work with GwSpawn.
      }
    }
  }
  ...
  intro_message.append(
      _(".\nAny changes you make show up immediately.\n\nThe online help "
        "provides more information for each step."));
  ...
  gtk_assistant_set_page_title(GTK_ASSISTANT(assistant), vbox_title,
                               _("What is the title of the Resource?"));
  gtk_assistant_set_page_type(GTK_ASSISTANT(assistant), vbox_title,
  ...
  gtk_entry_set_text(GTK_ENTRY(entry_title),
                     resource_get_title(working_configuration_file()).c_str());

  g_signal_connect((gpointer)entry_title, "changed",
                   G_CALLBACK(on_entry_title_changed), gpointer(this));
  ...
  gtk_assistant_set_page_title(
      GTK_ASSISTANT(assistant), table_files,
      _("Would you like to add local files to the Resource?"));
  gtk_assistant_set_page_type(GTK_ASSISTANT(assistant), table_files,
                              GTK_ASSISTANT_PAGE_CONTENT);
  ...
  g_signal_connect((gpointer)button_add_files, "clicked",
                   G_CALLBACK(on_button_add_files_clicked), gpointer(this));
  g_signal_connect((gpointer)button_add_folders, "clicked",
                   G_CALLBACK(on_button_add_folders_clicked), gpointer(this));
  ...
  gtk_assistant_set_page_title(GTK_ASSISTANT(assistant), vbox_home_page,
                               _("What is the home page of the Resource?"));
  gtk_assistant_set_page_type(GTK_ASSISTANT(assistant), vbox_home_page,
                              GTK_ASSISTANT_PAGE_CONTENT);
  gtk_assistant_set_page_complete(GTK_ASSISTANT(assistant), vbox_home_page,
                                  true);
  ...
  gtk_entry_set_text(
      GTK_ENTRY(entry_home_page),
      resource_get_home_page(working_configuration_file()).c_str());

  vbox_home_page_resource = gtk_vbox_new(FALSE, 0);
  gtk_widget_show(vbox_home_page_resource);
  gtk_box_pack_start(GTK_BOX(vbox_home_page), vbox_home_page_resource, TRUE,
                     TRUE, 0);

  browser_home_page = new WebkitBrowser(vbox_home_page_resource);

  g_signal_connect((gpointer)entry_home_page, "changed",
                   G_CALLBACK(on_entry_home_page_changed), gpointer(this));
  ...
  gtk_assistant_set_page_title(
      ...
      _("What are the abbreviations for the books of the Resource?"));
  gtk_assistant_set_page_type(GTK_ASSISTANT(assistant), vbox_bookset,
                              GTK_ASSISTANT_PAGE_CONTENT);
  ...
  g_signal_connect((gpointer)button_bookset, "clicked",
                   G_CALLBACK(on_button_bookset_clicked), gpointer(this));
  ...
  gtk_box_pack_start(GTK_BOX(hbox_books_import), button_books_import, FALSE,
                     FALSE, 0);
  ...
  g_signal_connect((gpointer)button_books_import, "clicked",
                   G_CALLBACK(on_button_books_import_clicked), gpointer(this));
  ...
  gtk_assistant_set_page_title(
      GTK_ASSISTANT(assistant), vbox_bookset2,
      _("What are the second abbreviations for the books of the Resource?"));
  gtk_assistant_set_page_type(GTK_ASSISTANT(assistant), vbox_bookset2,
                              GTK_ASSISTANT_PAGE_CONTENT);
  gtk_assistant_set_page_complete(GTK_ASSISTANT(assistant), vbox_bookset2,
                                  true);
  ...
  g_signal_connect((gpointer)button_bookset2, "clicked",
                   G_CALLBACK(on_button_bookset2_clicked), gpointer(this));

  hbox_books2_import = gtk_hbox_new(FALSE, 0);
  gtk_widget_show(hbox_books2_import);
  gtk_box_pack_start(GTK_BOX(vbox_bookset2), hbox_books2_import, FALSE, FALSE,
                     0);

  button_books2_import = gtk_button_new();
  gtk_widget_show(button_books2_import);
  gtk_box_pack_start(GTK_BOX(hbox_books2_import), button_books2_import, FALSE,
                     FALSE, 0);
  ...
  g_signal_connect((gpointer)button_books2_import, "clicked",
                   G_CALLBACK(on_button_books2_import_clicked), gpointer(this));
  ...
  gtk_assistant_set_page_title(
      GTK_ASSISTANT(assistant), vbox_anchors,
      _("Would you like to write the anchors in the pages of the Resource?"));
  gtk_assistant_set_page_type(GTK_ASSISTANT(assistant), vbox_anchors,
                              GTK_ASSISTANT_PAGE_CONTENT);
  ...
  g_signal_connect((gpointer)button_anchors, "clicked",
                   G_CALLBACK(on_button_anchors_clicked), gpointer(this));
  ...
  gtk_assistant_set_page_title(
      GTK_ASSISTANT(assistant), vbox_url,
      _("What is the URL constructor for the Resource?"));
  gtk_assistant_set_page_type(GTK_ASSISTANT(assistant), vbox_url,
                              GTK_ASSISTANT_PAGE_CONTENT);
  ...
  gtk_entry_set_text(
      GTK_ENTRY(entry_url),
      resource_get_url_constructor(working_configuration_file()).c_str());
  ...
  gtk_box_pack_start(GTK_BOX(hbox_tester), combobox_test_chapter, FALSE, FALSE,
                     0);
  ...
  gtk_box_pack_start(GTK_BOX(hbox_tester), combobox_test_verse, FALSE, FALSE,
                     0);
  ...
  g_signal_connect((gpointer)entry_url, "changed",
                   G_CALLBACK(on_entry_url_changed), gpointer(this));
  g_signal_connect((gpointer)combobox_test_book, "changed",
                   G_CALLBACK(on_combobox_test_changed), gpointer(this));
  g_signal_connect((gpointer)combobox_test_chapter, "changed",
                   G_CALLBACK(on_combobox_test_changed), gpointer(this));
  g_signal_connect((gpointer)combobox_test_verse, "changed",
                   G_CALLBACK(on_combobox_test_changed), gpointer(this));
...
void ResourceAssistant::on_assistant_prepare_signal(GtkAssistant *assistant,
                                                    GtkWidget *page,
                                                    gpointer user_data) {
...
void ResourceAssistant::on_assistant_apply_signal(GtkAssistant *assistant,
                                                  gpointer user_data) {
...
void ResourceAssistant::on_assistant_apply() {
  ...
  // Title.
  g_key_file_set_string(keyfile, resource_template_general_group(),
                        resource_template_title_key(), title().c_str());

  // Home page.
  g_key_file_set_string(keyfile, resource_template_general_group(),
                        resource_template_home_page_key(), home_page().c_str());
  ...
  // Book set.
  {
    ...
    for (unsigned int i = 0; i < ids.size(); i++) {
      ...
      if (!book.empty()) {
        g_key_file_set_string(keyfile, resource_template_books_group(),
                              books_id_to_english(ids[i]).c_str(),
                              book.c_str());
      }
    }
  }
  ...
  // Book set 2.
  {
    ...
    for (unsigned int i = 0; i < ids.size(); i++) {
      ...
      if (!book.empty()) {
        g_key_file_set_string(keyfile, resource_template_books2_group(),
                              books_id_to_english(ids[i]).c_str(),
                              book.c_str());
      }
    }
  ...
  // URL constructor.
  g_key_file_set_string(keyfile, resource_template_general_group(),
                        resource_template_url_constructor_key(),
                        url_constructor().c_str());
  ...
  created_resource_template =
      gw_build_filename(directory, resource_template_ini());

  // Show summary.
  gtk_assistant_set_current_page(GTK_ASSISTANT(assistant), summary_page_number);
}

gint ResourceAssistant::assistant_forward_function(gint current_page,
                                                   gpointer user_data) {
...
gint ResourceAssistant::assistant_forward(gint current_page) {
  ...
  if (current_page == page_number_task_selector) {
    ...
    if
  (gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(radiobutton_task_selector_settings)))
  {
...
void ResourceAssistant::on_entry_title_changed(GtkEditable *editable,
                                               gpointer user_data) {
...
void ResourceAssistant::on_entry_title() {
  ...
  // If the title is the same as the one of the Resource being edited, that's
  // fine.
  ...
  gtk_assistant_set_page_complete(GTK_ASSISTANT(assistant), vbox_title,
                                  title_is_available);
  ustring message;
...
void ResourceAssistant::on_button_add_files_clicked(GtkButton *button,
                                                    gpointer user_data) {
...
void ResourceAssistant::on_button_add_folders_clicked(GtkButton *button,
                                                      gpointer user_data) {
...
void ResourceAssistant::on_entry_home_page_changed(GtkEditable *editable,
                                                   gpointer user_data) {
...
void ResourceAssistant::on_entry_home_page() {
  ustring homepage =
      resource_url_get(home_page(), working_configuration_file());
...
void ResourceAssistant::on_button_bookset_clicked(GtkButton *button,
                                                  gpointer user_data) {
...
void ResourceAssistant::on_button_bookset(bool update_gui_only) {
  if (!update_gui_only) {
    BooknamesDialog dialog(books, _("Enter the abbreviations for the books"),
                           _("Abbreviations"));
...
void ResourceAssistant::on_button_books_import_clicked(GtkButton *button,
                                                       gpointer user_data) {
...
void ResourceAssistant::on_button_bookset2_clicked(GtkButton *button,
                                                   gpointer user_data) {
...
void ResourceAssistant::on_button_bookset2(bool update_gui_only) {
  if (!update_gui_only) {
    BooknamesDialog dialog(books2,
                           _("Enter the second abbreviations for the books"),
                           _("Abbreviations"));
    if (dialog.run() == GTK_RESPONSE_OK) {
...
void ResourceAssistant::on_button_books2_import_clicked(GtkButton *button,
                                                        gpointer user_data) {
...
void ResourceAssistant::on_button_anchors_clicked(GtkButton *button,
                                                  gpointer user_data) {
...
void ResourceAssistant::on_button_anchors() {
  ...
  if (dialog.run() == GTK_RESPONSE_OK) {
    // Modify the url constructor by adding the anchor to it, except if one is
    // already there.
...
void ResourceAssistant::on_entry_url_changed(GtkEditable *editable,
                                             gpointer user_data) {
  ((ResourceAssistant *)user_data)->on_url();
}

void ResourceAssistant::on_combobox_test_changed(GtkComboBox *combobox,
                                                 gpointer user_data) {
  ((ResourceAssistant *)user_data)->on_url();
}
...
void ResourceAssistant::on_url() {
  ustring url =
      resource_url_get(url_constructor(), working_configuration_file());
  unsigned int book =
      books_english_to_id(combobox_get_active_string(combobox_test_book));
  unsigned int chapter =
      convert_to_int(combobox_get_active_string(combobox_test_chapter));
...
So Bibledit goes to a website, downloads all verses, stores them under the
URL's, so these can be kept for later use offline.
Bibledit may use httrack to download sites to local files for offline viewing.
But httrack may produce huge files, so a warning may have to be given
to the user. Else Bibledit can manually download the page for each verse, using
htmltrack 2 levels deep and store that info, then
...
We need predictable locations for this resource, so that if this location is
found, the URL is not used.
...
The maximum depth to which the retrieval may descend is specified with the ‘-l’
option. The default maximum depth is five layers.
When downloading from Internet servers, consider using the ‘-w’ option to
introduce a delay between accesses to the server.
If you want to download only one page, use ‘--page-requisites’ without any
additional recursion.

wget --recursive --no-clobber --page-requisites --convert-links --domains
net.bible.org --user-agent=Mozilla --level=1
...
We may need to have an option to --wait some time, as optional, so by default it
speeds on.

If using the --no-clobber option, and downloading everything to the same
directory, we st
are going to do a lot of saving the more we download, because no file will be
downloaded twice.
...
httrack 'http://net.bible.org/bible.php?book=Mat&chapter=1' -O "." -%v -r2
--can-go-down -c8
