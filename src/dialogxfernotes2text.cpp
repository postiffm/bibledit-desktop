...
XferNotes2TextDialog::XferNotes2TextDialog(int dummy) {
  ...
  gtk_window_set_title(GTK_WINDOW(notestransferdialog),
                       _("Transfer Project Notes To Text"));
  ...
  label1 =
      gtk_label_new(_("This will transfer all the Project Notes that display "
                      "for each verse into the currently opened project"));
  ...
  new InDialogHelp(notestransferdialog, NULL, NULL,
                   "tools/transfer-project-notes-to-text");
...
void XferNotes2TextDialog::on_okbutton_clicked(GtkButton *button,
                                               gpointer user_data) {
...
void XferNotes2TextDialog::transfer_note(const ustring &project,
                                         unsigned int book,
