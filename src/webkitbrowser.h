...
private:
  ...
  static void progress_change_cb(WebKitWebView *page, gint progress,
                                 gpointer data);
  void progress_change(WebKitWebView *page, gint progress);
  static void link_hover_cb(WebKitWebView *page, const gchar *title,
                            const gchar *link, gpointer data);
  void link_hover(WebKitWebView *page, const gchar *title, const gchar *link);
  static void load_started_cb(WebKitWebView *page, WebKitWebFrame *frame,
                              gpointer user_data);
  void load_started(WebKitWebView *page, WebKitWebFrame *frame);
  static void load_finished_cb(WebKitWebView *page, WebKitWebFrame *frame,
                               gpointer user_data);
