...
public:
  FontColorDialog(bool initial_use_default_font, const ustring &initial_font,
...
private:
  static void on_checkbutton_font_toggled(GtkToggleButton *togglebutton,
                                          gpointer user_data);
  void on_checkbutton_font();
  static void on_checkbutton_colors_toggled(GtkToggleButton *togglebutton,
                                            gpointer user_data);
