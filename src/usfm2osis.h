...
private:
  ...
  void transform_usfm_description(ustring &usfm_code,
                                  const ustring &marker_text,
                                  size_t marker_length);

  void transform_h_title(ustring &usfm_code, size_t marker_length,
                         bool runningheader, const gchar *placement);
  void transform_general_title(ustring &usfm_code, size_t marker_length,
                               const gchar *type, unsigned int level);
  ...
  void transform_note(ustring &usfm_code, size_t marker_length, bool is_opener,
                      bool endnote, bool xref);
  bool note_is_open;
  void ensure_note_closed();

  bool character_style_open;
  void transform_character_style(ustring &usfm_code, size_t marker_length,
                                 bool is_opener, const gchar *element);
  void transform_character_style(ustring &usfm_code, size_t marker_length,
                                 bool is_opener, const gchar *element,
  ...
  void transform_figure(ustring &usfm_code, const ustring &marker_text,
                        size_t marker_length);
};
