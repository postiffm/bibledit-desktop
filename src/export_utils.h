...
enum ExportType { etBible,
                  etReferences,
                  etStylesheet,
                  etNotes,
                  etKeyterms };
enum ExportBibleType { ebtUSFM,
                       ebtBibleWorks,
                       ebtOSIS,
                       ebtSWORD,
                       ebtOpenDocument,
                       ebtGoBible };
enum ExportOsisType { eotRecommended,
                      eotGoBibleCreator,
                      eotOld };
enum ExportUsfmType { eutEverything,
                      eutChangesOnly };
enum ExportUsfmChangesType { euctSinceLast,
                             euctSinceDateTime };
