...
WebkitBrowser::WebkitBrowser(GtkWidget *parent_vbox) {
  ...
  gtk_progress_bar_set_ellipsize(GTK_PROGRESS_BAR(progressbar),
                                 PANGO_ELLIPSIZE_MIDDLE);

  // Set gui as if loading has finished, so that the sensitivitiy of buttons
  // gets right.
  ...
  g_signal_connect((gpointer)button_refresh, "clicked",
                   G_CALLBACK(on_button_refresh_clicked), gpointer(this));
  g_signal_connect((gpointer)button_stop, "clicked",
                   G_CALLBACK(on_button_stop_clicked), gpointer(this));
  g_signal_connect((gpointer)button_home, "clicked",
                   G_CALLBACK(on_button_home_clicked), gpointer(this));
  g_signal_connect((gpointer)entry_url, "activate",
                   G_CALLBACK(on_entry_url_activate), gpointer(this));
  g_signal_connect((gpointer)button_enter, "clicked",
                   G_CALLBACK(on_button_enter_clicked), gpointer(this));
  g_signal_connect(G_OBJECT(webview), "grab_focus",
                   G_CALLBACK(on_webview_grab_focus), gpointer(this));
  g_signal_connect(G_OBJECT(webview), "load-committed",
                   G_CALLBACK(load_commit_cb), gpointer(this));
  g_signal_connect(G_OBJECT(webview), "load-started",
                   G_CALLBACK(load_started_cb), gpointer(this));
  g_signal_connect(G_OBJECT(webview), "load-progress-changed",
                   G_CALLBACK(progress_change_cb), gpointer(this));
  g_signal_connect(G_OBJECT(webview), "load-finished",
                   G_CALLBACK(load_finished_cb), gpointer(this));
  g_signal_connect(G_OBJECT(webview), "hovering-over-link",
                   G_CALLBACK(link_hover_cb), gpointer(this));
}
...
void WebkitBrowser::focus() { gtk_widget_grab_focus(webview); }

bool WebkitBrowser::focused() { return gtk_widget_has_focus(webview); }
...
void WebkitBrowser::on_webview_grab_focus(GtkWidget *widget,
                                          gpointer user_data) {
...
void WebkitBrowser::on_button_back_clicked(GtkButton *button,
                                           gpointer user_data) {
...
void WebkitBrowser::on_button_forward_clicked(GtkButton *button,
                                              gpointer user_data) {
...
void WebkitBrowser::on_button_refresh_clicked(GtkButton *button,
                                              gpointer user_data) {
...
void WebkitBrowser::on_button_stop_clicked(GtkButton *button,
                                           gpointer user_data) {
...
void WebkitBrowser::on_button_home_clicked(GtkButton *button,
                                           gpointer user_data) {
...
void WebkitBrowser::on_button_enter_clicked(GtkButton *button,
                                            gpointer user_data) {
  ((WebkitBrowser *)user_data)->on_entry_url();
}
...
void WebkitBrowser::load_commit_cb(WebKitWebView *page, WebKitWebFrame *frame,
                                   gpointer data) {
...
void WebkitBrowser::progress_change_cb(WebKitWebView *page, gint progress,
                                       gpointer data) {
...
void WebkitBrowser::link_hover_cb(WebKitWebView *page, const gchar *title,
                                  const gchar *link, gpointer data) {
  ((WebkitBrowser *)data)->link_hover(page, title, link);
}

void WebkitBrowser::link_hover(WebKitWebView *page, const gchar *title,
                               const gchar *link) {
  gtk_label_set_text(GTK_LABEL(label_status), link);
  gtk_progress_bar_set_text(GTK_PROGRESS_BAR(progressbar), link);
}

void WebkitBrowser::set_home_page(const ustring &url) { homepage = url; }

void WebkitBrowser::load_started_cb(WebKitWebView *page, WebKitWebFrame *frame,
                                    gpointer user_data) {
...
void WebkitBrowser::load_started(WebKitWebView *page, WebKitWebFrame *frame) {
  ...
  gtk_widget_set_sensitive(
      button_back, webkit_web_view_can_go_back(WEBKIT_WEB_VIEW(webview)));
  gtk_widget_set_sensitive(
      button_forward, webkit_web_view_can_go_forward(WEBKIT_WEB_VIEW(webview)));
}

void WebkitBrowser::load_finished_cb(WebKitWebView *page, WebKitWebFrame *frame,
                                     gpointer user_data) {
