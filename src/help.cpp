...
InDialogHelp::InDialogHelp(GtkWidget *dialog, GtkBuilder *builder,
                           Shortcuts *shortcuts, const gchar *topic) {
  ...
  // Help menu for dialogs and assistants was disabled to make maintenance
  // easier.
  ...
  // G_CALLBACK(on_helpbutton_activated), gpointer(this));
  // g_signal_connect((gpointer) dialog, "delete_event",
  // G_CALLBACK(on_dialog_delete_event), gpointer(this));
}
...
void InDialogHelp::on_helpbutton_activated(GtkButton *button,
                                           gpointer user_data) {
...
gboolean InDialogHelp::on_dialog_delete_event(GtkWidget *widget,
                                              GdkEvent *event,
                                              gpointer user_data) {
