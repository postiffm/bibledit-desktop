...
FontColorDialog::FontColorDialog(bool initial_use_default_font,
  ...
  gtk_window_set_position(GTK_WINDOW(fontcolordialog),
  ...
  spinbutton_line_spacing_adj =
      gtk_adjustment_new(initial_line_spacing, 50, 500, 1, 10, 0);
  spinbutton_line_spacing =
      gtk_spin_button_new(GTK_ADJUSTMENT(spinbutton_line_spacing_adj), 1, 0);
  gtk_widget_show(spinbutton_line_spacing);
  gtk_box_pack_start(GTK_BOX(hbox_line_spacing), spinbutton_line_spacing, FALSE,
                     FALSE, 0);
  ...
  checkbutton_colors =
      gtk_check_button_new_with_mnemonic(_("Use default colors"));
  gtk_widget_show(checkbutton_colors);
  gtk_box_pack_start(GTK_BOX(dialog_vbox1), checkbutton_colors, FALSE, FALSE,
                     0);
  ...
  gtk_dialog_add_action_widget(GTK_DIALOG(fontcolordialog), cancelbutton,
                               GTK_RESPONSE_CANCEL);
  gtk_widget_set_can_default(GTK_WIDGET(cancelbutton), true);

  okbutton = gtk_button_new_from_stock("gtk-ok");
  gtk_widget_show(okbutton);
  gtk_dialog_add_action_widget(GTK_DIALOG(fontcolordialog), okbutton,
                               GTK_RESPONSE_OK);
  ...
  g_signal_connect((gpointer)checkbutton_font, "toggled",
                   G_CALLBACK(on_checkbutton_font_toggled), gpointer(this));
  g_signal_connect((gpointer)checkbutton_colors, "toggled",
                   G_CALLBACK(on_checkbutton_colors_toggled), gpointer(this));
  ...
  gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(checkbutton_font),
                               initial_use_default_font);
  gtk_font_selection_set_font_name(GTK_FONT_SELECTION(fontselection),
                                   initial_font.c_str());
  gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(checkbutton_colors),
                               initial_use_default_color);
  GdkColor gdkcolor;
  color_decimal_to_gdk(initial_normal_text_color, &gdkcolor);
  gtk_color_button_set_color(GTK_COLOR_BUTTON(colorbutton_normal_text),
                             &gdkcolor);
  color_decimal_to_gdk(initial_background_color, &gdkcolor);
  gtk_color_button_set_color(GTK_COLOR_BUTTON(colorbutton_background),
                             &gdkcolor);
  color_decimal_to_gdk(initial_selected_text_color, &gdkcolor);
  gtk_color_button_set_color(GTK_COLOR_BUTTON(colorbutton_selected_text),
                             &gdkcolor);
  color_decimal_to_gdk(initial_selection_color, &gdkcolor);
  gtk_color_button_set_color(GTK_COLOR_BUTTON(colorbutton_selection),
                             &gdkcolor);
}

FontColorDialog::~FontColorDialog() { gtk_widget_destroy(fontcolordialog); }

int FontColorDialog::run() {
  return gtk_dialog_run(GTK_DIALOG(fontcolordialog));
}

void FontColorDialog::on_checkbutton_font_toggled(GtkToggleButton *togglebutton,
                                                  gpointer user_data) {
...
void FontColorDialog::on_checkbutton_font() {
  bool sensitive =
      !gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(checkbutton_font));
  gtk_widget_set_sensitive(fontselection, sensitive);
  gtk_widget_set_sensitive(hbox_line_spacing, sensitive);
}

void FontColorDialog::on_checkbutton_colors_toggled(
...
void FontColorDialog::on_checkbutton_colors() {
  bool sensitive =
      !gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(checkbutton_colors));
...
void FontColorDialog::on_okbutton_clicked(GtkButton *button,
                                          gpointer user_data) {
  ((FontColorDialog *)user_data)->on_okbutton();
}

void FontColorDialog::on_okbutton() {
  new_use_default_font =
      gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(checkbutton_font));
  new_font =
  ...
  new_line_spacing = gtk_spin_button_get_value_as_int(
      GTK_SPIN_BUTTON(spinbutton_line_spacing));
  new_use_default_color =
      gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(checkbutton_colors));
  GdkColor gdkcolor;
  gtk_color_button_get_color(GTK_COLOR_BUTTON(colorbutton_normal_text),
                             &gdkcolor);
  new_normal_text_color = color_gdk_to_decimal(&gdkcolor);
  gtk_color_button_get_color(GTK_COLOR_BUTTON(colorbutton_background),
                             &gdkcolor);
  new_background_color = color_gdk_to_decimal(&gdkcolor);
  gtk_color_button_get_color(GTK_COLOR_BUTTON(colorbutton_selected_text),
                             &gdkcolor);
  new_selected_text_color = color_gdk_to_decimal(&gdkcolor);
  gtk_color_button_get_color(GTK_COLOR_BUTTON(colorbutton_selection),
                             &gdkcolor);
